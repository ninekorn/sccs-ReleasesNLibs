...
namespace sccs
{
    public class SC_instancedChunkPrim
    {
        ...
        private void ShutdownBuffers()
        {
            ...
            for (int j = 0; j < arrayOfChunkData.Length; j++)
            {
                if (arrayOfChunkData[j] != null)
                {
                    ...
                    if (arrayOfChunkData[j].somerandomvaluebuffer != null)
                    {
                        arrayOfChunkData[j].somerandomvaluebuffer.Dispose();
                        arrayOfChunkData[j].somerandomvaluebuffer = null;
                    }
        ...
        public SC_instancedChunk.DVertex[] chunkarrayofverts;
                    ...
                    for (int y = 0; y < numberOfObjectInHeight_; y++)
                    {
                        for (int z = 0; z < numberOfObjectInDepth_; z++)
                        {
                            ...
                            */
                            ...
                            chunkpermeshreduced.startBuildingArray(new Vector4(chunkPos.X, chunkPos.Y, chunkPos.Z, 1.0f),
                                 out m11, out m12, out m13, out m14, out m21, out m22, out m23, out m24, out m31, out m32, out m33, out m34, out m41, out m42, out m43, out m44, out theMap, null,
                                 swtcsetneighboors, null, numberofmainobjectx, numberofmainobjecty, numberofmainobjectz, numberOfObjectInWidth, numberOfObjectInHeight, numberOfObjectInDepth, numberOfInstancesPerObjectInWidth,
                                 numberOfInstancesPerObjectInHeight, numberOfInstancesPerObjectInDepth, tinyChunkWidth, tinyChunkHeight, tinyChunkDepth, planeSize, voxeltype, typeofbytemapobject,
                                 mainix, mainiy, mainiz, 0, 0, 0, 0, 0, 0
                                , out m11b, out m12b, out m13b, out m14b, out m21b, out m22b, out m23b, out m24b, out m31b, out m32b, out m33b, out m34b, out m41b, out m42b, out m43b, out m44b,
                                out m11c, out m12c, out m13c, out m14c, out m21c, out m22c, out m23c, out m24c, out m31c, out m32c, out m33c, out m34c, out m41c, out m42c, out m43c, out m44c,
                                out m11d, out m12d, out m13d, out m14d, out m21d, out m22d, out m23d, out m24d, out m31d, out m32d, out m33d, out m34d, out m41d, out m42d, out m43d, out m44d, -1, out chunkarrayofverts, out chunkarrayofindices); //, somechunkkeyboardpriminstanceindex_, chunkprimindex_, chunkinstindex
                            ...
                            arrayofindexzeromesh[chunkprimindex] = new SC_instancedChunk(1, 1, 1, new Vector4(0.1f, 0.1f, 0.1f, 1), numberOfInstancesPerObjectInWidth_, numberOfInstancesPerObjectInHeight_, numberOfInstancesPerObjectInDepth_, chunkPos, mainObjectInstance1stCubeMatrix, null, _addtoworld, _mass, _the_world, _is_static, _tag, numberofmainobjectx, numberofmainobjecty, numberofmainobjectz, numberOfObjectInWidth, numberOfObjectInHeight, numberOfObjectInDepth, numberOfInstancesPerObjectInWidth, numberOfInstancesPerObjectInHeight, numberOfInstancesPerObjectInDepth, tinyChunkWidth, tinyChunkHeight, tinyChunkDepth, planeSize, offsetinstance, instancesbytemaps, somechunkkeyboardpriminstanceindex_, chunkprimindex, voxeltype, typeofbytemapobject, mainix, mainiy, mainiz, x, y, z, typeofvoxelmesh, swtcsetneighboors, voxeltype_); //, instances[chunkprimindex]
                            ...
                            arrayOfChunkData[chunkprimindex].istypeofmesh = istypeofmesh;
                            ...
                            if (voxeltype == 0 || voxeltype == 1 || voxeltype == 2 || voxeltype == 3 || voxeltype == 4)
                            {
                            ...
                            arrayOfChunkData[chunkprimindex].randomvaluearray = randomvaluearray;
                            arrayOfChunkData[chunkprimindex].somerandomvaluebuffer = somerandomvaluebuffer;
