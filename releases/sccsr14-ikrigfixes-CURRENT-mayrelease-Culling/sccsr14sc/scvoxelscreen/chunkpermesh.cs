...
namespace sccs
{
    public class chunkpermesh : IDisposable
    {


        private List<SC_instancedChunk.DVertex> vertexlist = new List<SC_instancedChunk.DVertex>(); //listOfVerts
       ...
       // FastNoise fastNoise = new FastNoise();
        ...
        public void startBuildingArray(Vector4 currentPosition,
            ...
            out double m21d, out double m22d, out double m23d, out double m24d, out double m31d, out double m32d, out double m33d, out double m34d, out double m41d, out double m42d, out double m43d, out double m44d, int someswtc, out SC_instancedChunk.DVertex[] vertexArray, out int[] triangleArray)// , int somechunkkeyboardpriminstanceindex_, int chunkprimindex_, int chunkinstindex_
        {


            chunkinitpos = currentPosition;

            padding0 = numberOfInstancesPerObjectInWidth_;
            padding1 = numberOfInstancesPerObjectInHeight_;
            padding2 = numberOfInstancesPerObjectInDepth_;
            ...
            width = tinyChunkWidth * numberOfInstancesPerObjectInWidth;
            height = tinyChunkHeight * numberOfInstancesPerObjectInHeight;
            depth = tinyChunkDepth * numberOfInstancesPerObjectInDepth;
