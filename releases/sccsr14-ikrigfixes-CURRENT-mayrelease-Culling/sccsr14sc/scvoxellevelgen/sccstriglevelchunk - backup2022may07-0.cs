...
namespace sccs
{
    public class sccstriglevelchunk
    {
        ...
        public int[] startBuildingArray(Vector3 currentPosition, out Vector4[] vertexArray, out int[] indicesArray, out int[] mapper, out sclevelgenchunk.DVertex[] dVertexArray, out Vector3[] norms, out Vector2[] tex, float planeSize_, LevelGenerator4 levelgen_, Vector3 _chunkPos, int width_, int height_, int depth_, int typeofterraintiles, sclevelgenchunk componentparent_, int[] map_) //, out int vertexNum, out int indicesNum
                    ...
                    */
                    ...
                    if (xi == 0)
                    {
                        ...
                        if (someChunk != null)
                        {
                            if (someChunk.map != null)
                            {
                                if (someChunk.GetByte(width - 1, yi, zi) != 1)
                                {
                                    if (GetByte(xi - 1, yi, zi) == 0)
                                    {
                                        buildTopLeft(xi, yi, zi, 1.0f);
                                        //Console.WriteLine("test");
                                    }
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            /*Vector3 somechunkpos0 = chunkPos;
                            ...
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(xChunkPos -1, 0, zChunkPos);
                                                ...
                                                //if (someChunk.IsTransparent(width - 1, rowIterateY, rowIterateZ))
                                                {
                                                    ...
                                                    if (rowIterateY < height && rowIterateZ < depth)
                                                    {
                                                        if (_yy == 0 && _zz == 0)
                                                        {
                                                            ...
                                                            if (blockExistsInArray(xi, rowIterateY + 1, rowIterateZ) && someChunk.IsTransparent(width - 1, rowIterateY+1, rowIterateZ))
                                                            {
                                                                ...
                                                                {
                                                                    if (blockExistsInArray(xi - 1, rowIterateY + 1, rowIterateZ) && someChunk.IsTransparent(width - 1, rowIterateY + 1, rowIterateZ))
                                                                    {
                                                            ...
                                                            {
                                                                if (someChunk.IsTransparent(width - 1, rowIterateY+1, rowIterateZ)) 
                                                                {
                                                            ...
                                                            if (blockExistsInArray(xi, rowIterateY, rowIterateZ + 1) && someChunk.IsTransparent(width - 1, rowIterateY, rowIterateZ+1))
                                                            {
                                                                ...
                                                                else if (_block == 1 || _block == 2) //_block == 1||
                                                                {
                                                                    if (_block == 1)
                                                                    {
                                                                        if (blockExistsInArray(xi - 1, rowIterateY, rowIterateZ + 1) && someChunk.IsTransparent(width - 1, rowIterateY , rowIterateZ+1))
                                                                        {
                                                            ...
                                                            {
                                                                if (someChunk.IsTransparent(width - 1, rowIterateY, rowIterateZ+1))
                                                                {
                                                                    twoVertIndexX = xi;
                                                                    twoVertIndexY = rowIterateY;
                                                                    twoVertIndexZ = rowIterateZ + 1;
                                                        ...
                                                        else if (_yy == 0 && _zz > 0)
                                                        {
                                                            ...
                                                            {
                                                                if (someChunk.IsTransparent(width - 1, rowIterateY + 1, rowIterateZ+1))
                                                                {
                                                                    if (rowIterateZ + 1 == twoVertIndexZ && rowIterateY + 1 == threeVertIndexY)
                                                                    {
                                                                        fourVertIndexX = xi;
                                                        ...
                                                        else if (_yy > 0 && _zz == 0)
                                                        {
                                                            ...
                                                            {
                                                                if (someChunk.IsTransparent(width - 1, rowIterateY + 1, rowIterateZ-_zz))
                                                                {
                                                                    threeVertIndexX = xi;
                                                                    threeVertIndexY = rowIterateY + 1;
                                                                    threeVertIndexZ = rowIterateZ - _zz;
                                                    ...
                                                    if (blockExistsInArray(xi, rowIterateY, rowIterateZ) && someChunk.IsTransparent(width - 1, rowIterateY, rowIterateZ))
                                                    {
