...
namespace sccs.scgraphics
{
    public class scupdate : scdirectx
    {
        ...
        public static SharpDX.Vector3 originPos = new SharpDX.Vector3(0, 2, 25); //new SharpDX.Vector3(-10, 1, 10);
        public static SharpDX.Vector3 originPosScreen = new SharpDX.Vector3(0, 0, 40);

        float disco_sphere_rot_speed = 0.5f;

        float speedRot = 0.5f; //1.95f // 0.25f
        float speedRotArduino = 0.000001f;

        float speedPos = 1.25f; //0.025f // 1.5f
