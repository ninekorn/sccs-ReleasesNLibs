...
namespace sccs.scgraphics
{
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
        ...
        public static int activatenotyetinfinitevoxelterrain = 1;
                        ...
                        for (int x = 0; x < MainWindow.worldwidth; x++)
                        {
                            for (int y = 0; y < MainWindow.worldheight; y++)
                            {
                                for (int z = 0; z < MainWindow.worlddepth; z++)
                                {
                                    ...
                                    somevoxelvirtualdesktopglobals.planeSize = 0.1f; // * 10
                                    ...
                                    somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth = 128; //256 // 512
                                    somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight = 72; //128 // 256
                                                ...
                                                for (int xx = 0; xx < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth; xx++)
                                                {
                                                    ...
                                                    for (int yy = 0; yy < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight; yy++)
                                                    {
                                                        ...
                                                        for (int zz = 0; zz < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInDepth; zz++)
                                                        {
                                                            ...
                                                            var rpix = 0;// somepixelarrayvalue[2 + somebyteindex0];
                                                            var apix = 3;// somepixelarrayvalue[3 + somebyteindex0];



                                                            float somefullbytes = somepixelarrayvalue[rpix + somebyteindex0];// 11111111.0f;
                                                            ...
                                                            */
                                                            ...
                                                            var bytePoser = (((1080 - (divyadd)) * 1920) + divxadd) * somepixelsize;
                                                            //var bytePoser = (((1920 - (divxadd)) * 1080) + divyadd) * somepixelsize;



                                                            var somemultiplier = somevoxelvirtualdesktopglobals.planeSize;
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[rpix + (0 * 4) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M11 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = bytePoser;//(xx * 1080) + (((yy * memorymapstride) + 5) * somepixelsize);//  ((ycolpix * 1920) + (xrowpix + 5)) * somepixelsize;//  (someoffset * wid) + (5 * somepixelsize);
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (1 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M12 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = bytePoser;//(xx * 1080) + (((yy * memorymapstride) + 6) * somepixelsize);//  ((ycolpix * 1920) + (xrowpix + 6)) * somepixelsize;//  (someoffset * wid) + (6 * somepixelsize);
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (2 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M13 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = bytePoser;//(xx * 1080) + (((yy * memorymapstride) + 7) * somepixelsize);//  ((ycolpix * 1920) + (xrowpix + 7)) * somepixelsize;//  (someoffset * wid) + (7 * somepixelsize);
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (3 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M14 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[rpix + (4 * 4) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M21 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (5 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M22 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (6 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M23 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (7 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M24 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[rpix + (8 * 4) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M31 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (9 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M32 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (10 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M33 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (11 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M34 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[rpix + (12 * 4) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M41 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (13 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M42 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (14 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M43 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (somebyteindex0 < 1920 * 1080 * 4)
                                                            {
                                                                someheightmapvalue = somepixelarrayvalue[(rpix + (15 * 4)) + somebyteindex0];
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M44 = someheightmapvalue;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + 0;
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M11 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (1 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M12 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (2 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M13 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M13 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (3 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M14 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M14 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }

                                                            //someoffset++;

                                                            somebyteindex0 = (someoffset * wid) + (4 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M21 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (5 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M22 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (6 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M23 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M23 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (7 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M24 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M24 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;



                                                            somebyteindex0 = (someoffset * wid) + (8 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M31 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (9 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M32 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (10 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M33 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M33 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (11 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M34 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M34 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (12 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M41 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (13 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M42 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (14 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M43 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M43 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (15 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M44 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrix[cc].instancematrix.M44 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            */
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (16 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M11 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (17 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M12 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (18 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M13 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M13 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (19 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M14 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M14 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }

                                                            //someoffset++;

                                                            somebyteindex0 = (someoffset * wid) + (20 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M21 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (21 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M22 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (22 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M23 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M23 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (23 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M24 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M24 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;



                                                            somebyteindex0 = (someoffset * wid) + (24 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M31 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (25 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M32 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (26 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M33 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M33 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (27 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M34 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M34 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (28 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M41 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (29 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M42 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (30 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M43 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M43 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (31 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M44 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixb[cc].instancematrix.M44 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixb[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (32 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M11 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (33 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M12 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (34 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M13 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M13 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (35 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M14 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M14 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }

                                                            //someoffset++;

                                                            somebyteindex0 = (someoffset * wid) + (36 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M21 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (37 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M22 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (38 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M23 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M23 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (39 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M24 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M24 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;



                                                            somebyteindex0 = (someoffset * wid) + (40 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M31 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (41 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M32 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (42 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M33 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M33 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (43 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M34 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M34 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (44 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M41 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (45 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M42 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (46 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M43 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M43 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (47 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M44 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixc[cc].instancematrix.M44 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixc[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (48 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M11 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (49 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M12 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (50 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M13 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M13 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (51 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M14 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M14 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }

                                                            //someoffset++;

                                                            somebyteindex0 = (someoffset * wid) + (52 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M21 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (53 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M22 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somebyteindex0 = (someoffset * wid) + (54 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M23 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M23 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (55 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M24 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M24 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;



                                                            somebyteindex0 = (someoffset * wid) + (56 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M31 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (57 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M32 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (58 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M33 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M33 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (59 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M34 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M34 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (60 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M41 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M42 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M12;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (62 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M43 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M43 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M13;
                                                            }
                                                            //someoffset++;
                                                            somebyteindex0 = (someoffset * wid) + (63 * somepixelsize);
                                                            somefullbytes = somepixelarrayvalue[rpix + somebyteindex0] * someclampednoisexz;
                                                            if (sc_maths.LimitInclusiveInt(somepixelarrayvalue[rpix + somebyteindex0], 0, maxval) == normz)
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M44 = somefullbytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrixd[cc].instancematrix.M14;
                                                            }
                                                            else
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].instancesmatrixd[cc].instancematrix.M44 = someemptybytes;//somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancematrixrix[cc].instancematrix.M14;
                                                            }
                                                            //someoffset++;
                                                            */
