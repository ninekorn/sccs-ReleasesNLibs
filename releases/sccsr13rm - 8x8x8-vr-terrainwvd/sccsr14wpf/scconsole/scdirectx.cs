...
{
    public abstract class scdirectx : ISCCS_Jitter_Interface
    {
       ...
       public static SharpDX.Matrix WorldMatrix;
            ...
            try
            {
                ...
                if (MainWindow._useOculusRift == 1)
                {
                    ...
                    try
                    {
                        ...
                        var swapChainDescription = new SwapChainDescription()
                        {
                            ...
                            OutputHandle = MainWindow.consoleHandle,
                ...
                else //without oculus rift
                {
                    ...
                    */
                    ...
                    ProjectionMatrix = Matrix.PerspectiveFovLH((float)(Math.PI / 4), ((float)SurfaceWidth / (float)SurfaceHeight), 0.1f, 100);
            ...
            try
            {
                mainthreadupdate = new Thread(() =>
                {
                    if (MainWindow.usejitterphysics == 1)
                    {
                        ...
                        sccsjittertasks = init_update_variables(sccsjittertasks, MainWindow.config, MainWindow.consoleHandle, MainWindow.SCGLOBALSACCESSORS.SCCONSOLEWRITER);
                    }
        ...
        protected abstract scmessageobjectjitter[][] init_update_variables(scmessageobjectjitter[][] sccsjittertasks, sccs.sccore.scsystemconfiguration configuration, IntPtr hwnd, scconsole.scconsolewriter _writer); //void Update();
