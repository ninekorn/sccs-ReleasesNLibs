            ...
            //if (!runapptype)
            {
                ...
                */
                ...
                if (!Program.runapptype)
                {
                    ...
                    {
                        resultsetuppipelineUIThread = SetupPipelineUIThread.Invoke();
                    }
                    ...
                    if (D3D.currentState.Type == directx.TestType.Immediate || (D3D.currentState.Type == directx.TestType.Deferred && D3D.currentState.ThreadCount == 1))
                    {
                        ...
                        {
                            //IAsyncResult result = 
                            resultrenderrowUIThread = renderrowUIThread.Invoke(0, 0, D3D.currentState.CountCubes); //(0, 0, D3D.currentState.CountCubes)
                        }
                    ...
                    if (D3D.currentState.Type != directx.TestType.Immediate)
                    {
                        if (D3D.currentState.Type == directx.TestType.FrozenDeferred)
                        {
                            if (D3D.commandsListUIThread[0] == null)
                            {
                                ...
                                {
                                    resultrenderdeferredUIThread = RenderDeferredUIThread.Invoke(1);
                                }
                            }
                        ...
                        else if (D3D.currentState.ThreadCount > 1)
                        {
                            if (RenderDeferredUIThread != null)
                            {
                                resultrenderdeferredUIThread = RenderDeferredUIThread.Invoke(D3D.currentState.ThreadCount);
                            }
                ...
                else if (Program.runapptype)
                {
                    ...
                    {
                        resultsetuppipelineSysThread = SetupPipelineSysThread.Invoke();
                    }
                    ...
                    if (D3D.currentState.Type == directx.TestType.Immediate || (D3D.currentState.Type == directx.TestType.Deferred && D3D.currentState.ThreadCount == 1))
                    {
                        ...
                        {
                            //IAsyncResult result = 
                            resultrenderrowSysThread = renderrowSysThread.Invoke(0, 0, D3D.currentState.CountCubes); //(0, 0, D3D.currentState.CountCubes)
                        }
                    ...
                    if (D3D.currentState.Type != directx.TestType.Immediate)
                    {
                        if (D3D.currentState.Type == directx.TestType.FrozenDeferred)
                        {
                            if (D3D.commandsListSysThread[0] == null)
                            {
                                ...
                                {
                                    resultrenderdeferredSysThread = RenderDeferredSysThread.Invoke(1);
                                }
                            }
                        ...
                        else if (D3D.currentState.ThreadCount > 1)
                        {
                            if (RenderDeferredSysThread != null)
                            {
                                resultrenderdeferredSysThread = RenderDeferredSysThread.Invoke(D3D.currentState.ThreadCount);
                            }
