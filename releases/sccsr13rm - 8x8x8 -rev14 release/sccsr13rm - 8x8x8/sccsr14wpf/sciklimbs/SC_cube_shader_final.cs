        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                vsFileName = sccsr14wpf.Properties.Resources.texture1;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsr14wpf.Properties.Resources.texture;// "../../../_sc_instance_shader/" + "texture.ps";
