    ...
    public class sccsikvoxellimbs
    {
        ...
        public scmessageobjectjitter[][] createikbody(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, Matrix worldmatofobj_, int human_inst_rig_x, int human_inst_rig_y, int human_inst_rig_z, int grabtargetitem_)
        {
            ...
            _player_pelvis[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight,
                ...
                MainWindow.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerPelvis,
            ...
            if (MainWindow.usejitterphysics == 1)
            {
                ...
                for (int phys = 0; phys < MainWindow.physicsengineinstancex * MainWindow.physicsengineinstancey * MainWindow.physicsengineinstancez; phys++)
                {
                    for (int i = 0; i < MainWindow.worldwidth * MainWindow.worldheight * MainWindow.worlddepth; i++)
                    {
