    ...
    public class scgraphicssec //: sccs.scgraphics.scupdate//SC_Intermediate_Update
    {
                        ...
                        for (int x = 0; x < MainWindow.worldwidth; x++)
                        {
                            for (int y = 0; y < MainWindow.worldheight; y++)
                            {
                                for (int z = 0; z < MainWindow.worlddepth; z++)
                                {
                                    ...
                                    somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth = 128; //256 // 512 //240 //128
                                    somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight = 72; //128 // 256 //135 //72
        ...
        public scmessageobjectjitter[][] scwritetobuffer(scmessageobjectjitter[][] _sc_jitter_tasks)
        {
            ...
            if (activatevrheightmapfeature == 1)
            {
                ...
                var somepixelarrayvalue = sccs.scgraphics.scupdate.screencaptureframe.frameByteArray;//.arrayOfFRACSCREENSPECTRUMBytes[somebytearrayindex];
                                                ...
                                                for (int xx = 0; xx < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth; xx++)
                                                {
                                                    ...
                                                    for (int yy = 0; yy < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight; yy++)
                                                    {
                                                        ...
                                                        for (int zz = 0; zz < somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInDepth; zz++)
                                                        {
                                                            ...
                                                            {
                                                                somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M11 = somefullbytes;// somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].instancesmatrix[cc].instancematrix.M11;
                                                            }
                                                            else
                                                            {
                                                            ...
                                                            somemultiplier = somevoxelvirtualdesktopglobals.planeSize * -10; // -25 // -100 // - 1000.0f //sccsr14sc.Form1.someform.heightmapvalue
                                                            someresw = 0;//
                                                            someresh = 0;//
                                                            someindexmx = 1;
                                                            someindexmy = 1;

                                                            if (somevoxelvirtualdesktopglobals.tinyChunkWidth == 4 && somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth == 128 && somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight == 72 && somevoxelvirtualdesktopw == 1 && somevoxelvirtualdesktoph == 1)
                                                            {
                                                                xpluszero = 14 - 0;
                                                                xplusone = 14 - 2;
                                                                xplustwo = 14 - 4;
                                                            ...
                                                            else if (somevoxelvirtualdesktopglobals.tinyChunkWidth == 4 && somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInWidth == 240 && somevoxelvirtualdesktopglobals.numberOfInstancesPerObjectInHeight == 135 && somevoxelvirtualdesktopw == 1 && somevoxelvirtualdesktoph == 1)
                                                            {
                                                                /*xpluszero = 7 - 0;
                                                                xplusone = 7 - 1;
                                                                xplustwo = 7 - 2;
                                                            ...
                                                            if (somepixelarrayvalue != null && somepixelarrayvalue.Length > 0) // && MainWindow.exitedprogram == -1
                                                            {
                                                                ...
                                                                if (somevoxelvirtualdesktopglobals.tinyChunkWidth == 4) // || somevoxelvirtualdesktopglobals.tinyChunkWidth == 8 // || somevoxelvirtualdesktopglobals.tinyChunkWidth ==16
                                                                {
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            b = somepixelarrayvalue[bytePoser + 0];
                                                                            g = somepixelarrayvalue[bytePoser + 1];
                                                                            r = somepixelarrayvalue[bytePoser + 2];
                                                                            a = somepixelarrayvalue[bytePoser + 3];

                                                                            total = (b + g + r) / 3.0f;


                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M11 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M12 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M13 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M14 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M21 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M22 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M23 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M24 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M31 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M32 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M33 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M34 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M41 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M42 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M43 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                                    ...
                                                                    if (bytePoser >= 0 && bytePoser < somepixelarrayvalue.Length)
                                                                    {
                                                                        try
                                                                        {
                                                                            ...
                                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M44 = total * somenoise * somemultiplier;
                                                                        }
                                                                        catch (Exception ex)
                                                                        {
                                                                            //MainWindow.MessageBox((IntPtr)0, "" + (rpix + (0 * somepixelval) + bytePoser) + " " + somepixelarrayvalue.Length + " " + ex.ToString(), "scmsg", 0);
                                                            ...
                                                            /*somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M11 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M11;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M12 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M12;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M13 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M13;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M14 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M14;

                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M21 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M21;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M22 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M22;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M23 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M23;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M24 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M24;


                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M31 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M31;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M32 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M32;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M33 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M33;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M34 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M34;


                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M41 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M41;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M42 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M42;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M43 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M43;
                                                            somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayOfChunkData[c].heightmapmatrix[cc].heightmapmat.M44 = somevoxelvirtualdesktop[somevoxelvirtualdesktopindex].arrayofindexzeromesh[c].heightmapmatrix[cc].heightmapmat.M44;
                                                            */
                                                            //TO READD //removed 27 october 27
                                                            //source_rect.X += wid;
                                                        }
