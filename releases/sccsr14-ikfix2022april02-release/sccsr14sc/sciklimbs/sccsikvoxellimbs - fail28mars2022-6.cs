        ...
        public scmessageobjectjitter[][] setiktargetnfingerspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, int typeoflimb, sccsikvoxellimbs ikvoxellimb, int somechunkpriminstanceikfingervoxelindex)
        {
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        Vector3 crossRes111;
                        Vector3.Cross(ref someDirFromPivothandtograb, ref handtohandgrabdir, out crossRes111);
                        ...
                        var thehandmatrix = Matrix.LookAtRH(someposofelbowlowerarm, someposofelbowlowerarm + someDirFromPivothandtograb, crossRes111);
                ...
                */
                ...
                var upperEquationCirCirIntersecttohand = (lengthofdirfromlowerpivottoendhand * lengthofdirfromlowerpivottoendhand) - (lengthOfLowerArmRight * lengthOfLowerArmRight) + (lengthOfHandRight * lengthOfHandRight);
                var adjacentSolvingForXtohand = upperEquationCirCirIntersecttohand / (2 * lengthofdirfromlowerpivottoendhand);
                adjacentSolvingForXtohand = Math.Min(adjacentSolvingForXtohand, lengthOfLowerArmRight - lengthOfLowerArmRight * 0.001f);
                var resultertohand = Math.Pow(lengthOfLowerArmRight, 2) - Math.Pow(adjacentSolvingForXtohand, 2);
                if (resultertohand < 0)
                {
                    resultertohand *= -1;
                }
                var oppositeSolvingForHalfAtohand = (float)Math.Sqrt(resultertohand);
                oppositeSolvingForHalfAtohand = Math.Min(oppositeSolvingForHalfAtohand, lengthOfLowerArmRight - lengthOfLowerArmRight * 0.001f);
                */
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    //someNewPointer = someNewPointer + (-crossRes * oppositeSolvingForHalfAtohand);
                }
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    someNewPointer = someNewPointer + (-updirupperarm * oppositeSolvingForHalfA);
                ...
                */
                ...
                someNewPointer = realPIVOTOfUpperArm + (someDirFromPivotUpperToHand * adjacentSolvingForXtohand);
