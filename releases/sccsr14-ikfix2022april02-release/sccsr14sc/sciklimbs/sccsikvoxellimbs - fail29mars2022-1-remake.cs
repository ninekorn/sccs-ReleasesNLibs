                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0)
                    {
                        ...
                        //somevec0 = somevec0 - (direction_head_forward0 * lengthOfHandheight * 0.005f);
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        lowerarmendpos.X += OFFSETPOS.X;
                        lowerarmendpos.Y += OFFSETPOS.Y;
                        lowerarmendpos.Z += OFFSETPOS.Z;

                        Vector3 handtohandgrabdir1 = handgrabpos - lowerarmendpos;
                        float somelength4 = handtohandgrabdir1.Length();
                        ...
                        var someDirFromPivothandtograb = pointA1 - someposofelbowlowerarm;
                        someDirFromPivothandtograb.Normalize();

                        Vector3 crossRes111;
                        Vector3.Cross(ref someDirFromPivothandtograb, ref handtohandgrabdir0, out crossRes111);
                        ...
                        var thehandmatrix = Matrix.LookAtRH(lowerarmendpos, lowerarmendpos + handtohandgrabdir0, crossRes111);
                        ...
                        Vector3 somepointermove = somePosOfSHLDR + (direction_feet_forward_ori * lengthOfUpperArmRight);
                        ...
                        somepointermove = somepointermove + (direction_feet_forward_ori * lengthOfLowerArmRight);
                        ...
                        Vector3 posshouldertolowerarm = somePosOfSHLDR - lowerarmendpos;
                        posshouldertolowerarm.Normalize();

                        var somelength3 = (somepointermove - somePosOfSHLDR).Length();
                        ...
                        else
                        {
                            ...
                            Vector3 dirgrabtoelbow = handgrabpos - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;
                            dirgrabtoelbow.Normalize();
                            ...
                            Vector3 pointtograbpos = somePosOfSHLDR + (handtohandgrabdir0 * somelength0);

                            Vector3 pointOfinterest = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + (dirgrabtoelbow * (somelength0*0.1f));

                            //Vector3 locationoflowerarmenddir = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION - pointOfinterest;
                            //locationoflowerarmenddir.Normalize();

                            //tempDirr.Normalize();
                            Vector3 tempVect = pointtograbpos + (-dirgrabtoelbow * (lengthOfHandRight));
                            MOVINGPOINTER.X = tempVect.X;
                            MOVINGPOINTER.Y = tempVect.Y;
                            MOVINGPOINTER.Z = tempVect.Z; 
                        }
