    ...
    public class sccsikvoxellimbs : IDisposable
    {
        ...
        public scmessageobjectjitter[][] setiktargetnfingerspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, sccsikvoxellimbs ikvoxellimb, int somechunkpriminstanceikfingervoxelindex)
        {
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                {
                    somefingerpos = somefingerpos + (-dirhandup * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 6 * 0.45f));
                }
                ...
                {
                    somefingerpos = somefingerpos + (dirhandup * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 6 * 0.75f));
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    if (sccs.scgraphics.scupdate.handTriggerLeft[0] > 0.00000001f)
                    {
                        somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * (1 - sccs.scgraphics.scupdate.handTriggerLeft[0]) * 0.03f * 1.0923f)));
                ...
                var positionoflowermovingpointer = positionofuppermovingpointer + (dirupperforward * _player_rght_lower_arm[0][0]._total_torso_depth * 6 * 0.5f);
                ...
                positionoflowerfingersegment = positionoflowermovingpointer + (dirlowerforward * _player_rght_lower_arm[0][0]._total_torso_depth * 6 * 0.5f);
                ...
                Vector3 grabtolowerfingersegmentendpos = handgrabpos - positionoflowerfingersegment;
                ...
                var pointA1 = positionofuppermovingpointer + (-crossRes1);
                ...
                var someDirFromPivothandtograb = pointA1 - positionofuppermovingpointer;
                ...
                var thehandmatrix = Matrix.LookAtRH(positionoflowerfingersegment, positionoflowerfingersegment + grabtolowerfingersegmentendpos, crossRes111);
                ...
                _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = pointtofingertippivot;
                ...
                Vector3 positionoflowerarmcurrent = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);


                //var somePosOfRightHand = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                //var someposoflowerarm = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                var someposoflowerarm = _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT;

                var somePosOfUpperElbowTargetTwo = new Vector3(_player_rght_elbow_target_two[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_elbow_target_two[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_elbow_target_two[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                var somePosOfUpperElbowTargetOne = new Vector3(_player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                var someDirFromElbowTargetOneToTwo = somePosOfUpperElbowTargetTwo - somePosOfUpperElbowTargetOne;
                var someDirFromElbowTargetOneTolowerpivot = someposoflowerarm - somePosOfUpperElbowTargetOne;


                //var sometotalarmlength2 = totalArmLengthRight * 4;

                Vector3 crossRes;
                Vector3.Cross(ref someDirFromElbowTargetOneToTwo, ref someDirFromElbowTargetOneTolowerpivot, out crossRes);
                crossRes.Normalize();
                //crossRes *= -1;
                var pointA = positionoflowerarmcurrent + (crossRes);

                var someDirFromPivotUpperToHand = someposoflowerarm - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT;
                var lengthOfDirFromPivotUpperToendlowerarm = someDirFromPivotUpperToHand.Length();
                someDirFromPivotUpperToHand.Normalize();
                var someDirFromPivotUpperToA = pointA - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT;
                var lengthOfDirFromPivotUpperToA = someDirFromPivotUpperToA.Length();
                someDirFromPivotUpperToA.Normalize();


                Vector3 crossRes1111;
                Vector3.Cross(ref someDirFromPivothandtograb, ref grabtolowerfingersegmentendpos, out crossRes1111);
                crossRes1111.Normalize();

                Vector3 pointfromlowecurrenttolowerstart = someposoflowerarm + (-someDirFromPivotUpperToHand * _player_rght_lower_arm[0][0]._total_torso_depth * 6);

                var theuppermatrix = Matrix.LookAtRH(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT + someDirFromPivotUpperToHand, crossRes1111);
                theuppermatrix.Invert();


                Vector3 someposofthing = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT + (someDirFromPivotUpperToHand * _player_rght_upper_arm[0][0]._total_torso_depth * 6 * 0.5f);
                ...
                var someNewPointer = positionofshouldermovingpointer + (someDirFromPivotUpperToHand * oppositeSolvingForHalfA);
                ...
                Vector3 somelowercrossrightvec = someNewPointer + (updirupperarm);
                */
                /*
                matrixerer = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                matrixerer.M41 = someNewPointer.X;
                ...
                */
                ...
                matrixerer.M41 = someposofthing.X;
                matrixerer.M42 = someposofthing.Y;
                matrixerer.M43 = someposofthing.Z;
                ...
                var positionofshouldermovingpointer0 = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                somerotmatrixshoulder = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                Quaternion.RotationMatrix(ref somerotmatrixshoulder, out otherQuat);
                dirshoulderforward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                dirshoulderright = sc_maths._getDirection(Vector3.Right, otherQuat);
                dirshoulderup = sc_maths._getDirection(Vector3.Up, otherQuat);
                positionofshouldermovingpointer0 = positionofshouldermovingpointer0 + (dirshoulderforward * _player_rght_shldr[0][0]._total_torso_depth * 6 * 0.5f);
                positionofshouldermovingpointer0 = positionofshouldermovingpointer0 + (dirshoulderforward * _player_rght_upper_arm[0][0]._total_torso_depth * 6 * 0.5f);

                positionofuppermovingpointer = positionofshouldermovingpointer0;// new Vector3(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                ...
                positionofuppermovingpointer = positionofuppermovingpointer + (dirupperforward * _player_rght_upper_arm[0][0]._total_torso_depth * 6 * 0.5f);

                positionoflowermovingpointer = positionofuppermovingpointer + (dirupperforward * _player_rght_lower_arm[0][0]._total_torso_depth * 6 * 0.5f);//reallocation middle of lower finger segment ... middle finger;

                _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT = positionofuppermovingpointer;
                ...
                Vector3 somelowercrossrightvec = somePosOfRightHand0 + (crossRes10 * 0.1f);
                matrixerer = somerotmatrixshoulder;
                matrixerer.M41 = somelowercrossrightvec.X;
                matrixerer.M42 = somelowercrossrightvec.Y;
                matrixerer.M43 = somelowercrossrightvec.Z;
                ...
                Vector3 pointtofingertippivot0 = _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + (grabtolowerfingersegmentendpos0 * _player_rght_lower_arm[0][0]._total_torso_depth * 6 * 0.5f);
