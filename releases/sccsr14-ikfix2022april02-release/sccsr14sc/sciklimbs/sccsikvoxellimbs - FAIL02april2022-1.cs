            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    ...
                    var lengthOfHandheight = 1.0f;//_player_rght_hnd[0][0]._total_torso_width *
                    var lengthOfHandgrabheight = _player_r_hand_grab[0][0]._total_torso_height;
                    ...
                    {
                        somevec0 = somevec0 + (dirshoulderforward0 * totalArmLengthRight  * 0.5f);
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 3)
                {
                    ...
                    var lengthOfHandheight = 1f;//_player_rght_hnd[0][0]._total_torso_width *
                    var lengthOfHandgrabheight = _player_r_hand_grab[0][0]._total_torso_height * 1f;
                ...
                positionofshouldermovingpointer = positionofshouldermovingpointer + (dirshoulderforward * _player_rght_shldr[0][0]._total_torso_depth * 1 * 0.5f);
                positionofshouldermovingpointer = positionofshouldermovingpointer + (dirshoulderforward * _player_rght_upper_arm[0][0]._total_torso_depth * 1);
                positionofshouldermovingpointer = positionofshouldermovingpointer + (dirshoulderforward * _player_rght_lower_arm[0][0]._total_torso_depth * 1);
                ...
                Vector3 pointtofingertippivot = handgrabpos + (-grabtolowerfingersegmentendpos * _player_rght_hnd[0][0]._total_torso_depth * 1);
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                {
                    ...
                    if (lengthmax > (totalArmLengthRight * 1.0f))
                ...
                positionofshouldermovingpointer = positionofshouldermovingpointer + (dirshoulderforward * _player_rght_shldr[0][0]._total_torso_depth * 1 * 0.5f);
                positionofshouldermovingpointer = positionofshouldermovingpointer + (dirshoulderforward * _player_rght_upper_arm[0][0]._total_torso_depth * 1 * 0.5f);
                ...
                positionofuppermovingpointer = positionofuppermovingpointer + (dirshoulderforward * _player_rght_upper_arm[0][0]._total_torso_depth * 1 * 0.5f);

                var positionoflowermovingpointer = positionofuppermovingpointer + (dirshoulderforward * _player_rght_lower_arm[0][0]._total_torso_depth * 1 * 0.5f);//reallocation middle of lower finger segment ... middle finger;
                ...
                Vector3 pointtofingertippivot0 = _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + (grabtolowerfingersegmentendpos0 * _player_rght_lower_arm[0][0]._total_torso_depth * 1);

                Vector3 pivotpointoflower = _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + (grabtolowerfingersegmentendpos0 * _player_rght_lower_arm[0][0]._total_torso_depth * 1);
                ...
                //pivotpositionofuppermovingpointer = pivotpositionofuppermovingpointer + (dirshoulderforward * _player_rght_shldr[0][0]._total_torso_depth * 1 * 0.5f);
                positionofshouldermovingpointer = positionofshouldermovingpointer + (dirshoulderforward * _player_rght_shldr[0][0]._total_torso_depth * 1 * 0.5f);
                ...
                Vector3 pointtofingertippivot00 = someposoflowerarmstart + (-grabtolowerfingersegmentendpos00 * _player_rght_upper_arm[0][0]._total_torso_depth * 1 * 0.5f);

                _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = pointtofingertippivot00;// handgrabpos + (-grabtolowerfingersegmentendpos * _player_rght_hnd[0][0]._total_torso_depth * 1 * 1.5f);
                ...
                */
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    //someNewPointer = someNewPointer + (-updirupperarm * lengthOfHandRight * 1);
                }
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    someNewPointer = someNewPointer + (-updirupperarm * oppositeSolvingForHalfA);
                ...
                */
                ...
                {
                    Quaternion forTest1;
                    Matrix _rotMatrixer1 = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                    Quaternion.RotationMatrix(ref _rotMatrixer1, out forTest1);

                    direction_feet_forward_ori = sc_maths._getDirection(Vector3.ForwardRH, forTest1);
                    direction_feet_right_ori = sc_maths._getDirection(Vector3.Right, forTest1);
                    direction_feet_up_ori = sc_maths._getDirection(Vector3.Up, forTest1);

                    somenewtargetlocation = (_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * lengthOfUpperArmRight * 1* 0.5f);// + (direction_feet_right_ori * totalArmLengthRight * 2);

                    somenewtargetlocation = somenewtargetlocation + (direction_feet_forward_ori * totalArmLengthRight * 1);
                    somenewtargetlocation = somenewtargetlocation + (-direction_feet_right_ori * totalArmLengthRight * 1);
                }
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    //someNewPointer = (_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (dirtohandinvertedx * totalArmLengthRight * 2);
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 2)
                {
                    //someNewPointer = (_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (dirtohandinvertedx * totalArmLengthRight * 2);
                    //somenewtargetlocation = (_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * totalArmLengthRight * 2);
                    //someNewPointer = someNewPointer + (direction_feet_up_ori * totalArmLengthRight * 1);
                    //somenewtargetlocation = somenewtargetlocation + (direction_feet_up_ori * totalArmLengthRight * 1);
                    //somenewtargetlocation = somenewtargetlocation + (direction_feet_forward_ori * totalArmLengthRight * 10);
                    Quaternion forTest1;
                    Matrix _rotMatrixer1 = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                    Quaternion.RotationMatrix(ref _rotMatrixer1, out forTest1);
                    ...
                    somenewtargetlocation = (_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * lengthOfUpperArmRight * 1.0f * 0.5f);// + (direction_feet_right_ori * totalArmLengthRight * 2);
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    somenewtargetlocation = (_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * lengthOfUpperArmRight * 1.0f);// + (direction_feet_right_ori * totalArmLengthRight * 2);
                ...
                //var sometotalarmlength2 = totalArmLengthRight * 1;
                Vector3 crossRes;
                Vector3.Cross(ref someDirFromElbowTargetOneToTwo, ref someDirFromElbowTargetOneToRghtHand, out crossRes);
                crossRes.Normalize();
                //crossRes *= -1;
