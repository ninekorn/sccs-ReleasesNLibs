...
namespace sccs
{
    public class sccsikvoxellimbs : IDisposable
    {
        ...
        public scmessageobjectjitter[][] createikbody(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, Matrix worldmatofobj_, int human_inst_rig_x, int human_inst_rig_y, int human_inst_rig_z, int grabtargetitem_)
        {
            ...
            _tempMatroxer.M41 = 0;
            _tempMatroxer.M42 = -0.55f + initchunkposition.Y; //-0.485f
            _tempMatroxer.M43 = 0;
            _tempMatroxer.M44 = 1;
        ...
        public scmessageobjectjitter[][] createikarm(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxelindex, int human_inst_limbs_x, int human_inst_limbs_y, int human_inst_limbs_z, int grabtargetitem_, int typeoflimb, sccsikvoxellimbs ikvoxellimb)
        {
            ...
            9, 9, 9, 14, 14, 14, 14, 14, 14, 13, 12, 34, 33, 13, 12,
            voxel_general_size, new Vector3(0, 0, 0), 30, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            */
            ...
            _player_rght_hnd[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight,
                0, 1, 1, 1, 0.0125f, 0.035f, 0.055f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    MOVINGPOINTER = new Vector3(ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);


                    var handrotmat = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos;// _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._SHOULDERROT;
                    Quaternion.RotationMatrix(ref handrotmat, out otherQuat);
                    direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                    direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                    direction_head_up = sc_maths._getDirection(Vector3.Up, otherQuat);
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        var somefingerpos = MOVINGPOINTER + (direction_head_forward * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 75));


                        if (somechunkpriminstanceikfingervoxelindex == 0)
                        {
                            somefingerpos = somefingerpos + (-direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.35f));

                        }

                        else if (somechunkpriminstanceikfingervoxelindex == 1)
                        {
                            somefingerpos = somefingerpos + (-direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.15f));

                        }

                        else if (somechunkpriminstanceikfingervoxelindex == 2)
                        {
                            somefingerpos = somefingerpos + (direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.05f));

                        }
                        else if (somechunkpriminstanceikfingervoxelindex == 3)
                        {
                            somefingerpos = somefingerpos + (direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.25f));
                        ...
                        else if (somechunkpriminstanceikfingervoxelindex == 4)
                        {
                            ...
                            handrotmat = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos;// _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._SHOULDERROT;
                            Quaternion.RotationMatrix(ref handrotmat, out otherQuat);
                            direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                            direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                            direction_head_up = sc_maths._getDirection(Vector3.Up, otherQuat);

                            somefingerpos = MOVINGPOINTER + (direction_head_forward * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 50));

                            //somefingerpos = somefingerpos + (direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 100 * 0.5f));
                            somefingerpos = somefingerpos + (direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 5.5f * 0.50f));

                        }
                        matrixerer = handrotmat;
                    ...
                    else if (somechunkpriminstanceikarmvoxelindex == 1 || somechunkpriminstanceikarmvoxelindex == 2)
                    {
                        ...
                        var somefingerpos = MOVINGPOINTER + (direction_head_forward * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 25));


                        if (somechunkpriminstanceikfingervoxelindex == 0)
                        {
                            somefingerpos = somefingerpos + (-direction_feet_right * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.35f));
                        }
                        else if (somechunkpriminstanceikfingervoxelindex == 1)
                        {
                            somefingerpos = somefingerpos + (-direction_feet_right * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.15f));
                        }
                        else if (somechunkpriminstanceikfingervoxelindex == 2)
                        {
                            somefingerpos = somefingerpos + (direction_feet_right * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.05f));
                        }
                        else if (somechunkpriminstanceikfingervoxelindex == 3)
                        {
                            somefingerpos = somefingerpos + (direction_feet_right * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.25f));
                        }
                        else if (somechunkpriminstanceikfingervoxelindex == 4)
                        {
                            /*MOVINGPOINTER = new Vector3(ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                            ...
                            somefingerpos = MOVINGPOINTER + (direction_head_forward * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 25));

                            //somefingerpos = somefingerpos + (direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 100 * 0.5f));
                            somefingerpos = somefingerpos + (direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 5.5f * 0.50f));
                            */
                            somefingerpos = somefingerpos + (direction_feet_right * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 6 * 0.45f));
                    ...
                    /*Vector3 handposition = new Vector3(ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                    
                    
                    var shoulderMatrix = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos;// _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._SHOULDERROT;
                    Quaternion.RotationMatrix(ref shoulderMatrix, out otherQuat);
                    direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                    direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                    direction_head_up = sc_maths._getDirection(Vector3.Up, otherQuat);

                    //Console.WriteLine(ikvoxellimb._player_rght_hnd[0][0]._total_torso_height);
                    realPosOfRS = handposition + (-direction_head_right * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width));// TORSOPIVOT + (dirToPoint * ((ikvoxelbody._player_torso[0][0]._total_torso_height)));
                                                                                                                                 //pivotOfHead = TORSOPIVOT + (dirToPoint * ((ikvoxelbody._player_torso[0][0]._total_torso_height)));

                    //realPosOfRS = realPosOfRS + (direction_feet_right_ori * (_player_rght_shldr[0][0]._total_torso_width * 8));

                    var theheadrotmatrix = Matrix.LookAtRH(handposition, handposition + direction_head_right, direction_head_up);
                    theheadrotmatrix.Invert();


                    matrixerer = shoulderMatrix;// theheadrotmatrix;
                    ...
                    /*
                    //SAVING IN MEMORY THE ORIGINAL TORSO MATRIX NOT AFFECTED BY CURRENT POSITION AND ROTATION CHANGES.
                    _rotMatrixer = mainarmparentmeshobject._arrayOfInstances[_iterator]._ORIGINPOSITION;// _player_torso[0][0]._ORIGINPOSITION;
                    //Quaternion forTest;
                    Quaternion.RotationMatrix(ref _rotMatrixer, out forTest);

                    //FROM THE MATRIX OF ROTATION/POSITION, I GET THE QUATERNION OUT OF THAT AND CREATE THE DIRECTIONS THAT THE OBJECTS ARE ORIGINALLY FACING.
                    direction_feet_forward_ori_torso = sc_maths._getDirection(Vector3.ForwardRH, forTest);
                    direction_feet_right_ori_torso = sc_maths._getDirection(Vector3.Right, forTest);
                    direction_feet_up_ori_torso = sc_maths._getDirection(Vector3.Up, forTest);

                    //SINCE THE PIVOT POINT IS CURRENTLY IN THE MIDDLE OF THE TORSO, IT CANNOT ROTATE AT THAT POINT OTHERWISE, IT WONT FOLLOW THE PELVIS ROTATION LATER ON.
                    //SO WE CURRENTLY ONLY OFFSET THE TORSO "MIDDLE OF SPINE APPROX" TO HALF OF THE CURRENT HEIGHT IN ORDER TO MAKE THE PIVOT POINT, APPROX WHERE THE PELVIS IS.
                    TORSOPIVOT = MOVINGPOINTER + -(direction_feet_up_ori_torso * (mainarmparentmeshobject._total_torso_height * 0.5f));
                    */
                }
                ...
                //////HANDRIGHTGRAB//////
                //MOVINGPOINTER = new Vector3(ikvoxelbody._player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, ikvoxelbody._player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, ikvoxelbody._player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                MOVINGPOINTER = new Vector3(ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                ...
                **/
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0)
                    {
                        var shoulderMatrixx = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;


                        Quaternion.RotationMatrix(ref shoulderMatrixx, out otherQuat);
                        var direction_head_forward0 = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                        var direction_head_right0 = sc_maths._getDirection(Vector3.Right, otherQuat);
                        var direction_head_up0 = sc_maths._getDirection(Vector3.Up, otherQuat);
                        ...
                        somevec0 = somevec0 - (direction_head_forward0 * lengthOfHandheight * 0.001f);
                        somevec0 = somevec0 - (-direction_head_right0 * lengthOfHandheight * 0.001f);
                        ...
                        {
                            tempVect = (somevec0) + (direction_head_right0 * ((lengthOfHandheight * sccs.scgraphics.scupdate.handTriggerLeft[0] * 0.015f * 1.0923f)));
                        }
                        else
                        {
                            tempVect = (somevec0) + (direction_head_right0 * ((lengthOfHandheight * 0.025f * 1.0923f)));
                        }
                        ...
                        if (sccs.scgraphics.scupdate.handTriggerLeft[0] > 0.00000001f)
                        {
                            tempVect = (tempVect) + (direction_head_forward0 * ((lengthOfHandheight * (1 - sccs.scgraphics.scupdate.handTriggerLeft[0]) * 0.03f * 1.0923f)));

                        }
                        else
                        {
                            tempVect = (tempVect) + (direction_head_forward0 * ((lengthOfHandheight * 0.03f * 1.0923f)));
                        }
                    ...
                    else if (somechunkpriminstanceikarmvoxelindex == 1)
                    {
                        ...
                        Vector3 tempVect = Vector3.Zero;
                        if (sccs.scgraphics.scupdate.handTriggerRight[1] > 0.0000000001f)
                        {
                            tempVect = (somevec0) + (-direction_feet_up * ((lengthOfHandheight * sccs.scgraphics.scupdate.handTriggerRight[1] * 0.015f * 1.0923f)));
                        }
                        else
                        {
                            tempVect = (somevec0) + (-direction_feet_up * ((lengthOfHandheight * 0.015f * 1.0923f)));
                        }
                        ...
                        if (sccs.scgraphics.scupdate.handTriggerRight[1] > 0.0000000001f)
                        {
                            tempVect = (tempVect) + (direction_head_forward0 * ((lengthOfHandheight * (1 - sccs.scgraphics.scupdate.handTriggerRight[1]) * 0.02f * 1.0923f)));

                        }
                        else
                        {
                            tempVect = (tempVect) + (direction_head_forward0 * ((lengthOfHandheight * 0.02f * 1.0923f)));
                        }
                        //Vector3 tempVect = (somevec0) + (-direction_head_right0 * ((lengthOfHandheight * sccs.scgraphics.scupdate.handTriggerRight[1]* 0.05f * 1.0923f)));
                        //tempVect = (tempVect) + (direction_head_up0 * 0.005f * 1.0923f);
                    ...
                    else if (somechunkpriminstanceikarmvoxelindex == 2)
                    {
                        ...
                        Vector3 tempVect = Vector3.Zero;
                        if (sccs.scgraphics.scupdate.handTriggerLeft[0] > 0.0000000001f)
                        {
                            tempVect = (somevec0) + (-direction_feet_up * ((lengthOfHandheight * sccs.scgraphics.scupdate.handTriggerLeft[0] * 0.015f * 1.0923f)));
                        }
                        else
                        {
                            tempVect = (somevec0) + (-direction_feet_up * ((lengthOfHandheight * 0.015f * 1.0923f)));
                        ...
                        if (sccs.scgraphics.scupdate.handTriggerLeft[0] > 0.0000000001f)
                        {
                            tempVect = (tempVect) + (direction_head_forward0 * ((lengthOfHandheight * (1 - sccs.scgraphics.scupdate.handTriggerLeft[0]) * 0.02f * 1.0923f)));
                    ...
                    else if (somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        if (sccs.scgraphics.scupdate.handTriggerRight[1] > 0.0000000001f)
                        {
                            tempVect = (somevec0) + (-direction_head_right0 * ((lengthOfHandheight * sccs.scgraphics.scupdate.handTriggerRight[1] * 0.015f * 1.0923f)));
                        }
                        else
                        {
                            tempVect = (somevec0) + (-direction_head_right0 * ((lengthOfHandheight * 0.015f * 1.0923f)));
                        }
                ...
                */
                ...
                { //TRYING TO MOVE IK OF HAND GRAB FAIL EXPERIMENT
                  ...
                  //TRYING TO MOVE IK OF HAND GRAB FAIL EXPERIMENT
                    ...
                    {
                        /*
                        Vector3 posRHand = new Vector3(_player_r_hand_grab[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M41, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M42, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M43);

                        Vector3 tempDir = posRHand - _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;
                ...
                {
                    /*var posRHand = new Vector3(_player_r_hand_grab[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M41, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M42, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M43);

                    var tempDir = posRHand - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;
                ...
                //var shoulderMatrixx = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                matrixerer = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;// someMatRight * finalRotationMatrix;
                ...
                */
                ...
                //////HANDRIGHT//////
                //MOVINGPOINTER = new Vector3(ikvoxelbody._player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, ikvoxelbody._player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, ikvoxelbody._player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                MOVINGPOINTER = new Vector3(ikvoxellimb._player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, ikvoxellimb._player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, ikvoxellimb._player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                ...
                */
                ...
                Vector3 somegrabposition = MOVINGPOINTER + (mainarmparentmeshobject._arrayOfInstances[_iterator].forwarddirection * (diffNormPosZ * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + (mainarmparentmeshobject._arrayOfInstances[_iterator].forwarddirection * (diffNormPosZ * 0.5f));

                MOVINGPOINTER.X += OFFSETPOS.X;
                MOVINGPOINTER.Y += OFFSETPOS.Y;
                MOVINGPOINTER.Z += OFFSETPOS.Z;

                var posRHandd = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M43);
                Vector3 tempDirr = posRHandd - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;
                ...
                if (typeoflimb == 0)
                {
                    ...
                    tempDirr = posRHandd - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;
                    if (tempDirr.Length() > lengthOfLowerArmRight * connectorOfHandOffsetMul && lengthOfLowerArmRight != 0)
                    {
                        ...
                        tempDirr.Normalize();
                        var somePosOfSHLDR = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                        Vector3 tempVect = somePosOfSHLDR + (tempDirr * ((lengthOfLowerArmRight * 1.0923f) + (lengthOfUpperArmRight * 1.0923f)));
                        MOVINGPOINTER.X = tempVect.X;
                        MOVINGPOINTER.Y = tempVect.Y;
                        MOVINGPOINTER.Z = tempVect.Z;
                    }
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    /*var shoulderMatrixx = _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos;// _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._SHOULDERROT;
                    Quaternion.RotationMatrix(ref shoulderMatrixx, out otherQuat);
                    direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                    direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                    direction_head_up = sc_maths._getDirection(Vector3.Up, otherQuat);
                    */
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        Vector3 endhandpos = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION.M43);  //_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION;
                        ...
                        Vector3 handtohandgrabdir0 = handgrabpos - somePosOfSHLDR;

                        //Vector3 dirhandtograb = handgrabpos - posofhand;
                        float somelength0 = handtohandgrabdir0.Length();
                        handtohandgrabdir0.Normalize();



                        Vector3 lowerarmpos = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);

                        Vector3 currentFINALPIVOTUPPERARM1 = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43) + (direction_feet_up_ori * (_player_rght_shldr[0][0]._total_torso_height * connectorOfUpperArmRightOffsetMul));// realPIVOTOfUpperArm;
                        Vector3 lowerarmtotarget = handgrabpos - lowerarmpos;
                        lowerarmtotarget.Normalize();


                        Vector3 elbowpositiontofingertipp = lowerarmendpos + (handtohandgrabdir0 * lengthOfUpperArmRight);
                        tempDirr = elbowpositiontofingertipp - currentFINALPIVOTUPPERARM1;
                        float somelength2 = tempDirr.Length();



                        Vector3 handtohandgrabdir1 = handgrabpos - elbowpositiontofingertipp;


                        Vector3 someposofelbowlowerarm = lowerarmpos + (lowerarmtotarget * _player_rght_lower_arm[0][0]._total_torso_height * 0.5f);


                        Vector3 somePosererDirr = somePosOfRightHandd - handgrabpos;
                        somePosererDirr.Normalize();
                        ...
                        var someDirFromElbowTargetOneToRghtHand1 = somePosOfRightHandd - somePosOfUpperElbowTargetOne1;

                        Vector3 crossRes1;
                        Vector3.Cross(ref someDirFromElbowTargetOneToTwo1, ref someDirFromElbowTargetOneToRghtHand1, out crossRes1);
                        crossRes1.Normalize();

                        var pointA1 = lowerarmendpos + (-crossRes1);
                        var someDirFromPivotUpperToHand1 = somePosOfRightHandd - handgrabpos;
                        var lengthOfDirFromPivotUpperToHand1 = someDirFromPivotUpperToHand1.Length();
                        someDirFromPivotUpperToHand1.Normalize();
                        var someDirFromPivothandtograb = pointA1 - lowerarmendpos;
                        ...
                        Vector3 somepointermove = somePosOfSHLDR + (direction_feet_right_ori * lengthOfUpperArmRight);

                        _rotMatrixer = _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos;
                        ...
                        somepointermove = somepointermove + (direction_feet_right_ori * lengthOfLowerArmRight);

                        somepointermove = somepointermove + (handtohandgrabdir1 * lengthOfHandRight);

                        MOVINGPOINTER = somepointermove;



                        Vector3 someendhandpos = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION.M43);

                        Vector3 posshouldertolowerarm = somePosOfSHLDR - lowerarmendpos;//lowerarmendpos;
                        //var somelength3 = (posshouldertolowerarm).Length();


                        posshouldertolowerarm.Normalize();


                        //handtohandgrabdir1 *= -1;


                        Vector3 crossRes111;
                        Vector3.Cross(ref someDirFromPivothandtograb, ref posshouldertolowerarm, out crossRes111);
                        crossRes111.Normalize();

                        crossRes111 *= -1;
                        //var thehandmatrix = Matrix.LookAtRH(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + tempDirr, somePosererDirr);
                        var thehandmatrix = Matrix.LookAtRH(lowerarmendpos, lowerarmendpos + posshouldertolowerarm, crossRes111);
                        thehandmatrix.Invert();

                        matrixerer = thehandmatrix;// finalRotationMatrix;
                        ...
                        /*
                        var lengthofdirfromlowerpivottoendhand1 = (lowerarmendpos - endhandpos).Length();
                        ...
                        var somenewpoint = lowerarmpos + (handtohandgrabdir1 * adjacentSolvingForXtohand1);



                        var matrixererr = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;//finalRotationMatrix;

                        matrixererr.M41 = somenewpoint.X;
                        matrixererr.M42 = somenewpoint.Y;
                        matrixererr.M43 = somenewpoint.Z;
                        ...
                        //JQuaternion _other_quat = new JQuaternion(_quat.X, _quat.Y, _quat.Z, _quat.W);
                        // matrixIn = JMatrix.CreateFromQuaternion(_other_quat);
                        worldMatrix_instances_r_elbow_target_three[0][0][_iterator] = matrixererr;
                        _player_rght_elbow_target_three[0][0]._arrayOfInstances[_iterator].current_pos = matrixererr;
                        */
                        ...
                        /*Vector3 somecrossUpvec;
                        Vector3.Cross(ref someDirFromPivotUpperToA, ref someDirFromPivotUpperToHand, out somecrossUpvec);
                        somecrossUpvec.Normalize();

                        someDirFromElbowTargetOneToTwo.Normalize();

                        if (somechunkpriminstanceikarmvoxelindex == 0)
                        {
                            someNewPointer = someNewPointer + (-somecrossUpvec * oppositeSolvingForHalfAtohand);
                        ...
                        elbowpositiontofingertip = currentFINALPIVOTUPPERARM + -(direction_feet_forward_ori * lengthOfUpperArmRight);
                        dirpivottoelbow = elbowpositiontofingertip - currentFINALPIVOTUPPERARM;
                        ...
                        currentPositionOfUPPERARMROTATION3DPOSITION = currentFINALPIVOTUPPERARM;
                        ...
                        if (somelength0 > ((lengthOfLowerArmRight * 1.0f) + (lengthOfUpperArmRight * 1.0f)) && (lengthOfLowerArmRight + lengthOfUpperArmRight) != 0)
                        //if (tempDirr.Length() > lengthOfLowerArmRight * connectorOfHandOffsetMul && lengthOfLowerArmRight != 0)
                        {
                            //Console.WriteLine("> tempDir.Length " + somechunkpriminstanceikarmvoxelindex);
                            //Program.MessageBox((IntPtr)0, "" + tempDir.Length(), "sc core systems message", 0);
                            tempDirr.Normalize();
                            Vector3 tempVect = somePosOfSHLDR + (handtohandgrabdir0 * ((lengthOfLowerArmRight * 1.0923f * 1.0f) + (lengthOfUpperArmRight * 1.0923f * 1.0f)));
                            MOVINGPOINTER.X = tempVect.X;
                            MOVINGPOINTER.Y = tempVect.Y;
                            MOVINGPOINTER.Z = tempVect.Z;
                        ...
                        {
                            /*handtohandgrabdir0 = someendhandpos - somePosOfSHLDR;
                            //Vector3 dirhandtograb = handgrabpos - posofhand;
                            somelength0 = handtohandgrabdir0.Length();
                            handtohandgrabdir0.Normalize();*/


                            tempDirr.Normalize();
                            Vector3 tempVect = somePosOfSHLDR + (posshouldertolowerarm * somelength0);
                            MOVINGPOINTER.X = tempVect.X;
                            MOVINGPOINTER.Y = tempVect.Y;
                            MOVINGPOINTER.Z = tempVect.Z;
                        }
                        ...
                        /*tempDirr.Normalize();
                        Vector3 tempVect = somePosOfSHLDR + (handtohandgrabdir * somelength);
                        MOVINGPOINTER.X = tempVect.X;
                        MOVINGPOINTER.Y = tempVect.Y;
                        MOVINGPOINTER.Z = tempVect.Z;*/
                        ...
                        /*
                        tempDirr.Normalize();
                        Vector3 tempVect = somePosOfSHLDR + (tempDirr * somelength);
                        MOVINGPOINTER.X = tempVect.X;
                        MOVINGPOINTER.Y = tempVect.Y;
                        MOVINGPOINTER.Z = tempVect.Z;*/
                        ...
                        Vector3 handgrabpos = new Vector3(_player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                        Vector3 handtohandgrabdir = handgrabpos - somePosOfSHLDR;


                        var lowerarmpos = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);

                        Vector3 grabtolower = handgrabpos - lowerarmpos;
                        grabtolower.Normalize();

                        //Vector3 dirhandtograb = handgrabpos - posofhand;
                        float somelength = handtohandgrabdir.Length();


                        //Vector3 handpivottograb = handgrabpos - pivothand;

                        Vector3 lowerarmpivot = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;// new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                        Vector3 pivothand = lowerarmpivot + (grabtolower * lengthOfLowerArmRight * 0.5f);

                        handtohandgrabdir = handgrabpos - pivothand;
                        handtohandgrabdir.Normalize();
                        ...
                        Vector3 elbowpositiontofingertipp = currentFINALPIVOTUPPERARM1 + (handtohandgrabdir * lengthOfUpperArmRight);
                        tempDirr = elbowpositiontofingertipp - currentFINALPIVOTUPPERARM1;
                        float somelength2 = tempDirr.Length();
                        ...
                        var pointA1 = someposofelbowlowerarm + (-crossRes1);
                        var someDirFromPivotUpperToHand1 = somePosOfRightHandd - handgrabpos;
                        var lengthOfDirFromPivotUpperToHand1 = someDirFromPivotUpperToHand1.Length();
                        someDirFromPivotUpperToHand1.Normalize();
                        var somedirtopointAcross = pointA1 - someposofelbowlowerarm;
                        somedirtopointAcross.Normalize();


                        Vector3 lowertograb = lowerarmpos - handgrabpos;
                        lowertograb.Normalize();

                        Vector3 crossRes111;
                        Vector3.Cross(ref somedirtopointAcross, ref handtohandgrabdir, out crossRes111);
                        crossRes111.Normalize();


                        var thehandmatrix = Matrix.LookAtRH(pivothand, pivothand + handtohandgrabdir, crossRes111);
                        thehandmatrix.Invert();

                        matrixerer = thehandmatrix;
                        //
                        //Vector3 pivothandtograb = pivothand - handgrabpos;
                        //pivothandtograb.Normalize();

                        //var thehandmatrix = Matrix.LookAtRH(pivothand, pivothand + crossRes111 , grabtolower);
                        //thehandmatrix.Invert();
                        //matrixerer = thehandmatrix;

                        //tempDirr.Length() > (lengthOfLowerArmRight + lengthOfUpperArmRight * 0.1f) * connectorOfHandOffsetMul && (lengthOfLowerArmRight + lengthOfUpperArmRight * 0.1f) != 0
                        if (somelength > ((lengthOfLowerArmRight * 1.0f) + (lengthOfUpperArmRight * 1.0f)) && (lengthOfLowerArmRight + lengthOfUpperArmRight) != 0)
                        //if (tempDirr.Length() > lengthOfLowerArmRight * connectorOfHandOffsetMul && lengthOfLowerArmRight != 0)
                        {
                            //Console.WriteLine("> tempDir.Length " + somechunkpriminstanceikarmvoxelindex);
                            //Program.MessageBox((IntPtr)0, "" + tempDir.Length(), "sc core systems message", 0);
                            tempDirr.Normalize();
                            Vector3 tempVect = somePosOfSHLDR + (tempDirr * ((lengthOfLowerArmRight * 1.0923f * 1.0f) + (lengthOfUpperArmRight * 1.0923f * 1.0f)));
                            MOVINGPOINTER.X = tempVect.X;
                            MOVINGPOINTER.Y = tempVect.Y;
                            MOVINGPOINTER.Z = tempVect.Z;
                        ...
                        else
                        {
                            ...
                            //MOVINGPOINTER.X = pivothand.X;
                            //MOVINGPOINTER.Y = pivothand.Y;
                            //MOVINGPOINTER.Z = pivothand.Z;
                        }*/
                        ...
                        //TORSOPIVOT = MOVINGPOINTER;
                        /*
                        MOVINGPOINTER = new Vector3(_player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_r_hand_grab[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                        var currentFINALPIVOTUPPERARM1 = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43) + (direction_feet_up_ori * (_player_rght_lower_arm[0][0]._total_torso_height * connectorOfUpperArmRightOffsetMul));// realPIVOTOfUpperArm;

                        //var currentelbowposition = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.X, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Y, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Z) + (direction_feet_up_ori * (_player_rght_lower_arm[0][0]._total_torso_height * connectorOfUpperArmRightOffsetMul));// realPIVOTOfUpperArm;
                        var currentelbowposition = _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;// realPIVOTOfUpperArm;

                        Vector3 dirgrabtolower = currentFINALPIVOTUPPERARM1 - MOVINGPOINTER;
                        dirgrabtolower.Normalize();

                        MOVINGPOINTER = MOVINGPOINTER - (dirgrabtolower * lengthOfHandRight * 0.5f);
                        ...
                        direction_feet_right_ori = sc_maths._getDirection(Vector3.Right, forTest);
                        direction_feet_up_ori = sc_maths._getDirection(Vector3.Up, forTest);
                        var realPIVOTOfUpperArm1 = currentFINALPIVOTUPPERARM1;

                        _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT = currentFINALPIVOTUPPERARM1;
                        ...
                        var somePosOfUpperElbowTargetOne1 = new Vector3(_player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                        var someDirFromElbowTargetOneToTwo1 = somePosOfUpperElbowTargetTwo1 - somePosOfUpperElbowTargetOne1;
                        var someDirFromElbowTargetOneToRghtHand1 = somePosOfRightHand1 - somePosOfUpperElbowTargetOne1;
                        ...
                        crossRes1.Normalize();
                        //crossRes *= -1;
                        var pointA1 = realPIVOTOfUpperArm1 + (crossRes1);


                       var someDirFromPivotUpperToHand1 = somePosOfRightHand1 - realPIVOTOfUpperArm1;
                       var lengthOfDirFromPivotUpperToHand1 = someDirFromPivotUpperToHand1.Length();
                        someDirFromPivotUpperToHand1.Normalize();
                       var someDirFromPivotUpperToA1 = pointA1 - realPIVOTOfUpperArm1;
                       var  lengthOfDirFromPivotUpperToA1 = someDirFromPivotUpperToA1.Length();
                        someDirFromPivotUpperToA1.Normalize();
                        _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ARMLENGTH = totalArmLengthRight;



                        lengthOfDirFromPivotUpperToHand1 = Math.Min(lengthOfDirFromPivotUpperToHand1, totalArmLengthRight - totalArmLengthRight * 0.001f);

                        var upperEquationCirCirIntersect1 = (lengthOfDirFromPivotUpperToHand1 * lengthOfDirFromPivotUpperToHand1) - (lengthOfLowerArmRight * lengthOfLowerArmRight) + (lengthOfUpperArmRight * lengthOfUpperArmRight);
                        var adjacentSolvingForX1 = upperEquationCirCirIntersect1 / (2 * lengthOfDirFromPivotUpperToHand1);
                        adjacentSolvingForX1 = Math.Min(adjacentSolvingForX1, lengthOfUpperArmRight - lengthOfUpperArmRight * 0.001f);
                        var resulter1 = Math.Pow(lengthOfUpperArmRight, 2) - Math.Pow(adjacentSolvingForX1, 2);
                        if (resulter1 < 0)
                        {
                            resulter1 *= -1;
                        }
                        var oppositeSolvingForHalfA1 = (float)Math.Sqrt(resulter1);
                        oppositeSolvingForHalfA1 = Math.Min(oppositeSolvingForHalfA1, lengthOfUpperArmRight - lengthOfUpperArmRight * 0.001f);



                        var someNewPointer1 = realPIVOTOfUpperArm1 + (someDirFromPivotUpperToHand1 * adjacentSolvingForX1);


                        Vector3.Cross(ref someDirFromPivotUpperToA1, ref someDirFromPivotUpperToHand1, out crossRes1);
                        crossRes1.Normalize();

                        someDirFromElbowTargetOneToTwo1.Normalize();

                        if (somechunkpriminstanceikarmvoxelindex == 0)
                        {
                            someNewPointer1 = someNewPointer1 + (-crossRes1 * oppositeSolvingForHalfA1);
                        ...
                        var elbowpositiontofingertip1 = currentFINALPIVOTUPPERARM1 + -(direction_feet_forward_ori * lengthOfUpperArmRight);
                        var dirpivottoelbow1 = elbowpositiontofingertip1 - currentFINALPIVOTUPPERARM1;
                        dirpivottoelbow1.Normalize();

                       var elbowPositionRight1 = someNewPointer1;
                        //var elbowPositionRight = elbowpositiontofingertip;


                        _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = elbowPositionRight1;


                        //_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = elbowPositionRight;
                        var dirPivotUpperRIghtToElbowRight1 = elbowPositionRight1 - currentFINALPIVOTUPPERARM1;
                        //var currentPositionOfUPPERARMROTATION3DPOSITION = currentFINALPIVOTUPPERARM + (dirPivotUpperRIghtToElbowRight * 0.5f);

                       /*var currentPositionOfUPPERARMROTATION3DPOSITION1 = currentFINALPIVOTUPPERARM1;

                        if (somechunkpriminstanceikarmvoxelindex == 0)
                        {
                            currentPositionOfUPPERARMROTATION3DPOSITION1 = currentFINALPIVOTUPPERARM1 + (dirPivotUpperRIghtToElbowRight1 * 0.5f);
                        }
                        else if (somechunkpriminstanceikarmvoxelindex == 1)
                        {
                            currentPositionOfUPPERARMROTATION3DPOSITION1 = currentFINALPIVOTUPPERARM1 + (dirPivotUpperRIghtToElbowRight1);
                        }
                        else if (somechunkpriminstanceikarmvoxelindex == 2)
                        {
                            currentPositionOfUPPERARMROTATION3DPOSITION1 = currentFINALPIVOTUPPERARM1 + (dirPivotUpperRIghtToElbowRight1);
                        ...
                        /*var  dirElbowRightToHand1 = somePosOfRightHand1 - elbowPositionRight1;
                         dirPivotUpperRIghtToElbowRight1.Normalize();
                         dirElbowRightToHand1.Normalize();
                         Vector3 someCross01;
                         Vector3.Cross(ref dirPivotUpperRIghtToElbowRight1, ref dirElbowRightToHand1, out someCross01);
                         someCross01.Normalize();

                         _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ELBOWCROSSVEC = someCross01;
                         Vector3 someCross11;
                         Vector3.Cross(ref dirPivotUpperRIghtToElbowRight1, ref someCross01, out someCross11);
                         someCross11.Normalize();


                         var shoulderRotationMatrixRight1 = Matrix.LookAtRH(currentelbowposition, currentelbowposition + someCross11, dirPivotUpperRIghtToElbowRight1);
                         shoulderRotationMatrixRight1.Invert();

                         matrixerer = shoulderRotationMatrixRight1;

                         _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._SHOULDERROT = shoulderRotationMatrixRight1;
                         /*matrixerer.M41 = currentelbowposition.X;
                         matrixerer.M42 = currentelbowposition.Y;
                         matrixerer.M43 = currentelbowposition.Z;
                         matrixerer.M44 = 1;

                         MOVINGPOINTER.X = currentelbowposition.X;
                         MOVINGPOINTER.Y = currentelbowposition.Y;
                         MOVINGPOINTER.Z = currentelbowposition.Z;*/



                        //_body_pos = matrixerer;
                        //Quaternion _quat1;
                        //Quaternion.RotationMatrix(ref _body_pos, out _quat1);
                        //var _other_quat1 = new JQuaternion(_quat1.X, _quat1.Y, _quat1.Z, _quat1.W);
                        //var matrixIn1 = JMatrix.CreateFromQuaternion(_other_quat1);
                        //worldMatrix_instances_r_hand[0][0][_iterator] = matrixerer;
                        //_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos = matrixerer;
                    ...
                    else if (somechunkpriminstanceikarmvoxelindex == 1 || somechunkpriminstanceikarmvoxelindex == 2)
                    {
                        ...
                        Vector3 currentFINALPIVOTUPPERARM1 = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43) + (direction_feet_up_ori * (_player_rght_shldr[0][0]._total_torso_height * connectorOfUpperArmRightOffsetMul));// realPIVOTOfUpperArm;
                        Vector3 lowerarmtotarget = handgrabpos - currentFINALPIVOTUPPERARM1;
                        lowerarmtotarget.Normalize();
                        ...
                        //var thehandmatrix = Matrix.LookAtRH(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + tempDirr, somePosererDirr);
                        var thehandmatrix = Matrix.LookAtRH(someposofelbowlowerarm, someposofelbowlowerarm + somePosererDirr, tempDirr);
                ...
                _rotMatrixer = _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos;
                Quaternion.RotationMatrix(ref _rotMatrixer, out forTest);
                direction_feet_forward_ori = sc_maths._getDirection(Vector3.ForwardRH, forTest);
                direction_feet_right_ori = sc_maths._getDirection(Vector3.Right, forTest);
                direction_feet_up_ori = sc_maths._getDirection(Vector3.Up, forTest);
                ...
                Vector3 endhand = MOVINGPOINTER + (direction_feet_forward_ori * lengthOfHandRight * 10);
                matrixerer.M41 = endhand.X;
                matrixerer.M42 = endhand.Y;
                matrixerer.M43 = endhand.Z;
                matrixerer.M44 = 1;
                ...
                var posRHand1 = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._LASTPOSITION.M43);
                Vector3 tempDir1 = posRHand1 - _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;



                if (tempDir1.Length() > lengthOfLowerArmRight * connectorOfHandOffsetMul && lengthOfLowerArmRight != 0)
                {
                    //Console.WriteLine("> tempDir.Length " + somechunkpriminstanceikarmvoxelindex);
                    //Program.MessageBox((IntPtr)0, "" + tempDir.Length(), "sc core systems message", 0);
                    tempDir1.Normalize();
                    var somePosOfSHLDR = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                    Vector3 tempVect = somePosOfSHLDR + (tempDir1 * ((lengthOfLowerArmRight * 1.0923f) + (lengthOfUpperArmRight * 1.0923f)));
                    MOVINGPOINTER.X = tempVect.X;
                    MOVINGPOINTER.Y = tempVect.Y;
                    MOVINGPOINTER.Z = tempVect.Z;
                }
                ...
                */
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        someNewPointer = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_right_ori * totalArmLengthRight * 2);
                        //someNewPointer = someNewPointer + (direction_feet_up_ori * totalArmLengthRight * 4);
                        //someNewPointer = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * totalArmLengthRight * 2);
                        someNewPointer = someNewPointer + (direction_feet_forward_ori * totalArmLengthRight * 2);
                    }
                    else if (somechunkpriminstanceikarmvoxelindex == 1)
                    {
                ...
                */
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    {
                        //someNewPointer = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (dirtohandinvertedx * totalArmLengthRight * 2);
                        somenewtargetlocation = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_right_ori * totalArmLengthRight * 2);
                        //someNewPointer = someNewPointer + (direction_feet_up_ori * totalArmLengthRight * 4);
                        //somenewtargetlocation = somenewtargetlocation + (direction_feet_up_ori * totalArmLengthRight * 4);
                        //somenewtargetlocation = somenewtargetlocation + (direction_feet_forward_ori * totalArmLengthRight * 10);
                    }
                    ...
                    {
                        //someNewPointer = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (dirtohandinvertedx * totalArmLengthRight * 2);
                        somenewtargetlocation = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * totalArmLengthRight * 2);
                        //someNewPointer = someNewPointer + (direction_feet_up_ori * totalArmLengthRight * 4);
                        //somenewtargetlocation = somenewtargetlocation + (direction_feet_up_ori * totalArmLengthRight * 4);
                        somenewtargetlocation = somenewtargetlocation + (direction_feet_forward_ori * totalArmLengthRight * 10);
                    }
                ...
                */
                ...
                //_rotMatrixer = ikvoxelbody._player_pelvis[0][0]._arrayOfInstances[_iterator].current_pos;
                //_rotMatrixer = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                _rotMatrixer = _player_rght_elbow_target_three[0][0]._arrayOfInstances[_iterator].current_pos;
                Quaternion.RotationMatrix(ref _rotMatrixer, out forTest);
                ...
                MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_up_ori * (_player_rght_elbow_target_three[0][0]._total_torso_height * 0.5f));

                diffNormPosX = (MOVINGPOINTER.X) - _player_rght_elbow_target_three[0][0]._arrayOfInstances[_iterator].current_pos.M41;
                diffNormPosY = (MOVINGPOINTER.Y) - _player_rght_elbow_target_three[0][0]._arrayOfInstances[_iterator].current_pos.M42;
                diffNormPosZ = (MOVINGPOINTER.Z) - _player_rght_elbow_target_three[0][0]._arrayOfInstances[_iterator].current_pos.M43;
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        somenewtargetlocation = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (direction_feet_up_ori * lengthOfUpperArmRight * 2.0f * 0.5f);// + (direction_feet_right_ori * totalArmLengthRight * 2);
                ...
                */
                ...
                var somelengthlowerrightarm = lengthOfLowerArmRight * 1;

                Vector3 currentFINALPIVOTLOWERARM = new Vector3(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.X, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Y, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Z) + (direction_feet_up_ori * (_player_rght_shldr[0][0]._total_torso_height * connectorOfUpperArmRightOffsetMul));// realPIVOTOfUpperArm;
                var someDirFromPivotlowerToHand = somePosOfRightHand - currentFINALPIVOTLOWERARM;


                var lengthofdirfromlowerpivottoendhand = someDirFromPivotlowerToHand.Length();
                var upperEquationCirCirIntersecttohand = (lengthofdirfromlowerpivottoendhand * lengthofdirfromlowerpivottoendhand) - (somelengthlowerrightarm * somelengthlowerrightarm) + (lengthOfHandRight * lengthOfHandRight);
                var adjacentSolvingForXtohand = upperEquationCirCirIntersecttohand / (2 * lengthofdirfromlowerpivottoendhand);
                adjacentSolvingForXtohand = Math.Min(adjacentSolvingForXtohand, somelengthlowerrightarm - somelengthlowerrightarm * 0.001f);
                var resultertohand = Math.Pow(somelengthlowerrightarm, 2) - Math.Pow(adjacentSolvingForXtohand, 2);
                if (resultertohand < 0)
                {
                    resultertohand *= -1;
                }
                var oppositeSolvingForHalfAtohand = (float)Math.Sqrt(resultertohand);
                oppositeSolvingForHalfAtohand = Math.Min(oppositeSolvingForHalfAtohand, somelengthlowerrightarm - somelengthlowerrightarm * 0.001f);



                //Console.WriteLine(oppositeSolvingForHalfAtohand);
                ...
                Vector3 elbowpositiontofingertip = currentFINALPIVOTUPPERARM + -(direction_feet_forward_ori * lengthOfUpperArmRight);
                Vector3 dirpivottoelbow = elbowpositiontofingertip - currentFINALPIVOTUPPERARM;
                dirpivottoelbow.Normalize();
                ...
                //currentPositionOfUPPERARMROTATION3DPOSITION = currentFINALPIVOTUPPERARM + (dirpivottoelbow);
                ...
                Vector3 dirToLowerArm = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION - rShldrPos;
                dirToLowerArm.Normalize();
                Vector3 lowerarmpos1 = rShldrPos + (dirToLowerArm * lengthOfUpperArmRight);
                lowerarmpos1 = lowerarmpos1 + (direction_feet_up_ori * (_player_rght_shldr[0][0]._total_torso_height * connectorOfLowerArmRightOffsetMul));
                Vector3 newdir = somePosOfRightHand - lowerarmpos1;
                newdir.Normalize();
                //newpoint = newpoint + (newdir * lengthOfLowerArmRight * 0.5f);
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    //lowerarmpos1 = lowerarmpos1 + (newdir * lengthOfUpperArmRight * 0.5f * 2);
                    lowerarmpos1 = lowerarmpos1 + (newdir * lengthOfLowerArmRight * 0.5f);
                    //lowerarmpos1 = lowerarmpos1 + (newdir * lengthOfHandRight * 0.5f * 2);
                }
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    lowerarmpos1 = lowerarmpos1 + (newdir * lengthOfLowerArmRight * 1);
                }
                else if (somechunkpriminstanceikarmvoxelindex == 2)
                {
                    lowerarmpos1 = lowerarmpos1 + (newdir * lengthOfLowerArmRight * 1);
                ...
                //somePosOfRightHand = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                somePosOfRightHand = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43) + (direction_feet_forward_ori * lengthOfHandRight * 0.5f);
                ...
                theLowerArmRotationMatrix.Invert();
                matrixerer = theLowerArmRotationMatrix;
                matrixerer.M41 = lowerarmpos1.X;
                matrixerer.M42 = lowerarmpos1.Y;
                matrixerer.M43 = lowerarmpos1.Z;
                matrixerer.M44 = 1;
                _body_pos = matrixerer;
                Quaternion.RotationMatrix(ref _body_pos, out _quat);
                _other_quat = new JQuaternion(_quat.X, _quat.Y, _quat.Z, _quat.W);
                ...
                //END OF RIGHT ARM IK
                //END OF RIGHT ARM IK
                Vector3 rupperpos = new Vector3(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                ...
                worldMatrix_instances_r_lowerarm[0][0][_iterator] = matrixerer;
                _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos = matrixerer;
                _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + (direction_feet_forward_ori * lengthOfUpperArmRight * 0.5f);
                //END OF RIGHT ARM IK
                //END OF RIGHT ARM IK
                //END OF RIGHT ARM IK
                ...
                //_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._REALCENTERPOSITION = someMatRight;

                Vector3 endowerarm = MOVINGPOINTER + (direction_feet_forward_ori * lengthOfLowerArmRight * 1);
                matrixerer.M41 = endowerarm.X;
                matrixerer.M42 = endowerarm.Y;
                matrixerer.M43 = endowerarm.Z;
                matrixerer.M44 = 1;


                _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._TEMPPOSITION = matrixerer;
                */
                ...
                currentFINALPIVOTUPPERARM = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;// realPIVOTOfUpperArm;
                ...
                /*lengthOfDirFromPivotUpperToendlowerarm = Math.Min(lengthOfDirFromPivotUpperToendlowerarm, totalArmLengthRight - totalArmLengthRight * 0.001f)
                var lengthofdirfromlowerpivottoendhand = someDirFromPivotUpperToHand.Length();
                lengthOfDirFromPivotUpperToendlowerarm = Math.Min(lengthOfDirFromPivotUpperToendlowerarm, totalArmLengthRight - totalArmLengthRight * 0.001f);
                 upperEquationCirCirIntersect = (lengthOfDirFromPivotUpperToendlowerarm * lengthOfDirFromPivotUpperToendlowerarm) - (lengthOfLowerArmRight * lengthOfLowerArmRight) + (lengthOfUpperArmRight * lengthOfUpperArmRight);
                 adjacentSolvingForX = upperEquationCirCirIntersect / (2 * lengthOfDirFromPivotUpperToendlowerarm);
                adjacentSolvingForX = Math.Min(adjacentSolvingForX, lengthOfUpperArmRight - lengthOfUpperArmRight * 0.001f);
                ...
                */
                ...
                someNewPointer = realPIVOTOfUpperArm + (someDirFromPivotUpperToHand * adjacentSolvingForXtohand1);
