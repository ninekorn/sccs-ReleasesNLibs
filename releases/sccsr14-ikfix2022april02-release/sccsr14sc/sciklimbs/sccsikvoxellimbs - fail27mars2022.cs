...
namespace sccs
{
    public class sccsikvoxellimbs: IDisposable
    {
        ...
        {
            //typeoflimb == 0 => this is an arm
            //typeoflimb == 1 => this is a finger



            float generalsizex = 1.0f;
            float generalsizey = 1.0f;
            float generalsizez = 1.0f;
            ...
            if (typeoflimb == 0)
            {
                ...
                _player_rght_shldr[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight,
                    0, 1, 1, 1, sizex * generalsizex, sizey * generalsizey, sizez * generalsizez, new Vector4(r, g, b, a), _inst_p_r_shoulder_x, _inst_p_r_shoulder_y, _inst_p_r_shoulder_z, Program.consoleHandle,
            ...
            else if(typeoflimb == 1)
            {
                ...
                {
                    _tempMatroxer = WorldMatrix;
                    _tempMatroxer.M41 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M41 - (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 0.5f);// parentobject.initchunkposition.X + ikarmpivotinitposition.X;
                    _tempMatroxer.M42 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M42 + (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 0.5f);// parentobject.initchunkposition.Y + ikarmpivotinitposition.Y;
                    _tempMatroxer.M43 = 0;
                    _tempMatroxer.M44 = 1;
                ...
                {
                    _tempMatroxer = WorldMatrix;
                    _tempMatroxer.M41 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M41 - (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 0.25f);// parentobject.initchunkposition.X + ikarmpivotinitposition.X;
                    _tempMatroxer.M42 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M42 + (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 0.5f);// parentobject.initchunkposition.Y + ikarmpivotinitposition.Y;
                    _tempMatroxer.M43 = 0;
                    _tempMatroxer.M44 = 1;
                ...
                {
                    _tempMatroxer = WorldMatrix;
                    _tempMatroxer.M41 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M41 - (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 0);// parentobject.initchunkposition.X + ikarmpivotinitposition.X;
                    _tempMatroxer.M42 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M42 + (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 0.5f);// parentobject.initchunkposition.Y + ikarmpivotinitposition.Y;
                    _tempMatroxer.M43 = 0;
                    _tempMatroxer.M44 = 1;
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 4)
                {
                    _tempMatroxer = WorldMatrix;
                    _tempMatroxer.M41 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M41 + (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 0.5f);// parentobject.initchunkposition.X + ikarmpivotinitposition.X;
                    _tempMatroxer.M42 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[0].current_pos.M42 + (ikvoxellimb._player_rght_hnd[0][0]._total_torso_height * 0.5f);// parentobject.initchunkposition.Y + ikarmpivotinitposition.Y;
            ...
            _player_rght_lower_arm[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizex * generalsizex, sizey * generalsizey, sizez * generalsizez, new Vector4(r, g, b, a),
            ...
            if (typeoflimb == 0)
            {
                ...
                //sizex * generalsizex, sizey * generalsizey, sizez * generalsizez
                ...
                _player_rght_upper_arm[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizex * generalsizex, sizey * generalsizey, sizez * generalsizez, new Vector4(r, g, b, a),
                _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
            ...
            if (typeoflimb == 0)
            {
                ...
                _player_rght_hnd[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight,
                    0, 1, 1, 1, sizex * generalsizex, sizey * generalsizey, sizez * generalsizez, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
            ...
            if (grabtargetitem == 0)
            {
                ...
                */
                ...
                if (typeoflimb == 0)
                {
                    ...
                    _player_r_hand_grab[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight,
                        0, 1, 1, 1, sizex * generalsizex, sizey * generalsizey, sizez * generalsizez, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
                        _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccs.scgraphics.scdirectx.BodyTag.PlayerRightHandGrabTarget,
                        3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, voxel_general_size, new Vector3(0, 0, -0.1f), distance, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    var somefingerpos = MOVINGPOINTER + (direction_head_forward * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_width * 100));


                    if (somechunkpriminstanceikfingervoxelindex == 0)
                    {
                        somefingerpos = somefingerpos + (-direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 2 * 0.5f));

                    }

                    else if (somechunkpriminstanceikfingervoxelindex == 1)
                    {
                        somefingerpos = somefingerpos + (-direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 2 * 0.25f));

                    }

                    else if (somechunkpriminstanceikfingervoxelindex == 2)
                    {
                        somefingerpos = somefingerpos + (-direction_head_up * (ikvoxellimb._player_rght_hnd[0][0]._total_torso_depth * 2 * 0.0f));
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    someMatRight = extramatrix;
                    someMatRight.M41 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41;//_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41 + MOVINGPOINTER.X;
                    someMatRight.M42 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42;// + _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42 + MOVINGPOINTER.Y + _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42;
                    someMatRight.M43 = ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43;// _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43 + MOVINGPOINTER.Z;
                ...
                {
                    MOVINGPOINTER = MOVINGPOINTER + -(ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].rightdirection * (diffNormPosX));
                    MOVINGPOINTER = MOVINGPOINTER + -(ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].updirection * (diffNormPosY));
                    MOVINGPOINTER = MOVINGPOINTER + (ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].forwarddirection * (diffNormPosZ));
                    Vector3 somegrabposition = MOVINGPOINTER + (ikvoxellimb._player_rght_hnd[0][0]._arrayOfInstances[_iterator].forwarddirection * (diffNormPosZ * 0.5f));
