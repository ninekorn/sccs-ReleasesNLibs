            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)//right hand
                {
                    ...
                    var posRHand = MOVINGPOINTER;// new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    */
                    ...
                    var somePosOfSHLDR = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                    var posofhand = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                    ...
                    Vector3 shouldertohandgrabdir = handgrabpos - somePosOfSHLDR;

                    //Vector3 dirhandtograb = handgrabpos - posofhand;
                    float somelength = shouldertohandgrabdir.Length();
                    shouldertohandgrabdir.Normalize();




                    Vector3 elbowpos = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.X, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Y, _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Z);


                    Vector3 targetpos = new Vector3(_player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_elbow_target[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                    ...
                    Vector3 dirhandtotarget = handgrabpos - elbowpos;
                    dirhandtotarget.Normalize();
                    ...
                    //Vector3 someposofelbowlowerarm = upperarmpos + (direction_feet_forward_ori * _player_rght_lower_arm[0][0]._total_torso_height * 0.5f);
                    Vector3 someposofelbowlowerarm = elbowpos + (dirhandtotarget * _player_rght_lower_arm[0][0]._total_torso_height * 0.5f);


                    Vector3 handtohandgrabdir = elbowpos - handgrabpos;
                    handtohandgrabdir.Normalize();
                    pivotOfHead = elbowpos;// new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);

                    /* var somehandmatrix = _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos;
                     Quaternion.RotationMatrix(ref somehandmatrix, out otherQuat);
                     var direction_head_forward0 = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                     var direction_head_right0 = sc_maths._getDirection(Vector3.Right, otherQuat);
                     var direction_head_up0 = sc_maths._getDirection(Vector3.Up, otherQuat);

                     var theheadrotmatrix = Matrix.LookAtRH(posofhand, posofhand + handtohandgrabdir, direction_head_up0);
                     theheadrotmatrix.Invert();
                    ...
                    */
                    ...
                    //direction_feet_right_ori = sc_maths._getDirection(Vector3.Right, forTest);
                    //direction_feet_up_ori = sc_maths._getDirection(Vector3.Up, forTest);
                    Vector3 somePosererDirr = somePosOfRightHandd - handgrabpos;// _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;
                    //Vector3 someLowerRightArmPoss = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION  + (somePosererDirr * 0.5f);
                    //Vector3 someLowerRightArmPoss = someposofelbowlowerarm + (somePosererDirr * 0.5f);

                    somePosererDirr.Normalize();
                    //somePosererDirr *= -1;

                    Vector3 someCross11;
                    var someCross00 = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWCROSSVEC;
                    //handtohandgrabdir *= -1;
                    Vector3.Cross(ref somePosererDirr, ref someCross00, out someCross11);
                    someCross11.Normalize();

                    //someCross11 *= -1;
                    //Matrix theLowerArmRotationMatrixx = Matrix.LookAtRH(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + someCross11, somePosererDirr);
                    Matrix theLowerArmRotationMatrixx = Matrix.LookAtRH(someposofelbowlowerarm, someposofelbowlowerarm + somePosererDirr, someCross11);
                    theLowerArmRotationMatrixx.Invert();


                    matrixerer = theLowerArmRotationMatrixx ;
                    ...
                    */
                    ...
                    //matrixerer = _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos;// theheadrotmatrix * finalRotationMatrix;
                    //matrixerer = theheadrotmatrix;
                    ...
                    Vector3 currentFINALPIVOTUPPERARM1 = new Vector3(_player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.X, _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Y, _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION.Z) + (direction_feet_up_ori * (_player_rght_lower_arm[0][0]._total_torso_height * connectorOfUpperArmRightOffsetMul));// realPIVOTOfUpperArm;



                    Vector3 elbowpositiontofingertipp = currentFINALPIVOTUPPERARM1 + (shouldertohandgrabdir * lengthOfUpperArmRight);

                    //Vector3 elbowpositiontofingertipp = currentFINALPIVOTUPPERARM1 + (direction_head_forward0 * lengthOfUpperArmRight);
                    ...
                    if (somelength > ((lengthOfLowerArmRight * 1f) + (lengthOfUpperArmRight * 1f)) && (lengthOfLowerArmRight + lengthOfUpperArmRight) != 0)
                    //if (tempDirr.Length() > lengthOfLowerArmRight * connectorOfHandOffsetMul && lengthOfLowerArmRight != 0)
                    {
                        //Console.WriteLine("> tempDir.Length " + somechunkpriminstanceikarmvoxelindex);
                        //Program.MessageBox((IntPtr)0, "" + tempDir.Length(), "sc core systems message", 0);
                        tempDirr.Normalize();
                        Vector3 tempVect = somePosOfSHLDR + (tempDirr * ((lengthOfLowerArmRight * 1.0923f * 1f) + (lengthOfUpperArmRight * 1.0923f * 1f)));
                        MOVINGPOINTER.X = tempVect.X;
                        MOVINGPOINTER.Y = tempVect.Y;
                        MOVINGPOINTER.Z = tempVect.Z;
                ...
                else if (typeoflimb == 1)
                {
                    ...
                    if (somechunkpriminstanceikarmvoxelindex == 0 || somechunkpriminstanceikarmvoxelindex == 3)
                    {
                        ...
                        */
                        ...
                        someNewPointer = (_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._UPPERPIVOT) + (-direction_feet_right_ori * totalArmLengthRight * 2);
                        //Vector3 posofrhand = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                        someNewPointer = (someNewPointer) + (-direction_feet_right_ori * totalArmLengthRight * 2);

                        //someNewPointer = someNewPointer + (direction_feet_up_ori * totalArmLengthRight * 4);
                        //someNewPointer = posofrhand + (direction_feet_up_ori * totalArmLengthRight * 2);
                        //someNewPointer = someNewPointer + (direction_feet_forward_ori * totalArmLengthRight * 2);
                    }
                    else if (somechunkpriminstanceikarmvoxelindex == 1)
                    {
               ...
               */
                ...
                */
                ...
                _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION + (direction_feet_forward_ori * _player_rght_upper_arm[0][0]._total_torso_height);
