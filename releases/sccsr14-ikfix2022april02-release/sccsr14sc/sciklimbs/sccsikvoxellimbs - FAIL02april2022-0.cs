        ...
        public scmessageobjectjitter[][] setiktargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, int typeoflimb)
        {
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    realPosOfRS = realPosOfRS + (-direction_feet_right_ori * (_player_rght_shldr[0][0]._total_torso_width));
                    var shoulderMatrix = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._SHOULDERROT;
                    Quaternion.RotationMatrix(ref shoulderMatrix, out otherQuat);
                    direction_head_forward = sc_maths._getDirection(Vector3.ForwardRH, otherQuat);
                    direction_head_right = sc_maths._getDirection(Vector3.Right, otherQuat);
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    ...
                    realPosOfRS = realPosOfRS + (-direction_feet_up_ori * ikvoxelbody._player_pelvis[0][0]._total_torso_height);
                ...
                **/
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    var lengthOfHandheight = _player_rght_hnd[0][0]._total_torso_height * 1.0f;
                    var lengthOfHandgrabheight = _player_r_hand_grab[0][0]._total_torso_height * 1.0f;
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    ...
                    var lengthOfHandheight = _player_rght_hnd[0][0]._total_torso_height * 1f;
                    var lengthOfHandgrabheight = _player_r_hand_grab[0][0]._total_torso_height * 1f;
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 3)
                {
                    ...
                    var lengthOfHandwidth = _player_rght_hnd[0][0]._total_torso_depth * 1f;
                    var lengthOfHandheight = _player_rght_hnd[0][0]._total_torso_height * 1f;
                    var lengthOfHandgrabheight = _player_r_hand_grab[0][0]._total_torso_height * 1f;
                ...
                */
                ...
                Vector3 fakeelbowtohanddir = somePosOfRightHand - fakeelbowduetowrongsizes;
                fakeelbowtohanddir.Normalize();
                Vector3 fakeoriginpointlowerarmduetowrongsizesofabove = fakeelbowduetowrongsizes + (fakeelbowtohanddir * lengthOfLowerArmRight * 0.5f);
                ...
                */
                ...
                _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = elbowposition;// elbowposition;
                ...
                */
                ...
                Matrix theLowerArmRotationMatrix = Matrix.LookAtRH(pivotlower, pivotlower + dirhandtoelbow, vectorupdirlower);
                theLowerArmRotationMatrix.Invert();

                matrixerer = theLowerArmRotationMatrix; //_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;//  
                matrixerer.M41 = fakeoriginpointlowerarmduetowrongsizesofabove.X;
                matrixerer.M42 = fakeoriginpointlowerarmduetowrongsizesofabove.Y;
                matrixerer.M43 = fakeoriginpointlowerarmduetowrongsizesofabove.Z;
                matrixerer.M44 = 1;
                worldMatrix_instances_r_lowerarm[0][0][_iterator] = matrixerer;
                _player_rght_lower_arm[0][0]._arrayOfInstances[_iterator].current_pos = matrixerer;
                //RIGHT LOWER ARM
        ...
        public scmessageobjectjitter[][] setiktargetnfingerspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, sccsikvoxellimbs ikvoxellimb, int somechunkpriminstanceikfingervoxelindex)
        {
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                var dirToPoint = tempPoint - torsooripos;
                dirToPoint.Normalize();
                Vector3 TORSOPIVOT = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);

                realPosOfRS = TORSOPIVOT + (dirToPoint * ((_player_rght_shldr[0][0]._total_torso_height)));
                var pivotOfHead = TORSOPIVOT + (dirToPoint * ((_player_rght_shldr[0][0]._total_torso_height)));
                ...
                **/
                ...
                Vector3 direlbowtoshoulder = shoulderposition - elbowpositionrightbeforeikrot;
                direlbowtoshoulder.Normalize();

                Vector3 direlbowreferencetotargettwo = somePosOfUpperElbowTargetTwo - elbowpositionrightbeforeikrot;
                direlbowreferencetotargettwo.Normalize();

                Vector3 upvectorreferencetocreateothervec = Vector3.Up;

                Vector3 crossforpointofreferencefortargettwo;
                Vector3.Cross(ref upvectorreferencetocreateothervec, ref somedirshoulderpivottohand, out crossforpointofreferencefortargettwo);
                crossforpointofreferencefortargettwo.Normalize();

                Vector3 targettwopointA = elbowpositionrightbeforeikrot + (crossforpointofreferencefortargettwo);

                Vector3 shouldertopointadir = targettwopointA - shoulderposition;
                shouldertopointadir.Normalize();

                Vector3 crosstogetupvec;
                Vector3.Cross(ref shouldertopointadir, ref somedirshoulderpivottohand, out crosstogetupvec);
                crosstogetupvec.Normalize();

                Vector3 elbowposition = elbowpositionrightbeforeikrot + (crosstogetupvec * oppositeSolvingForHalfA);

                Vector3 dirshoulderelbow = elbowposition - shoulderposition;
                dirshoulderelbow.Normalize();

                Vector3 fakeelbowduetowrongsizes = elbowposition + (dirshoulderelbow * _player_rght_upper_arm[0][0]._total_torso_depth * 2);
                Vector3 fakeelbowtohanddir = somePosOfRightHand - fakeelbowduetowrongsizes;
                fakeelbowtohanddir.Normalize();
                Vector3 fakeoriginpointlowerarmduetowrongsizesofabove = fakeelbowduetowrongsizes + (fakeelbowtohanddir * _player_rght_upper_arm[0][0]._total_torso_depth * 2);
                ...
                _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWCROSSVEC = crossotherpointtorightofelbow;


                _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = fakeelbowduetowrongsizes;// elbowposition;

                Vector3 otherpointrightofrealelbow = elbowposition + (crossotherpointtorightofelbow);

                Vector3 dirshouldertootherpoint = otherpointrightofrealelbow - shoulderposition;
                dirshouldertootherpoint.Normalize();

                Vector3 crosstogetupvectorofupperarm;
                Vector3.Cross(ref dirshouldertootherpoint, ref somedirshoulderpivottohand, out crosstogetupvectorofupperarm);
                crosstogetupvectorofupperarm.Normalize();
                ...
                /*Vector3 crossforupperarmupvec;
                Vector3.Cross(ref direlbowtoshoulder, ref crossforpointofreferencefortargettwo, out crossforupperarmupvec);
                crossforupperarmupvec.Normalize();

                var shoulderRotationMatrixRight = Matrix.LookAtRH(elbowposition, elbowposition + direlbowtoshoulder, crossforupperarmupvec);
                shoulderRotationMatrixRight.Invert();*/
                ...
                matrixerer = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                matrixerer.M41 = otherpointrightofrealelbow.X;
                matrixerer.M42 = otherpointrightofrealelbow.Y;
                matrixerer.M43 = otherpointrightofrealelbow.Z;
                matrixerer.M44 = 1;
                ...
                /*matrixerer = shoulderRotationMatrixRight;//  Matrix.Identity;
                ...
                Vector3 direlbowtoshoulder = shoulderposition - elbowpositionupperbeforeaddingupperarmlength;
                direlbowtoshoulder.Normalize();
                ...
                /*
                shoulderposition = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                _rotMatrixer = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                Quaternion.RotationMatrix(ref _rotMatrixer, out forTest);
                direction_feet_forward_ori = sc_maths._getDirection(Vector3.ForwardRH, forTest);
                direction_feet_right_ori = sc_maths._getDirection(Vector3.Right, forTest);
                ...
                //var someDirFromElbowTargetOneToTwo = somePosOfUpperElbowTargetTwo - somePosOfUpperElbowTargetOne;
                 ...
                 somedirshoulderpivottohand = somePosOfRightHand - shoulderposition;
                 lengthOfDirFromPivotUpperToHand = somedirshoulderpivottohand.Length();
                somedirshoulderpivottohand.Normalize();
                ...
                //c2 = a2+b2
                 hypothenuseforupperarmsquared = (lengthOfUpperArmRight * lengthOfUpperArmRight) + (adjacentSolvingForX * adjacentSolvingForX);
                if (hypothenuseforupperarmsquared < 0)
                {
                    hypothenuseforupperarmsquared *= -1;
                }
                 oppositeSolvingForHalfA = (float)Math.Sqrt(hypothenuseforupperarmsquared);
                if (oppositeSolvingForHalfA < 0)
                {
                    oppositeSolvingForHalfA *= -1;
                }
                elbowpositionrightbeforeikrot = shoulderposition + (somedirshoulderpivottohand * adjacentSolvingForX);
                ...
                //crossupdirectionvectorupper *= -1;
                 elbowpositionupperbeforeaddingupperarmlength = elbowpositionrightbeforeikrot + (crossupdirectionvectorupper * oppositeSolvingForHalfA);

                 dirshouldertoupper = elbowpositionupperbeforeaddingupperarmlength - shoulderposition;
                dirshouldertoupper.Normalize();

                 elbowpositionupperrighttarget = shoulderposition + (dirshouldertoupper * _player_rght_upper_arm[0][0]._total_torso_depth * 4 * 0.5f);
                 elbowpositionupperrighttargetfull = shoulderposition + (dirshouldertoupper * _player_rght_upper_arm[0][0]._total_torso_depth * 4);
                 direlbowtoshoulder = shoulderposition - elbowpositionupperrighttarget;
                direlbowtoshoulder.Normalize();


                 direlbowtohand = somePosOfRightHand - elbowpositionupperrighttarget;
                direlbowtohand.Normalize();
                ...
                _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION = elbowpositionupperrighttargetfull;
                 ...
                 shoulderRotationMatrixRight = Matrix.LookAtRH(shoulderposition, shoulderposition + direlbowtoshoulder, crossupdirectionvectorupper);
                shoulderRotationMatrixRight.Invert();
                ...
                */
                /*
                var someNewPointer = Vector3.Zero; ;
                var somePosOfPivotUpperArm = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43); //new Vector3(realPIVOTOfUpperArm.X, realPIVOTOfUpperArm.Y, realPIVOTOfUpperArm.Z); ;// new Vector3(_player_rght_shldr.current_pos.M41, _player_rght_shldr.current_pos.M42, _player_rght_shldr.current_pos.M43);
                somePosOfRightHand = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                var dirShoulderToHand0 = somePosOfRightHand - somePosOfPivotUpperArm;
                dirShoulderToHand0 *= -1;
                ...
                */
                ...
                //somenewtargetlocation = upperarmpos + (dirtohandinvertedx * totalArmLengthRight * 2);
                ...
                somenewtargetlocation = targettwopointA;
            }
            else if (somechunkpriminstanceikarmvoxelindex == 1)
            {
            ...
            else if (somechunkpriminstanceikarmvoxelindex == 3)
            {
                ...
                */
                ...
                /*Vector3 someCross11;
                Vector3.Cross(ref dirhandtoelbow, ref someCross01, out someCross11);
                someCross11.Normalize();

                Vector3 realpivotlower = pivotlower + (-dirhandtoelbow * _player_rght_lower_arm[0][0]._total_torso_depth * 4 * 0.5f);
                
                someCross01 = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWCROSSVEC;
                Vector3 someCross1;
                Vector3.Cross(ref direlbowtoshoulder, ref someCross01, out someCross1);
                someCross1.Normalize();
                //Vector3 pivotlower = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;


                Matrix theLowerArmRotationMatrix = Matrix.LookAtRH(pivotlower, pivotlower + someCross1, dirhandtoelbow);
                theLowerArmRotationMatrix.Invert();*/
                ...
                Vector3 endupperarmpivot = _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator]._ELBOWPOSITION;// new Vector3(_player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_upper_arm[0][0]._arrayOfInstances[_iterator].current_pos.M43);
