    ...
    public class sclevelgenclass
    {
        ...
        */
        ...
        public sclevelgenmaps createbytemaps(Vector3 realposition, LevelGenerator4 levelgen, Vector3 chunkPos, sclevelgenmaps sometrigchunkmap_, int typeofterraintile, out int[] somemap_, sclevelgenclassPrim chunkprim, int levelofdetail)
        {
            ...
            sometrigchunkmap.buildchunkmaps(realposition, out somemap, planeSize, levelgen, chunkPos, tinyChunkWidth, tinyChunkHeight, tinyChunkDepth, typeofterraintile, chunkprim, levelofdetail);
            somemap_ = somemap;
        ...
        public sclevelgenvert createchunkvert(Vector3 realposition, LevelGenerator4 levelgen, Vector3 chunkPos, sclevelgenvert sometrigchunkvert_, int typeofterraintile, out int[] somemap_,out int[] indicesArray0_, out DVertex[] arrayOfD_, sclevelgenclassPrim chunkprim, sclevelgenmaps levelmap, int levelofdetail)
        {
            ...
            sometrigchunkvert.startBuildingArray(realposition, out indicesArray0, out somemap, out arrayOfD, planeSize, levelgen, chunkPos, tinyChunkWidth, tinyChunkHeight, tinyChunkDepth, typeofterraintile, chunkprim, levelmap.map, levelofdetail);
        ...
        int typeofvoxelmesh;
        public sclevelgenclass(Vector4 color, Vector3 pos, Matrix _maininstancematrix , int _addtoworld, float _mass, World _the_world, bool _is_static, sccs.scgraphics.scdirectx.BodyTag _tag, int tinyChunkWidth_, int tinyChunkHeight_, int tinyChunkDepth_, float planeSize_, float offsetinstance, LevelGenerator4 levelgen)
        {
