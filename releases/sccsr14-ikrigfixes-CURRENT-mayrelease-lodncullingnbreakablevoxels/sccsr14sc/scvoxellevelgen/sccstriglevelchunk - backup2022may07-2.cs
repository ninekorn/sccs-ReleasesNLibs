...
namespace sccs
{
    public class sccstriglevelchunk
    {
        ...
        public static Dictionary<sccstriglevelchunk, Vector3> chunkz = new Dictionary<sccstriglevelchunk, Vector3>();

        int typeofterraintiles;

        public int[] startBuildingArray(Vector3 currentPosition, out Vector4[] vertexArray, out int[] indicesArray, out int[] mapper, out sclevelgenchunk.DVertex[] dVertexArray, out Vector3[] norms, out Vector2[] tex, float planeSize_, LevelGenerator4 levelgen_, Vector3 _chunkPos, int width_, int height_, int depth_, int typeofterraintiles_, sclevelgenchunk componentparent_, int[] map_) //, out int vertexNum, out int indicesNum
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
                    if (someChunk != null)
                    {
                        if (someChunk.map != null)
                        {
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            if (someChunk != null)
                            {
                                ...
                                if (someChunk.map != null)
                                {
                                    if (someChunk.GetByte(width - 1, yi, zi) == 0) //someChunk.IsTransparent(width - 1, yi, zi)) //
                                    {
                                        if (typeofterraintiles != 0)
                                        {
                                            Vector4 start = new Vector4(xi * planeSize, yi * planeSize, zi * planeSize, 1);
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= (width) * planeSize;
                                someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforLeftx, 0, somevalueforLeftz);
                    ...
                    if (IsTransparent(xi + 1, yi, zi))
                    {
                        ...
                        else if (xi == width - 1)
                        {
                            ...
                            //Vector3 somechunkpos = chunkPos;
                            //somechunkpos.X += (width) * planeSize;
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforRightx, somevalueforRighty, somevalueforRightz);
                            ...
                            if (someChunk != null)
                            {
                                ...
                                if (someChunk.map != null)
                                {
                                    if (someChunk.GetByte(0, yi, zi) == 0) //someChunk.IsTransparent(width - 1, yi, zi)) //
                                    {
                                        if (typeofterraintiles != 0)
                                        {
                                            Vector4 start = new Vector4(xi * planeSize, yi * planeSize, zi * planeSize, 1);
                            ...
                            else
                            {
                                //somechunkpos = chunkPos;
                                //somechunkpos.X += (width) * planeSize;
                                someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforRightx, 0, somevalueforRightz);
                    ...
                    if (IsTransparent(xi, yi - 1, zi))
                    {
                        ...
                        else if (yi == 0)
                        {
                            ...
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforBottomx, somevalueforBottomy, somevalueforBottomz);
                            ...
                            if (someChunk != null)
                            {
                                ...
                                if (someChunk.map != null)
                                {
                                    if (someChunk.GetByte(xi, height - 1, zi) == 0) //someChunk.IsTransparent(width - 1, yi, zi)) //
                                    {
                                        if (typeofterraintiles != 0)
                                        {
                                            Vector4 start = new Vector4(xi * planeSize, yi * planeSize, zi * planeSize, 1);
                            ...
                            else
                            {
                                //somechunkpos = chunkPos;
                                //somechunkpos.Y -= (height) * planeSize;
                                someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforBottomx, 0, somevalueforBottomz);
                    ...
                    if (IsTransparent(xi, yi + 1, zi))
                    {
                        ...
                        else if (yi == height - 1)
                        {
                            ...
                            //Vector3 somechunkpos = chunkPos;
                            //somechunkpos.Y += (height) * planeSize;
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforTopx, somevalueforTopy, somevalueforTopz);
                            ...
                            if (someChunk != null)
                            {
                                ...
                                if (someChunk.map != null)
                                {
                                    if (someChunk.GetByte(xi, 0, zi) == 0) //someChunk.IsTransparent(width - 1, yi, zi)) //
                                    {
                                        if (typeofterraintiles != 0)
                                        {
                                            Vector4 start = new Vector4(xi * planeSize, yi * planeSize, zi * planeSize, 1);
                            ...
                            else
                            {
                                /*somechunkpos = chunkPos;
                                somechunkpos.Y += (height) * planeSize;
                                someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforTopx, 0, somevalueforTopz);
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        else if (zi == depth - 1)
                        {
                            ...
                            //Vector3 somechunkpos = chunkPos;
                            //somechunkpos.Z += (depth) * planeSize;
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
                            ...
                            if (someChunk != null)
                            {
                                ...
                                if (someChunk.map != null)
                                {
                                    if (someChunk.GetByte(xi, yi, 0) == 0) //someChunk.IsTransparent(width - 1, yi, zi)) //
                                    {
                                        if (typeofterraintiles != 0)
                                        {
                                            Vector4 start = new Vector4(xi * planeSize, yi * planeSize, zi * planeSize, 1);
                            ...
                            else
                            {
                                ...
                                //somechunkpos = chunkPos;
                                //somechunkpos.Z += (depth) * planeSize;
                                someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforFrontx, 0, somevalueforFrontz);
                    ...
                    if (IsTransparent(xi, yi, zi - 1))
                    {
                        ...
                        else if (zi == 0)
                        {
                            ...
                            //Vector3 somechunkpos = chunkPos;
                            //somechunkpos.Z -= (depth) * planeSize;
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforBackx, somevalueforBacky, somevalueforBackz);
                            ...
                            if (someChunk != null)
                            {
                                ...
                                if (someChunk.map != null)
                                {
                                    if (someChunk.GetByte(xi, yi, depth - 1) == 0) //someChunk.IsTransparent(width - 1, yi, zi)) //
                                    {
                                        if (typeofterraintiles != 0)
                                        {
                                            Vector4 start = new Vector4(xi * planeSize, yi * planeSize, zi * planeSize, 1);
                            ...
                            else
                            {
                                //somechunkpos = chunkPos;
                                //somechunkpos.Z -= (depth) * planeSize;
                                someChunk = (sccstriglevelchunk)componentparent.getChunk(somevalueforBackx, 0, somevalueforBackz);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        if (levelgen.getChunk(somevalueforLeftx, somevalueforLefty, somevalueforLeftz) != null)
                        {
                            ...
                            sccstriglevelchunk someChunk = (sccstriglevelchunk)levelgen.getChunk(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                            if (someChunk != null)
                            {
                                if (xi == 0 && someChunk.map != null)
                                {
