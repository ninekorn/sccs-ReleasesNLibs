...
namespace sccs
{
    ...
    {
        int sometypeofface = 0;

        public sccstriglevelchunk(int sometypeofface_)
        {
            sometypeofface = sometypeofface_;
        }
