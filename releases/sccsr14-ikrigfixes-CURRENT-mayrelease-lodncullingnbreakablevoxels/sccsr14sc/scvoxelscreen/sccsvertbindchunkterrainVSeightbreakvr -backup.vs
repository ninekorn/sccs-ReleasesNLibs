...
static int tinyChunkDepth = 4; // 4 // 8 // 1
...
{ 
	...
	*/
	...
	float typeoffacetwo = floor(currentMapData/1000.0f);

	float widthofface = floor(currentMapData) - (typeoffacetwo *1000.0f);
	float heightofface =floor((currentMapData - floor(currentMapData/1000.0f)) * 1000.0f);

	float typeofvertex = ((currentMapData - floor(currentMapData)) * 1000.0f);
	typeofvertex = ((typeofvertex) - floor(typeofvertex)) * 100.0f;



	if (typeoffacetwo == 0.0f) //front face
    {
    ...
    else if (typeoffacetwo == 1.0f) //top face
    {
		if(typeofvertex == 0.0f && widthofface != 0.0f)
		{
			input.position.w = 1.0f;
			...
			//MOVINGPOINT = MOVINGPOINT + (-rightDir * widthofface);
			//MOVINGPOINT = MOVINGPOINT + (upDir * diffY);
			//MOVINGPOINT = MOVINGPOINT + (forwardDir * heightofface);
		...
		else if(typeofvertex == 1.0f && widthofface != 0.0f)
		{
			input.position.x = input.instancePosition.x;
			input.position.y = input.instancePosition.y;
			input.position.z = input.instancePosition.z;
		...
		else if(typeofvertex == 2.0f && widthofface != 0.0f)
		{
			input.position.x = input.instancePosition.x;
			input.position.y = input.instancePosition.y;
			input.position.z = input.instancePosition.z;
		...
		else if(typeofvertex == 3.0f && widthofface != 0.0f)
		{
			input.position.x = input.instancePosition.x;
			input.position.y = input.instancePosition.y;
			input.position.z = input.instancePosition.z;
    ...
    else if (typeoffacetwo == 2.0f) //left face
    {
        input.position.x = input.instancePosition.x;
		input.position.y = input.instancePosition.y;
		input.position.z = input.instancePosition.z;
    ...
    else if (typeoffacetwo == 3.0f)  //right face
    {
        input.position.x = input.instancePosition.x;
		input.position.y = input.instancePosition.y;
		input.position.z = input.instancePosition.z;
    ...
    else if (typeoffacetwo == 4.0f) //back face
    {
        input.position.x = input.instancePosition.x;
		input.position.y = input.instancePosition.y;
		input.position.z = input.instancePosition.z;
    ...
    else if (typeoffacetwo == 5.0f) //bottom face
    {
        input.position.x = input.instancePosition.x;
		input.position.y = input.instancePosition.y;
		input.position.z = input.instancePosition.z;
	...
	output.indexPos = input.indexPos;
