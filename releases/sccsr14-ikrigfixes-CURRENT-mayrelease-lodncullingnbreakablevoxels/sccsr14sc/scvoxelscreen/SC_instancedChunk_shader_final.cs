...
namespace sccs
{
    public class SC_instancedChunk_shader_final : IDisposable
    {
        ...
        public SC_instancedChunkPrim.chunkData renderthemesh(SC_instancedChunkPrim.chunkData chunkdat, int indexBuilt, ShaderResourceView shaderResourceView2D_, int voxeltype_) //async
        {
