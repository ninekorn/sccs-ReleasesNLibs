...
namespace sccs.scgraphics.scshadermanager
{
    public class SC_ShaderManager                 // 77 lines
    {
        ...
        public bool Initialize(Device device, IntPtr windowsHandle, int createikrig,scgraphicssec graphicssec) //, float x, float y, float z, Vector4 color,Matrix worldMatrix
        {
            ...
            if (graphicssec.activatenotyetinfinitevoxelterrain == 1)
            {
