        ...
        public scmessageobjectjitter[][] setiktargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, int typeoflimb)
        {
            ...
            for (int _iterator = 0; _iterator < 1; _iterator++) // //_player_rght_hnd[0][0]._arrayOfInstances.Length
            {
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 1)
                {
                    ...
                    float somevaldiv = 1.0f / scgraphics.scgraphicssec._planeSize;

                    int someposfootx = (int)(((float)Math.Floor(MOVINGPOINTER.X * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize));
                    int someposfooty = (int)(((float)Math.Floor(MOVINGPOINTER.Y * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize));
                    int someposfootz = (int)(((float)Math.Floor(MOVINGPOINTER.Z * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize));
                    someposfooty -= 1;
                    ...
                    {
                        someremainsx = (int)Math.Floor((someposfootx / 10.0f)) * 10;
                        totalTimesx = -10 + (int)(someremainsx - someposfootx) + 10;
                        totalTimesx *= -1;
                    }

                    if (MOVINGPOINTER.Y >= 0)
                    {
                    ...
                    {
                        someremainsy = (int)Math.Floor((someposfooty / 10.0f)) * 10;
                        totalTimesy = -10 + (int)(someremainsy - someposfooty) + 10;
                        totalTimesy *= -1;
                    }

                    if (MOVINGPOINTER.Z >= 0)
                    {
                    ...
                    {
                        someremainsz = (int)Math.Floor((someposfootz / 10.0f)) * 10;
                        totalTimesz = -10 + (int)(someremainsz - someposfootz) + 10;
                        totalTimesz *= -1;
                    }
                    ...
                    int someindexmap = indexx + 10 * ((indexy) + 10 * indexz);



                    //Console.WriteLine("0x:" + someposfootx + "/0y:" + someposfooty + "/0z:" + someposfootz + "/ix:" + indexx + "/iy:" + indexy + "/iz:" + indexz + " " + sometotaltimesx + " " + sometotaltimesy + " " + sometotaltimesz + "/ttx:" + totalTimesx + "/tty:" + totalTimesy + "/ttz:" + totalTimesz + "/index:" + someindexmap);

                    var somechunk = (sccstriglevelchunk)sclevelgenchunk.thesclevelgenchunk.getChunk(sometotaltimesx, sometotaltimesy, sometotaltimesz, out arrayindex);

                    int movingleg = 0;
                    int dontunlockwithnormalbytemap = 0;



                    if (islegextendedr == 1)
                    {
                        dontunlockwithnormalbytemap = 1;
                        MOVINGPOINTER = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos.M43);

                        int counterheightwithbytes = 0;

                        var originposshoulder0 = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_rght_shldr[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                        var originposhand0 = new Vector3(_player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_rght_hnd[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);

                        float difflengthy = (float)Math.Abs(originposshoulder0.Y - originposhand0.Y) * somelimbextentoffset;


                        //float sometotalleglength = lengthOfLowerArmRight + lengthOfUpperArmRight + lengthOfHandRight;

                        int totalArmLengthRightmax = (int)(((float)Math.Floor(difflengthy * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize)) + 3;

                       // Console.WriteLine(totalArmLengthRightmax);

                        for (int yi = totalArmLengthRightmax - 1; yi >= 0; yi--)
                        {
                            someposfootx = (int)(((float)Math.Floor(MOVINGPOINTER.X * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize));
                            someposfooty = (int)(((float)Math.Floor(MOVINGPOINTER.Y * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize));
                            someposfootz = (int)(((float)Math.Floor(MOVINGPOINTER.Z * somevaldiv) / somevaldiv) / (scgraphics.scgraphicssec._planeSize));
                            someposfooty -= (totalArmLengthRightmax - 1) - yi; //
                            ...
                            sometotaltimesx = someremainsx / 10;// totalTimesx;
                            sometotaltimesy = someremainsy / 10;//totalTimesy;
                            sometotaltimesz = someremainsz / 10;//totalTimesz;

                            someindexmap = indexx + 10 * ((indexy) + 10 * indexz);

                            somechunk = (sccstriglevelchunk)sclevelgenchunk.thesclevelgenchunk.getChunk(sometotaltimesx, sometotaltimesy, sometotaltimesz, out arrayindex);
                                ...
                                if (somechunk.map != null)
                                {
                                    if (someindexmap >= 0 && someindexmap < 10 * 10 * 10)
                                    {
                                        ...
                                        if (somechunk.map[someindexmap] == 1)
                                        {
                                            ...
                                            MOVINGPOINTER.Y -= (scgraphics.scgraphicssec._planeSize * yi);
                                            //MOVINGPOINTER.Y = swtclockfootyl;

                                            //Console.WriteLine("test");

                                            movingleg = 1;

                                            swtclockfootxr = MOVINGPOINTER.X;
                                            swtclockfootyr = MOVINGPOINTER.Y;
                                            swtclockfootzr = MOVINGPOINTER.Z;

                                            if (lastswtclockfootyr < swtclockfootyr)
                                            {
                                                //scgraphics.scupdate.movePos.Y += (scgraphics.scgraphicssec._planeSize * yi);
                                                averageposneededrlegup += (scgraphics.scgraphicssec._planeSize * yi);
                                            }
                                            //else if (lastswtclockfootyl > swtclockfootyl)
                                            //{
                                            //    scgraphics.scupdate.movePos.Y -= (scgraphics.scgraphicssec._planeSize * yi);
                                            //}

                                            lastswtclockfootxr = swtclockfootxr;
                                            lastswtclockfootyr = swtclockfootyr;
                                            lastswtclockfootzr = swtclockfootzr;

                                            counterheightwithbytes++;
                                            break;
                                        }
                                        else
                                        {
                        ...
                        /*
                        if (counterheightwithbytes == 0)
                        {
                            //Console.WriteLine();

                            for (int yi = 10 - 1; yi >= 0; yi--)
                            {
                                ...
                                somechunk = (sccstriglevelchunk)sclevelgenchunk.thesclevelgenchunk.getChunk(sometotaltimesx, sometotaltimesy, sometotaltimesz);
                                    ...
                                    if (somechunk.map != null)
                                    {
                                        if (someindexmap >= 0 && someindexmap < 10 * 10 * 10)
                                        {
                                            ...
                                            if (somechunk.map[someindexmap] == 1)
                                            {
                                                ...
                                                //if (lastswtclockfootyl < swtclockfootyl)
                                                //{
                                                    //scgraphics.scupdate.movePos.Y -= (scgraphics.scgraphicssec._planeSize * yi * 0.5f);
                                                //}

                                                averageposneededrlegdown -= (scgraphics.scgraphicssec._planeSize * yi);
                    ...
                    //why make a locomotion? why do i need one?
                    //why don't i just try to move the grab location from when the leg extends too much in the back and
                    //lerp the grab cube target to further ahead of the character with a slight up offset for bringing the knee up?
                    //and then move the pelvis up to match the custom locomotion.
                        ...
                        if (somechunk != null)
                        {
                            if (somechunk.map != null)
                            {
                                if (someindexmap >= 0 && someindexmap < 10 * 10 * 10)
                                {
                                    ...
                                    if (somechunk.map[someindexmap] == 1)
                                    {
                                        if (dontunlockwithnormalbytemap == 1)
                                        {
                                    ...
                                    {
                                        //last frame was locked but now it isn't anymore and map == 0
                                        /*if (swtclockfootrwaslocked== 1)
                                        {
                                            scgraphics.scupdate.movePos.Y -= (scgraphics.scgraphicssec._planeSize * 1);
                                        }*/


                                        /*if (swtclockfootrwaslocked == 1 && swtclockfootr == 1)
                                        {

                                        }
                                        else if (swtclockfootrwaslocked == 0 && swtclockfootr == 1)
                                        {
                            ...
                            else
                            {
                                ...
                                //Console.WriteLine("somechunkmap null");
                            }
                        }
                        else
                        {
                            ...
                            //Console.WriteLine("somechunk null");
                        }
                    }
                    ...
                    if (swtclockfootr == 0)
                    {
                        ...
                        /*    
                        swtclockfootxl = indexx;
                        swtclockfootyl = indexy;
                        swtclockfootzl = indexz;
                        */

                        /*
                        swtclockfootxl = someindexaltx;
                        swtclockfootyl = someindexalty;
                        swtclockfootzl = someindexaltz;
                        */
                    ...
                    else
                    {
                        ...
                        var somematrixshoulder = _player_rght_shldr[0][0]._arrayOfInstances[_iterator].current_pos;
                        matrixerer = somematrixshoulder * somematrix;
                        matrixerer.M41 = swtclockfootxr;
                        matrixerer.M42 = swtclockfootyr;// + (1 * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M43 = swtclockfootzr;
                        matrixerer.M44 = 1;

                        /*
                        matrixerer.M41 = (totalTimesx * (scgraphics.scgraphicssec._planeSize * 10)) + (swtclockfootxl * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M42 = ((totalTimesy) * (scgraphics.scgraphicssec._planeSize * 10)) + (swtclockfootyl * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M43 = (totalTimesz * (scgraphics.scgraphicssec._planeSize * 10)) + (swtclockfootzl * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M44 = 1;

                        /*
                        matrixerer.M41 = (somechunk.chunkPos.X * (scgraphics.scgraphicssec._planeSize * 10)) + (swtclockfootxl * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M42 = ((somechunk.chunkPos.Y) * (scgraphics.scgraphicssec._planeSize * 10)) + (swtclockfootyl * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M43 = (somechunk.chunkPos.Z * (scgraphics.scgraphicssec._planeSize * 10)) + (swtclockfootzl * scgraphics.scgraphicssec._planeSize);
                        matrixerer.M44 = 1;*/
                    ...
                    lastswtclockfootxr = MOVINGPOINTER.X;
                    lastswtclockfootyr = MOVINGPOINTER.Y;
                    lastswtclockfootzr = MOVINGPOINTER.Z;


                    lastislegextendedr = islegextendedr;

                    swtclockfootlastposr = someindexmap;
                    swtclockfootrwaslocked = swtclockfootr;
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 2)
                {
                                ...
                                if (somechunk.map != null)
                                {
                                    if (someindexmap >= 0 && someindexmap < 10 * 10 * 10)
                                    {
                                        ...
                                        if (somechunk.map[someindexmap] == 1)
                                        {
                                            ...
                                            swtclockfootxl = MOVINGPOINTER.X;
                                            swtclockfootyl = MOVINGPOINTER.Y;
                                            swtclockfootzl = MOVINGPOINTER.Z;
                                            ...
                                            lastswtclockfootxl = swtclockfootxl;
                                            lastswtclockfootyl = swtclockfootyl;
                                            lastswtclockfootzl = swtclockfootzl;
                        ...
                        if (somechunk != null)
                        {
                            if (somechunk.map != null)
                            {
                                if (someindexmap >= 0 && someindexmap < 10 * 10 * 10)
                                {
                                    ...
                                    {
                                        //last frame was locked but now it isn't anymore and map == 0
                                        /*if (swtclockfootlwaslocked== 1)
                                        {
                                            scgraphics.scupdate.movePos.Y -= (scgraphics.scgraphicssec._planeSize * 1);
                                        }*/


                                        /*if (swtclockfootlwaslocked == 1 && swtclockfootl == 1)
                                        {

                                        }
                                        else if (swtclockfootlwaslocked == 0 && swtclockfootl == 1)
                                        {
                    ...
                    lastswtclockfootxl = MOVINGPOINTER.X;
                    lastswtclockfootyl = MOVINGPOINTER.Y;
                    lastswtclockfootzl = MOVINGPOINTER.Z;


                    lastislegextendedl = islegextendedr;

                    swtclockfootlastposl = someindexmap;
                    swtclockfootlwaslocked = swtclockfootl;
