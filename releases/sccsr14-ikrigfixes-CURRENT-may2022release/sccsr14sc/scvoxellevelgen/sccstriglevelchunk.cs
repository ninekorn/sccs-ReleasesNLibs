...
namespace sccs
{
    public class sccstriglevelchunk
    {
        ...
        sccstriglevelchunk[] listofchunksadjacent = new sccstriglevelchunk[6];
        sccstriglevelchunk[] listofchunksadjacentfloor = new sccstriglevelchunk[6];
     ...
     */
            ...
            */
            ...
            {
                listofchunksadjacent[i] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[i].X, listofvecs[i].Y, listofvecs[i].Z);
            }
            ...
            {
                listofchunksadjacentfloor[i] = (sccstriglevelchunk)componentparent.getChunk(listofvecsadjacentfloor[i].X, 0, listofvecsadjacentfloor[i].Z);
            }
            ...
            for (int i = 0; i < 1; i++)
            {
                listofchunksadjacent[0] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[0].X, listofvecs[0].Y, listofvecs[0].Z);            
            }
            for (int i = 0; i < 1; i++)
            {
                listofchunksadjacent[1] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[1].X, listofvecs[1].Y, listofvecs[1].Z);
            }
            for (int i = 0; i < 1; i++)
            {
                listofchunksadjacent[2] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[2].X, listofvecs[2].Y, listofvecs[2].Z);
            }
            for (int i = 0; i < 1; i++)
            {
                listofchunksadjacent[3] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[3].X, listofvecs[3].Y, listofvecs[3].Z);
            }
            for (int i = 0; i < 1; i++)
            {
                listofchunksadjacent[4] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[4].X, listofvecs[4].Y, listofvecs[4].Z);
            }
            for (int i = 0; i < 1; i++)
            {
                listofchunksadjacent[5] = (sccstriglevelchunk)componentparent.getChunk(listofvecs[5].X, listofvecs[5].Y, listofvecs[5].Z);
            }*/
            ...
            sccstriglevelchunk somechunkleft = (sccstriglevelchunk)componentparent.getChunk(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
            */
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= 1.0f;
                                //var someChunk = (sccstriglevelchunk)componentparent.getChunk(somechunkpos.X, 0, somechunkpos.Z);
