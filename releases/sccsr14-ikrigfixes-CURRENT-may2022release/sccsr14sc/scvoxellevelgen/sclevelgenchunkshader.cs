        ...
        public sccs.sclevelgenchunk.chunkData Renderer(sccs.sclevelgenchunk.chunkData chunkdat) //async
        {
            try
            {
                ...
                */
                ...
                {
                    if (chunkdat.arrayOfInstanceVertex[t].Length > 0)
                    {
                        if (chunkdat.startOnce == 0)
                        {
                            ...
                            {
                                Usage = ResourceUsage.Dynamic,
                                SizeInBytes = Marshal.SizeOf(typeof(Vector4)) * chunkdat.arrayOfInstanceNormals[t].Length,
                                BindFlags = BindFlags.VertexBuffer,
                                CpuAccessFlags = CpuAccessFlags.Write,
                                OptionFlags = ResourceOptionFlags.None,
                                StructureByteStride = 0
                            ...
                            mappedResource0.WriteRange(chunkdat.arrayOfInstanceNormals[t], 0, chunkdat.arrayOfInstanceNormals[t].Length);
                            ...
                            {
                                Usage = ResourceUsage.Dynamic,
                                SizeInBytes = Marshal.SizeOf(typeof(Vector4)) * chunkdat.arrayOfInstanceTextureCoordinates[t].Length,
                                BindFlags = BindFlags.VertexBuffer,
                                CpuAccessFlags = CpuAccessFlags.Write,
                                OptionFlags = ResourceOptionFlags.None,
                                StructureByteStride = 0
                            ...
                            mappedResource0.WriteRange(chunkdat.arrayOfInstanceTextureCoordinates[t], 0, chunkdat.arrayOfInstanceTextureCoordinates[t].Length);
                            ...
                            {
                                Usage = ResourceUsage.Dynamic,
                                SizeInBytes = Marshal.SizeOf(typeof(Vector4)) * chunkdat.arrayOfInstanceColors[t].Length,
                                BindFlags = BindFlags.VertexBuffer,
                                CpuAccessFlags = CpuAccessFlags.Write,
                                OptionFlags = ResourceOptionFlags.None,
                                StructureByteStride = 0
                            ...
                            mappedResource0.WriteRange(chunkdat.arrayOfInstanceVertex[t], 0, chunkdat.arrayOfInstanceVertex[t].Length);
                            ...
                            //chunkdat.colorBuffers[t] = ColorBuffer;

                            chunkdat.normalBuffers[t] = NormalBuffer;
                            chunkdat.texBuffers[t] = TextureBuffer;

                          

                            //chunkdat.instanceBuffers[t] = instanceBuff;
