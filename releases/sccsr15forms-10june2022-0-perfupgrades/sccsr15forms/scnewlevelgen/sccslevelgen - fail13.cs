...
namespace sccsr15forms
{
    public class sccslevelgen
    {
        ...
        public void createlevel()
        {
            ...
            //Console.WriteLine("/minx:" + (minx+1) + "/miny:" +  (miny+1) + "/minz:" + (minz + 1));
        ...
        public void buildWallsRerolled(int x, int y, int z)
        {
            ...
            if (indextile < somewidth * someheight * somedepth)
            {
                ...
                else if(adjacenttiles[indextile] == 1001)
                {
                    istypeofl = -2;
                }
            }
            ...
            {
                //Console.WriteLine("found bordertile");
                if (levelmap[indexinarray] == 0 && x == minx)
                {
            ...
            //FRONT WALL
            if (istypeoflb == -1 && istypeofb == -1 && istypeofrb == -1 &&
                istypeoflt == 0 && istypeoft == 0 && istypeofrt == 0 ||

                istypeoflb == -3 && istypeofb == -3 && istypeofrb == -3 &&
                istypeoflt == 0 && istypeoft == 0 && istypeofrt == 0 ||

                istypeoflb == -1 && istypeofb == -1 && istypeofrb == -1 &&
                istypeoflt == -2 && istypeoft == 0 && istypeofrt == 0 ||

                istypeoflb == -3 && istypeofb == -3 && istypeofrb == -3 &&
                istypeoflt == -2 && istypeoft == 0 && istypeofrt == 0 ||

                istypeoflb == -1 && istypeofb == -1 && istypeofrb == -1 &&
                istypeoflt == 0 && istypeoft == 0 && istypeofrt == -2 ||
