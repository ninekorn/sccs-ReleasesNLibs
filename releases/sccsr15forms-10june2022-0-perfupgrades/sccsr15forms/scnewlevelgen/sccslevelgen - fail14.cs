...
namespace sccsr15forms
{
    public class sccslevelgen
    {
        ...
        void checkAllSides(int xi, int yi, int zi)
        {
            ...
            int indexinlevelarray = xx + somewidth * (yy + someheight * zz); //y is always 0 on floor tiles
            if (levelmap[indexinlevelarray] == 0 && xi == minx ||
                levelmap[indexinlevelarray] == 0 && zi == minz ||
                levelmap[indexinlevelarray] == 0 && xi == maxx - 1 ||
                levelmap[indexinlevelarray] == 0 && zi == maxz - 1)
            {
        ...
        public void createfinal()
        {
            if (counter == 1)
            {
                ...
                //int somemaxarray1 = (-minx + maxx) * (-miny + maxy) * (-minz + maxz);
                int somecounter = 0;
        ...
        public void buildWallsRerolled(int x, int y, int z)
        {
            ...
            if (levelmap[indexinarray] == 0 && x == minx ||
               levelmap[indexinarray] == 0 && z == minz ||
               levelmap[indexinarray] == 0 && x == maxx ||
               levelmap[indexinarray] == 0 && z == maxz)
            {
                if (levelmap[indexinarray] == 0 && x == minx)
                {
                ...
                else if (levelmap[indexinarray] == 0 && z == minz)
                {
                    Console.WriteLine("found bordertile minz");

                }
                else if (levelmap[indexinarray] == 0 && x == maxx - 1)
                {
                    Console.WriteLine("found bordertile maxx");

                }
                else if (levelmap[indexinarray] == 0 && z == maxz - 1)
                {
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && x != minx &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && x != minx)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeofl = 0;
                }
                else if (adjacenttiles[indextile] == 999)
                {
                    istypeofl = 1;
                }
                else if(adjacenttiles[indextile] != 1001 && adjacenttiles[indextile] != 0 && adjacenttiles[indextile] != 999)
                {
                    istypeofl = -1;
                }
            }
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && x != maxx-1 &&

                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && x != maxx - 1)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeofr = 0;
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && z != maxz-1 &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && z != maxz - 1)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeoft = 0;
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && z != minz &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && z != minz)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeofb = 0;
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && x != minx && levelmap[indexinarray] == 999 && z != minz &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && x != minx && levelmap[indexinarray] == 0 && z != minz)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeoflb = 0;
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && x != maxx-1 && levelmap[indexinarray] == 999 && z != minz &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && x != maxx - 1 && levelmap[indexinarray] == 0 && z != minz)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeofrb = 0;
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && x != minx && levelmap[indexinarray] == 999 && z != maxz-1 &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && x != minx && levelmap[indexinarray] == 0 && z != maxz - 1)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeoflt = 0;
            ...
            if (indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 999 && x != maxx-1 && levelmap[indexinarray] == 999 && z != maxz - 1 &&
                indextile < somewidth * someheight * somedepth && levelmap[indexinarray] == 0 && x != maxx - 1 && levelmap[indexinarray] == 0 && z != maxz - 1)
            {
                if (adjacenttiles[indextile] == 0)
                {
                    istypeofrt = 0;
            ...
            if (istypeoflt == -1 && istypeofrt == 0 &&
                ...
                istypeoflt == -3 && istypeofrt == 0 &&
                istypeofl == -3 && istypeofr == 0 &&
                istypeoflb == -3 && istypeofrb == 0 ||

                istypeoflt == -1 && istypeofrt == -2 &&
                istypeofl == -1 && istypeofr == 0 &&
                istypeoflb == -1 && istypeofrb == 0 ||

                istypeoflt == -3 && istypeofrt == -2 &&
                istypeofl == -3 && istypeofr == 0 &&
                istypeoflb == -3 && istypeofrb == 0||

                istypeoflt == -1 && istypeofrt == 0 &&
                istypeofl == -1 && istypeofr == 0 &&
                istypeoflb == -1 && istypeofrb == -2 ||

                istypeoflt == -3 && istypeofrt == 0 &&
                istypeofl == -3 && istypeofr == 0 &&
                istypeoflb == -3 && istypeofrb == -2)
            {
                if (levelmap[indexinarray] != 1101 &&
                   levelmap[indexinarray] != 1102 &&
                   levelmap[indexinarray] != 1103 &&
            ...
            if (istypeoflt == 0 && istypeofrt == -1 &&
                ...
                istypeoflt == 0 && istypeofrt == -3 &&
                istypeofl == 0 && istypeofr == -3 &&
                istypeoflb == 0 && istypeofrb == -3 ||

                istypeoflt == -2 && istypeofrt == -1 &&
                istypeofl == 0 && istypeofr == -1 &&
                istypeoflb == 0 && istypeofrb == -1 ||

                istypeoflt == -2 && istypeofrt == -3 &&
                istypeofl == 0 && istypeofr == -3 &&
                istypeoflb == 0 && istypeofrb == -3 ||

                istypeoflt == 0 && istypeofrt == -1 &&
                istypeofl == 0 && istypeofr == -1 &&
                istypeoflb == -2 && istypeofrb == -1 ||

                istypeoflt == 0 && istypeofrt == -3 &&
                istypeofl == 0 && istypeofr == -3 &&
                istypeoflb == -2 && istypeofrb == -3
                )
            {
                if (levelmap[indexinarray] != 1101 &&
                   levelmap[indexinarray] != 1102 &&
            ...
            if (istypeoflt == -1 &&  istypeoft == -1 && istypeofrt == -1 &&
                ...
                istypeoflt == -3 && istypeoft == -3 && istypeofrt == -3 &&
                istypeoflb == 0 && istypeofb == 0 && istypeofrb == 0 ||

                istypeoflt == -1 && istypeoft == -1 && istypeofrt == -1 &&
                istypeoflb == -2 && istypeofb == 0 && istypeofrb == 0 ||

                istypeoflt == -3 && istypeoft == -3 && istypeofrt == -3 &&
                istypeoflb == -2 && istypeofb == 0 && istypeofrb == 0 ||

                istypeoflt == -1 && istypeoft == -1 && istypeofrt == -1 &&
                istypeoflb == 0 && istypeofb == 0 && istypeofrb == -2 ||
