...
namespace sccsr15forms
{
    public class sclevelgenmaps
    {
        ...
        public int[] buildchunkmaps(Vector3 currentPosition, float planeSize_, Vector3 _chunkPos, int typeofterraintiles, tutorialcubeaschunk componentparent_, int levelofdetail_) //, out int vertexNum, out int indicesNum
