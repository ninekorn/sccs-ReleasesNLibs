...
namespace sccsr15forms
{
    public class sccslevelgen
    {
        ...
        public void createlevel()
        {
            ...
            somewidth = (int)(maxx - minx) + 1;
            someheight = (int)(maxy - miny) + 1;
            somedepth = (int)(maxz - minz) + 1;
        ...
        public void createfinal()
        {
            if (counter == 1)
            {
                ...
                */
                ...
                /*for (var x = minx; x < maxx; x++)
                {
                    for (var y = miny; y < maxy; y++)
                    {
                        for (var z = minz; z < maxz; z++)
                        {
                            ...
                            if (levelmapsortingtiles[indexinlevelarray] == 998 || levelmapsortingtiles[indexinlevelarray] == 997)
                            {
                                levelmap[indexinlevelarray] = 1103;
                            }
                        }
                    ...
                    for (var y = miny; y < maxy; y++)
                    {
                        for (var z = minz; z < maxz; z++)
                        {
                            ...
                            if (levelmapsortingtilesremains[indexinlevelarray] == 998)
                            {
                                ...
                                {
                                    //toremove[indexinlevelarray] = 995;
                                    toremove[indexinlevelarray] = 998;// adjacenttiles[indexinlevelarray];
                                }
                            }
                        }
                    }
                ...
                //Console.WriteLine("/L0:" + somemaxarray0 + "/L1:" + somemaxarray1 + "/L0:" + somecounter);
                    ...
                    for (var y = miny; y < maxy; y++)
                    {
                        for (var z = minz; z < maxz; z++)
                        {
                            ...
                            if (levelmap[indexinlevelarray] != 1101 &&
                                ...
                                levelmap[indexinlevelarray] != 1112)
                            {
                                if (toremove[indexinlevelarray] == 998 )//&& levelmap[indexinlevelarray] == 0 ||
                                    //levelmapsortingtilesremains[indexinlevelarray] == 998 && levelmap[indexinlevelarray] != 0)
                                {
                                    levelmap[indexinlevelarray] = 1109;
                                    //levelmapsortingtiles[indexinlevelarray] = 0;
                                    //buildsomefloortiles(x,y,z);
                ...
                /*for (var x = minx; x < maxx; x++)
                {
                    for (var y = miny; y < maxy; y++)
                    {
                        for (var z = minz; z < maxz; z++)
                        {
                            ...
                            if (adjacenttiles[indexinlevelarray] == 1001)
                            {
                                if (levelmapsortingtiles[indexinlevelarray] == 0 || levelmapsortingtiles[indexinlevelarray] == 997)
                                {
                                    if (levelmap[indexinlevelarray] != 1101 &&
                                          levelmap[indexinlevelarray] != 1102 &&
                                          levelmap[indexinlevelarray] != 1103 &&
                        ...
                        for (var z = minz; z < maxz; z++)
                        {
                            ...
                            if (adjacenttiles[indexinlevelarray] == 1001)
                            {
                                if (levelmap[indexinlevelarray] != 1101 &&
                                    ...
                                    levelmap[indexinlevelarray] != 0)
                                {
                                    /*if (levelmap[indexinlevelarray] == 998)
                                    {
                                        //buildWallsRerolled(x, y, z);
                                        levelmap[indexinlevelarray] = 1112;
                                        levelmapsortingtiles[indexinlevelarray] = 1112;
                                    }
                                    else
                                    {
                                        levelmap[indexinlevelarray] = 1103;
                                        levelmapsortingtiles[indexinlevelarray] = 1103;
                                    }*/
                /*levelmap[indexinlevelarray] = 0;
                levelmapsortingtiles[indexinlevelarray] = 0;
            ...
            if (levelmapsortingtilesremains[indexinlevelarray] != 994)
            {
                levelmap[indexinlevelarray] = 1110;
                levelmapsortingtiles[indexinlevelarray] = 1110;
            }
