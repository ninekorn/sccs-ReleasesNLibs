...
namespace sccsr15forms
{
    public class sccstrigvertbuilder : IDisposable
    {
        ...
        private Vector4 forward = new Vector4(0, 0, 1, 1.0f);
        private Vector4 back = new Vector4(0, 0, -1, 1.0f);
        private Vector4 right = new Vector4(1, 0, 0, 1.0f);
        private Vector4 left = new Vector4(-1, 0, 0, 1.0f);
        private Vector4 up = new Vector4(0, 1, 0, 1.0f);
        private Vector4 down = new Vector4(0, -1, 0, 1.0f);
        ...
        public void DrawBrick(int x, int y, int z, Vector4 currentPosition, int block, int voxeltype)
        {
            ...
            Vector4 start = new Vector4(x * planeSize, y * planeSize, z * planeSize, 1.0f);
            ...
            */
            ...
            if (IsTransparent(x, y + 1, z))
            {
                ...
                createTopFace(start, offset1, offset2, currentPosition, x, y, z, 1, 0);
            ...
            if (IsTransparent(x, y - 1, z))
            {
                offset1 = right * planeSize;
                offset2 = forward * planeSize;
                createBottomFace(start, offset1, offset2, currentPosition, x, y, z, 1, 0);
            }
            //RIGHTFACE
            if (IsTransparent(x + 1, y, z))
            {
                offset1 = up * planeSize;
                offset2 = forward * planeSize;
                createRightFace(start + right * planeSize, offset1, offset2, currentPosition, x, y, z, 1, 0);
            }
            //LEFTFACE
            if (IsTransparent(x - 1, y, z))
            {
                offset1 = back * planeSize;
                offset2 = down * planeSize;
                createleftFace(start + up * planeSize + forward * planeSize, offset1, offset2, currentPosition, x, y, z, 1, 0);
            }*/
            //FRONTFACE
            if (IsTransparent(x, y, z - 1))
            {
                offset1 = left * planeSize;
                offset2 = up * planeSize;
                //createFrontFace(start + right * planeSize, offset1, offset2, currentPosition, x, y, z, 1, 0);
                createFrontFace(start + right * planeSize, offset1, offset2, currentPosition, x, y, z, 1, 0);
            ...
            if (IsTransparent(x, y, z + 1))
            {
                ...
                createBackFace(start * planeSize, offset1, offset2, currentPosition, x, y, z, 1, 0);
        ...
        private void createleftFace(Vector4 start, Vector4 offset1, Vector4 offset2, Vector4 currentPosition, int x, int y, int z, float block, int voxeltype)
        {
            ...
            mcolor = new Vector4(0.15f, 0.5f, 0.5f, 1.0f);
