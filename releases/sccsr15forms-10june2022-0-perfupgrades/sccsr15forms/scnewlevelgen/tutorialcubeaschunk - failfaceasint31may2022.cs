...
namespace sccsr15forms
{
    public class tutorialcubeaschunk : IDisposable
    {
        ...
        public tutorialcubeaschunk(Device device)
        {
            ...
            //arraychunkmapslod0 = new levelgenmaps[levelgen.typeoftiles.Count];
            //arraychunkvertslod0 = new levelgenvert[levelgen.typeoftiles.Count];
            arraychunkdatalod0 = new chunkdata[levelgen.typeoftiles.Count];
            arraychunkdatalod1 = new chunkdata[levelgen.typeoftiles.Count];
            arraychunkdatalod2 = new chunkdata[levelgen.typeoftiles.Count];
            arraychunkdatalod3 = new chunkdata[levelgen.typeoftiles.Count];
            arraychunkdatalod4 = new chunkdata[levelgen.typeoftiles.Count];
            ...
            while (enumerator1.MoveNext())
            {
                ...
                {
                    xx *= -1;
                    xx = xx + (levelgen.maxx - 1);
                }

                if (yy < 0)
                {
                    yy *= -1;
                    yy = yy + (levelgen.maxy - 1);
                }
                if (zz < 0)
                {
                    zz *= -1;
                    zz = zz + (levelgen.maxz - 1);
                }


                int indexofmaparray = xx + levelgen.somewidth * (yy + levelgen.someheight * zz); //y is always 0 on floor tiles


                var indexoftile = levelgen.levelmap[indexofmaparray];
                ...
                arraychunkdatalod0[ichunkleveltile].arraychunkvertslod0 = new sclevelgenvert(somearrayint);
                arraychunkdatalod0[ichunkleveltile].arraychunkvertslod0.buildchunkmaps(typeofterraintile, this, 1);
                arraychunkdatalod0[ichunkleveltile].realpos = newchunkpos;
                arraychunkdatalod0[ichunkleveltile].chunkPos = somearrayint;
                ...
                arraychunkdatalod0[ichunkleveltile].arraychunkvertslod0.chunkPos = somearrayint;
                ...
                //somemap = arraychunkdatalod1[ichunkleveltile].arraychunkmapslod1.buildchunkmaps( typeofterraintile, this, 1);
                arraychunkdatalod1[ichunkleveltile].arraychunkvertslod1 = new sclevelgenvert(somearrayint);
                arraychunkdatalod1[ichunkleveltile].arraychunkvertslod1.buildchunkmaps( typeofterraintile, this, 2);
                arraychunkdatalod1[ichunkleveltile].realpos = newchunkpos;
                arraychunkdatalod1[ichunkleveltile].chunkPos = somearrayint;
                ...
                arraychunkdatalod1[ichunkleveltile].arraychunkvertslod1.chunkPos = somearrayint;
                ...
                //somemap = arraychunkdatalod2[ichunkleveltile].arraychunkmapslod2.buildchunkmaps( typeofterraintile, this, 1);
                arraychunkdatalod2[ichunkleveltile].arraychunkvertslod2 = new sclevelgenvert(somearrayint);
                arraychunkdatalod2[ichunkleveltile].arraychunkvertslod2.buildchunkmaps( typeofterraintile, this, 3);
                arraychunkdatalod2[ichunkleveltile].realpos = newchunkpos;
                arraychunkdatalod2[ichunkleveltile].chunkPos = somearrayint;
                ...
                arraychunkdatalod2[ichunkleveltile].arraychunkvertslod2.chunkPos = somearrayint;
                ...
                //somemap = arraychunkdatalod3[ichunkleveltile].arraychunkmapslod3.buildchunkmaps( typeofterraintile, this, 1);
                arraychunkdatalod3[ichunkleveltile].arraychunkvertslod3 = new sclevelgenvert(somearrayint);
                arraychunkdatalod3[ichunkleveltile].arraychunkvertslod3.buildchunkmaps( typeofterraintile, this, 4);
                arraychunkdatalod3[ichunkleveltile].realpos = newchunkpos;
                arraychunkdatalod3[ichunkleveltile].chunkPos = somearrayint;
                ...
                arraychunkdatalod3[ichunkleveltile].arraychunkvertslod3.chunkPos = somearrayint;
                ...
                //somemap = arraychunkdatalod4[ichunkleveltile].arraychunkmapslod4.buildchunkmaps( typeofterraintile, this, 1);
                arraychunkdatalod4[ichunkleveltile].arraychunkvertslod4 = new sclevelgenvert(somearrayint);
                arraychunkdatalod4[ichunkleveltile].arraychunkvertslod4.buildchunkmaps( typeofterraintile, this, 5);
                arraychunkdatalod4[ichunkleveltile].realpos = newchunkpos;
                arraychunkdatalod4[ichunkleveltile].chunkPos = somearrayint;
                ...
                arraychunkdatalod4[ichunkleveltile].arraychunkvertslod4.chunkPos = somearrayint;
