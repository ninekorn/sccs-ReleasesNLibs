            ...
            //if (!runapptype)
            {
                ...
                */
                ...
                if (!Program.runapptype)
                {
                    ...
                    {
                        resultsetuppipelineUIThread = SetupPipelineUIThread();
                    }
                    ...
                    if (D3D.currentState.Type == directx.TestType.Immediate || (D3D.currentState.Type == directx.TestType.Deferred && D3D.currentState.ThreadCount == 1))
                    {
                        ...
                        {
                            //IAsyncResult result = 
                            resultrenderrowUIThread = renderrowUIThread(0, 0, D3D.currentState.CountCubes);
                        }
                    ...
                    if (D3D.currentState.Type != directx.TestType.Immediate)
                    {
                        if (D3D.currentState.Type == directx.TestType.FrozenDeferred)
                        {
                            if (D3D.commandsListUIThread[0] == null)
                            {
                                ...
                                {
                                    resultrenderdeferredUIThread = RenderDeferredUIThread(1);
                                }
                            }
                        ...
                        else if (D3D.currentState.ThreadCount > 1)
                        {
                            if (RenderDeferredUIThread!= null)
                            {
                                resultrenderdeferredUIThread = RenderDeferredUIThread(D3D.currentState.ThreadCount);
                            }
                ...
                else if (Program.runapptype)
                {
                    ...
                    {
                        resultrenderdeferredSysThread = SetupPipelineSysThread();
                    }
                    // Setup the pipeline before any rendering
                    ...
                    if (D3D.currentState.Type == directx.TestType.Immediate || (D3D.currentState.Type == directx.TestType.Deferred && D3D.currentState.ThreadCount == 1))
                    {
                        ...
                        {
                            resultrenderdeferredSysThread = renderrowSysThread(0, 0, D3D.currentState.CountCubes);
                        }
                    ...
                    if (D3D.currentState.Type != directx.TestType.Immediate)
                    {
                        if (D3D.currentState.Type == directx.TestType.FrozenDeferred)
                        {
                            if (D3D.commandsListSysThread[0] == null)
                            {
                                ...
                                {
                                    resultrenderdeferredSysThread = RenderDeferredSysThread(1);
                                }                        
                            }
                        }
                        else if (D3D.currentState.ThreadCount > 1)
                        {
                            if (RenderDeferredSysThread != null)
                            {
                                resultrenderdeferredSysThread = RenderDeferredSysThread(D3D.currentState.ThreadCount);
                            }
                        }
