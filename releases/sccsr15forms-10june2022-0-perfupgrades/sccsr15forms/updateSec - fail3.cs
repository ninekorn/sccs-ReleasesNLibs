...
namespace sccsr15forms
{
    internal class updateSec : IDisposable
    {
        ...
        public Func<int, int, int, int> renderrowUIThread;


        public Func<int, int> RenderDeferredUIThread;
        //public Action<int> RenderDeferredUIThread;
        //Action<int, int, int> RenderRow;
        //public Action SetupPipelineUIThread;

        public Func<int> SetupPipelineUIThread;



        public Func<int, int, int,int> renderrowSysThread;


        public Func<int, int> RenderDeferredSysThread;
        //public Action<int> RenderDeferredSysThread;
        //Action<int, int, int> RenderRow;
        //public Action SetupPipelineSysThread;

        public Func<int> SetupPipelineSysThread;
        ...
        public updateSec(updatePrim updateprim_, directx D3D_)
        {
            ...
            SetupPipelineUIThread = () =>
            {
                ...
                hasfinishedSetupPipeline = 1;
                 return 1;// (IAsyncResult)new object();
            };
        ...
        private static void CallbacksetuppipelineUIThread(IAsyncResult ar)
        {
            AsyncResult asyncResult = (AsyncResult)ar;
            Func<int> d = (Func<int>)asyncResult.AsyncDelegate;
            int result = d.EndInvoke(ar);
        }

        private static void CallbacksetuppipelineSysThread(IAsyncResult ar)
        {
            AsyncResult asyncResult = (AsyncResult)ar;
            Func<int> d = (Func<int>)asyncResult.AsyncDelegate;
            int result = d.EndInvoke(ar);
        ...
        private static void CallbackdeferredrenderUIThread(IAsyncResult ar)
        {
            AsyncResult asyncResult = (AsyncResult)ar;
            Func<int, int> d = (Func<int, int>)asyncResult.AsyncDelegate;
            int result = d.EndInvoke(ar);
        }

        private static void CallbackdeferredrenderSysThread(IAsyncResult ar)
        {
            AsyncResult asyncResult = (AsyncResult)ar;
            Func<int, int> d = (Func<int, int>)asyncResult.AsyncDelegate;
            int result = d.EndInvoke(ar);
        ...
        private static void CallbackrenderrowUIThread(IAsyncResult ar)
        {
            AsyncResult asyncResult = (AsyncResult)ar;
            Func<int, int,int, int> d = (Func<int, int, int, int>)asyncResult.AsyncDelegate;
            int result = d.EndInvoke(ar);
        }

        private static void CallbackrenderrowSysThread(IAsyncResult ar)
        {
            AsyncResult asyncResult = (AsyncResult)ar;
            Func<int, int, int, int> d = (Func<int, int, int, int>)asyncResult.AsyncDelegate;
            int result = d.EndInvoke(ar);
        ...
        public void createsysthreadactions() 
        {
        ...
        public void createuithreadactions()
        {
        ...
        /*
        public int resultrenderrowUIThread;
        public int resultsetuppipelineUIThread;
        public int resultrenderdeferredUIThread;
        public int resultrenderrowSysThread;
        public int resultsetuppipelineSysThread;
        public int resultrenderdeferredSysThread;*/

        
        public IAsyncResult resultrenderrowUIThread;
        public IAsyncResult resultsetuppipelineUIThread;
        public IAsyncResult resultrenderdeferredUIThread;
        public IAsyncResult resultrenderrowSysThread;
        public IAsyncResult resultsetuppipelineSysThread;
        public IAsyncResult resultrenderdeferredSysThread;
            ...
            //if (!runapptype)
            {
                ...
                */
                ...
                if (!Program.runapptype)
                {
                    ...
                    if (SetupPipelineUIThread!= null)
                    {
                        resultsetuppipelineUIThread = SetupPipelineUIThread.BeginInvoke(CallbacksetuppipelineUIThread, null);
                    }
                    ...
                    {
                        if (renderrowUIThread!= null)
                        {
                            //IAsyncResult result = 
                            resultrenderrowUIThread = renderrowUIThread.BeginInvoke(0, 0, D3D.currentState.CountCubes, CallbackrenderrowUIThread, null); //(0, 0, D3D.currentState.CountCubes)
                        }
                    ...
                    if (D3D.currentState.Type != directx.TestType.Immediate)
                    {
                        if (D3D.currentState.Type == directx.TestType.FrozenDeferred)
                        {
                            ...
                            {
                                if (RenderDeferredUIThread!= null)
                                {
                                    resultrenderdeferredUIThread = RenderDeferredUIThread.BeginInvoke(1, CallbackdeferredrenderUIThread, null);
                                }
                            }
                        ...
                        else if (D3D.currentState.ThreadCount > 1)
                        {
                            if (RenderDeferredUIThread!= null)
                            {
                                resultrenderdeferredUIThread = RenderDeferredUIThread.BeginInvoke(D3D.currentState.ThreadCount, CallbackdeferredrenderUIThread, null);
                            }
                ...
                else if (Program.runapptype)
                {
                    ...
                    // IAsyncResult result = 
                    // Setup the pipeline before any rendering
                    if (SetupPipelineSysThread != null)
                    {
                        resultsetuppipelineSysThread = SetupPipelineSysThread.BeginInvoke(CallbacksetuppipelineSysThread, null);
                    }
                    ...
                    if (D3D.currentState.Type == directx.TestType.Immediate || (D3D.currentState.Type == directx.TestType.Deferred && D3D.currentState.ThreadCount == 1))
                    {
                        if (renderrowSysThread != null)
                        {
                            //IAsyncResult result = 
                            resultrenderrowSysThread = renderrowSysThread.BeginInvoke(0, 0, D3D.currentState.CountCubes, CallbackrenderrowSysThread, null); //(0, 0, D3D.currentState.CountCubes)
                        }
                    ...
                    if (D3D.currentState.Type != directx.TestType.Immediate)
                    {
                        if (D3D.currentState.Type == directx.TestType.FrozenDeferred)
                        {
                            ...
                            {
                                if (RenderDeferredSysThread != null)
                                {
                                    resultrenderdeferredSysThread = RenderDeferredSysThread.BeginInvoke(1, CallbackdeferredrenderSysThread, null);
                                }
                            }
                        ...
                        else if (D3D.currentState.ThreadCount > 1)
                        {
                            if (RenderDeferredSysThread != null)
                            {
                                resultrenderdeferredSysThread = RenderDeferredSysThread.BeginInvoke(D3D.currentState.ThreadCount, CallbackdeferredrenderSysThread, null);
                            }
