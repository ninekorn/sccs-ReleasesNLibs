...
namespace sccsr15forms
{
    internal class updateSec : IDisposable
    {
        ...
        public Func<int, int, int, IAsyncResult> renderrowUIThread;


        public Func<int, IAsyncResult> RenderDeferredUIThread;
        //public Action<int> RenderDeferredUIThread;
        //Action<int, int, int> RenderRow;
        //public Action SetupPipelineUIThread;

        public Func<IAsyncResult> SetupPipelineUIThread;



        public Func<int, int, int, IAsyncResult> renderrowSysThread;


        public Func<int, IAsyncResult> RenderDeferredSysThread;
        //public Action<int> RenderDeferredSysThread;
        //Action<int, int, int> RenderRow;
        //public Action SetupPipelineSysThread;

        public Func<IAsyncResult> SetupPipelineSysThread;
        ...
        public updateSec(updatePrim updateprim_, directx D3D_)
        {
            ...
            SetupPipelineUIThread = () =>
            {
                ...
                return null;// (IAsyncResult)new object();
            };
