                ...
                for (int y = fromY; y < toY; y++)
                {
                    for (int x = 0; x < count; x++)
                    {
                        ...
                        if (D3D.currentState.UseMap)
                        {
                            if (somecube!= null)
                            {
                                if (somecube.dynamicConstantBuffersysthread != null)
                                {
                        ...
                        else
                        {
                            if (somecube != null)
                            {
                                if (somecube.staticContantBuffersysthread != null)
                                {
                ...
                for (int y = fromY; y < toY; y++)
                {
                    for (int x = 0; x < count; x++)
                    {
                        ...
                        if (D3D.currentState.UseMap)
                        {
                            if (somecube != null)
                            {
                                if (somecube.dynamicConstantBufferuithread != null)
                                {
                        ...
                        else
                        {
                            if (somecube != null)
                            {
                                if (somecube.staticContantBufferuithread != null)
                                {
