...
namespace sccsr15forms
{
    public class sclevelgenclassPrim
    {
        ...
        public class chunkData
        {
            ...
            public SharpDX.Direct3D11.Buffer staticConstantBuffer;
        ...
        //SharpDX.Direct3D11.Buffer staticConstantBuffer;
        ...
        public void createChunk(directx D3D, float surfaceWidth, float surfaceHeight, Vector3 lightpos, Vector3 dirLight, Vector3 somechunkpriminstancepos_, int chunkindex_, int _addtoworld, float _mass, World _the_world, bool _is_static, sccsr15forms.directx.BodyTag _tag, int numberofmainobjectx, int numberofmainobjecty, int numberofmainobjectz, float planeSize_, int shaderswtch, float offsetinstance, int fullface_, int usegeometryshader_, int somechunkkeyboardpriminstanceindex_, int voxeltype_, Matrix worldmatofobj_, int typeofbytemapobject_, int mainix, int mainiy, int mainiz,int typeofvoxelmesh, int swtcsetneighboors)
        {
            try
            {
                ...
                //staticConstantBuffer = new SharpDX.Direct3D11.Buffer(D3D.Device, Utilities.SizeOf<DMatrixBuffer>(), ResourceUsage.Default, BindFlags.ConstantBuffer, CpuAccessFlags.None, ResourceOptionFlags.None, 0);
                ...
                */
                ...
                var staticConstantBuffer = new SharpDX.Direct3D11.Buffer(D3D.Device, Utilities.SizeOf<Matrix>(), ResourceUsage.Default, BindFlags.ConstantBuffer, CpuAccessFlags.None, ResourceOptionFlags.None, 0);
               var dynamicConstantBuffer = new SharpDX.Direct3D11.Buffer(D3D.Device, Utilities.SizeOf<Matrix>(), ResourceUsage.Dynamic, BindFlags.ConstantBuffer, CpuAccessFlags.Write, ResourceOptionFlags.None, 0);
                ...
                while (enumerator1.MoveNext())
                {
                    ...
                    newchunkpos.X = newchunkpos.X * (sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.widthlod0 * planeSize);
                    newchunkpos.Y = newchunkpos.Y * (sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.heightlod0 * planeSize);
                    newchunkpos.Z = newchunkpos.Z * (sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.depthlod0 * planeSize);
                    ...
                    arrayofindexzeromeshlod0[ichunkleveltile] = new sclevelgenclass(new Vector4(0.1f, 0.1f, 0.1f, 1), chunkPos, worldmatofobj, _addtoworld, _mass, _the_world, _is_static, _tag, planeSize, offsetinstance, levelgen); //, instances[ichunkleveltile]        
                    ...
                    sometrigchunkmap = new sclevelgenmaps();
                    newChunker = new sclevelgenvert();
                    arrayofindexzeromeshlod1[ichunkleveltile] = new sclevelgenclass(new Vector4(0.1f, 0.1f, 0.1f, 1), chunkPos, worldmatofobj, _addtoworld, _mass, _the_world, _is_static, _tag, planeSize, offsetinstance, levelgen); //, instances[ichunkleveltile]        
                    ...
                    sometrigchunkmap = new sclevelgenmaps();
                    newChunker = new sclevelgenvert();
                    arrayofindexzeromeshlod2[ichunkleveltile] = new sclevelgenclass(new Vector4(0.1f, 0.1f, 0.1f, 1), chunkPos, worldmatofobj, _addtoworld, _mass, _the_world, _is_static, _tag, planeSize, offsetinstance, levelgen); //, instances[ichunkleveltile]        
                    ...
                    sometrigchunkmap = new sclevelgenmaps();
                    newChunker = new sclevelgenvert();
                    arrayofindexzeromeshlod3[ichunkleveltile] = new sclevelgenclass(new Vector4(0.1f, 0.1f, 0.1f, 1), chunkPos, worldmatofobj, _addtoworld, _mass, _the_world, _is_static, _tag, planeSize, offsetinstance, levelgen); //, instances[ichunkleveltile]        
                ...
                while (enumerator1.MoveNext())
                {
                    ...
                    if (indicesArray0.Length > 0)
                    {
                        ...
                        arrayOfChunkDatalod0[ichunkleveltile].frustrumculldraw = false;
                        arrayOfChunkDatalod0[ichunkleveltile].staticConstantBuffer = staticConstantBuffer;
                        arrayOfChunkDatalod0[ichunkleveltile].dynamicConstantBuffer = dynamicConstantBuffer;
                    ...
                    /*
                    arrayofchunkslod1[ichunkleveltile] = arrayofindexzeromeshlod1[ichunkleveltile].createchunkvert(newchunkpos, levelgen, chunkPos, arrayofchunkslod1[ichunkleveltile], typeofterraintile, out somemap, out indicesArray0, out arrayOfD, this, arrayofchunksmapslod1[ichunkleveltile], 2);
                    ...
                    if (indicesArray0.Length > 0)
                    {
                        ...
                        arrayOfChunkDatalod1[ichunkleveltile].frustrumculldraw = false;
                        arrayOfChunkDatalod1[ichunkleveltile].staticConstantBuffer = staticConstantBuffer;
                    }




                    arrayofchunkslod2[ichunkleveltile] = arrayofindexzeromeshlod2[ichunkleveltile].createchunkvert(newchunkpos, levelgen, chunkPos, arrayofchunkslod2[ichunkleveltile], typeofterraintile, out somemap, out indicesArray0, out arrayOfD, this, arrayofchunksmapslod2[ichunkleveltile], 3);
                    if (indicesArray0.Length > 0)
                    {
                        var VertexBuffer = SharpDX.Direct3D11.Buffer.Create(D3D.Device, BindFlags.VertexBuffer, arrayOfD);
                        var IndicesBuffer = SharpDX.Direct3D11.Buffer.Create(D3D.Device, BindFlags.IndexBuffer, indicesArray0);
                        ...
                        arrayOfChunkDatalod2[ichunkleveltile].frustrumculldraw = false;
                        arrayOfChunkDatalod2[ichunkleveltile].staticConstantBuffer = staticConstantBuffer;
                    }
                    ...
                    arrayofchunkslod3[ichunkleveltile] = arrayofindexzeromeshlod3[ichunkleveltile].createchunkvert(newchunkpos, levelgen, chunkPos, arrayofchunkslod3[ichunkleveltile], typeofterraintile, out somemap, out indicesArray0, out arrayOfD, this, arrayofchunksmapslod3[ichunkleveltile], 4);
                    if (indicesArray0.Length > 0)
                    {
                        var VertexBuffer = SharpDX.Direct3D11.Buffer.Create(D3D.Device, BindFlags.VertexBuffer, arrayOfD);
                       var IndicesBuffer = SharpDX.Direct3D11.Buffer.Create(D3D.Device, BindFlags.IndexBuffer, indicesArray0);
                        ...
                        arrayOfChunkDatalod3[ichunkleveltile].frustrumculldraw = false;
                        arrayOfChunkDatalod3[ichunkleveltile].staticConstantBuffer = staticConstantBuffer;
                    }*/
