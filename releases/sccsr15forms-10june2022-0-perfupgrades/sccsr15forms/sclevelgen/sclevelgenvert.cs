    ...
    public class sclevelgenvert
    {
        ...
        //public void startBuildingArray(Vector4 currentPosition, out sclevelgenclass.DVertex[] vertexArray, out int[] triangleArray, out int[] mapper, int padding0_, int padding1_, int padding2_, int numberOfObjectInWidth_, int numberOfObjectInHeight_, int numberOfObjectInDepth_, int numberOfInstancesPerObjectInWidth_, int numberOfInstancesPerObjectInHeight_, int numberOfInstancesPerObjectInDepth_, int tinyChunkWidth_, int tinyChunkHeight_, int tinyChunkDepth_, float planeSize_, sclevelgenclassPrim componentparentprim_, sclevelgenclass componentparentinstance_, sclevelgenclass_instances componentparentthischunk_, int fullface_, int voxeltype_)
        {
            ...
            */
            ...
            if (levelofdetail == 1)
            {
                width = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.widthlod0;
                height = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.heightlod0;
                depth = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.depthlod0;
            ...
            {
                width = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.widthlod1;
                height = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.heightlod1;
                depth = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.depthlod1;
            ...
            {
                width = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.widthlod2;
                height = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.heightlod2;
                depth = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.depthlod2;
                //width = 3;
                //height = 3;
                //depth = 3;
            }
            ...
            {
                width = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.widthlod3;
                height = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.heightlod3;
                depth = sccsr15forms.updateSec.currentupdatesec.somelevelgenprimglobals.depthlod3;
            ...
            */
            ...
            for (int i = 0; i < listofvecs.Count; i++)
            {
                if (levelofdetail == 1)
                {
                    listofchunksadjacent[i] = (sclevelgenvert)componentparent.getChunklod0(listofvecs[i].X, listofvecs[i].Y, listofvecs[i].Z, out arrayindex);
            ...
            {
                listofchunksadjacentfloor[i] = (sclevelgenvert)componentparent.getChunklod0(listofvecsadjacentfloor[i].X, 0, listofvecsadjacentfloor[i].Z, out arrayindex);
            }*/
                    ...
                    {                                       
                        ...
                        if (IsTransparent(xi, yi - 1, zi))
                        {
                            ...
                            else if (yi == 0)
                            {
                                ...
                                if (listofchunksadjacent[4] != null && levelofdetail == 1) //&& levelofdetail == 1
                                {
                                    //Console.WriteLine(chunkPos + " " + someChunk.chunkPos);
                        ...
                        if (IsTransparent(xi, yi + 1, zi))
                        {
                            ...
                            else if (yi == height - 1)
                            {
                                ...
                                if (listofchunksadjacent[5] != null && levelofdetail == 1) //&& levelofdetail == 1
                                {
                                    //Console.WriteLine(chunkPos + " " + someChunk.chunkPos);
                        ...
                        //if (someChunk.IsTransparent(width - 1, yi, zi))
                        {
                            ...
                            if (IsTransparent(xi - 1, yi, zi))// && someChunk.IsTransparent(width - 1, yi, zi))
                            {
                                ...
                                if (getChunklod0Vertexint1(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                                {
                                    ...
                                    ////////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(oneVertIndexX, oneVertIndexY, oneVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                ...
                                if (getChunklod0Vertexint1(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 0)
                                {
                                    ...
                                    ////////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(twoVertIndexX, twoVertIndexY, twoVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                ...
                                if (getChunklod0Vertexint1(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 0)
                                {
                                    ...
                                    ////////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(fourVertIndexX, fourVertIndexY, fourVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                        ...
                        for (int _zz = 0; _zz < _maxDepth; _zz++)
                        {
                            ...
                            if (rowIterateY < height && rowIterateZ < depth)
                            {
                                if (_yy == 0 && _zz == 0)
                                {
                                    ...
                                    oneVertIndexY = rowIterateY;
                                    oneVertIndexZ = rowIterateZ;
                                    ////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, y + 1, rowIterateZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                    foundVertOne = true;
                                    ...
                                    if (blockExistsInArray(xi, rowIterateY + 1, rowIterateZ))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxHeight = _yy;
                                            foundVertThree = true;
                                            ////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX+1, y+1, rowIterateZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                    ...
                                    else
                                    {
                                        ...
                                        if (rowIterateZ + 1 == twoVertIndexZ && rowIterateY + 1 == threeVertIndexY)
                                        {
                                            ...
                                            fourVertIndexY = threeVertIndexY;
                                            fourVertIndexZ = twoVertIndexZ;
                                            ////////Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX + 1, y + 1, twoVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                        }
                                    }
                                    ...
                                    if (blockExistsInArray(xi, rowIterateY, rowIterateZ + 1))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxDepth = _zz + 1;
                                            foundVertTwo = true;
                                            ////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, y + 1, rowIterateZ + 1) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                            if (rowIterateZ + 1 == twoVertIndexZ && rowIterateY + 1 == threeVertIndexY)
                                            {
                                                fourVertIndexX = xi + 1;
                                                fourVertIndexY = threeVertIndexY;
                                            ...
                                            if (_block == 1)
                                            {
                                                if (blockExistsInArray(xi + 1, rowIterateY, rowIterateZ + 1))
                                                {
                                                    ...
                                                    if (_block == 1 || _block == 2)
                                                    {
                                                        ...
                                                        _maxDepth = _zz + 1;
                                                        foundVertTwo = true;
                                                        ////////Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX, y + 1, rowIterateZ + 1) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                ...
                                else if (_yy == 0 && _zz > 0)
                                {
                                    ...
                                    if (blockExistsInArray(xi, rowIterateY + 1, rowIterateZ))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxHeight = _yy;
                                            foundVertThree = true;
                                            ////////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX + 1, y + 1, rowIterateZ - _zz) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                            if (rowIterateZ + 1 == twoVertIndexZ && rowIterateY + 1 == threeVertIndexY)
                                            {
                                                fourVertIndexX = xi + 1;
                                                fourVertIndexY = threeVertIndexY;
                                        ...
                                        else if (_block == 1 || _block == 2)
                                        {
                                            ...
                                            if (blockExistsInArray(xi + 1, rowIterateY + 1, rowIterateZ))
                                            {
                                                ...
                                                if (_block == 1 || _block == 2)
                                                {
                                                    ...
                                                    _maxHeight = _yy;
                                                    foundVertThree = true;
                                                    ////////Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX + 1, y + 1, rowIterateZ - _zz) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                                    if (rowIterateZ + 1 == twoVertIndexZ && rowIterateY + 1 == threeVertIndexY)
                                                    {
                                                        fourVertIndexX = xi + 1;
                                                        fourVertIndexY = threeVertIndexY;
                            ...
                            if (blockExistsInArray(xi, rowIterateY, rowIterateZ))
                            {
                                ...
                                ////////Instantiate(_blockZero, new Vector3(rowIterateX + 0.5f, y, rowIterateZ + 0.5f) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                            }
                        }
                    }
                        ...
                        for (int _xx = 0; _xx < _maxWidth; _xx++)
                        {
                            ...
                            if (rowIterateY < height && rowIterateX < width)
                            {
                                if (_yy == 0 && _xx == 0)
                                {
                                    ...
                                    oneVertIndexY = rowIterateY;
                                    oneVertIndexZ = zi + 1;
                                    //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, y + 1, rowIterateZ) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                                    ...
                                    if (blockExistsInArray(rowIterateX, rowIterateY + 1, zi))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxHeight = _yy;
                                            foundVertThree = true;
                                            //////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX+1, y+1, rowIterateZ) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                                    ...
                                    else
                                    {
                                        ...
                                        if (rowIterateX + 1 == twoVertIndexX && rowIterateY + 1 == threeVertIndexY)
                                        {
                                            ...
                                            fourVertIndexY = threeVertIndexY;
                                            fourVertIndexZ = zi + 1;
                                            //////Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX + 1, y + 1, twoVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                                        }
                                    }
                                    ...
                                    if (blockExistsInArray(rowIterateX + 1, rowIterateY, zi))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxWidth = _xx + 1;
                                            foundVertTwo = true;
                                            //////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, y + 1, rowIterateZ + 1) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                                            ...
                                            if (_block == 1)
                                            {
                                                if (blockExistsInArray(rowIterateX + 1, rowIterateY, zi + 1))
                                                {
                                                    ...
                                                    if (_block == 1 || _block == 2)
                                                    {
                                                        ...
                                                        _maxWidth = _xx + 1;
                                                        foundVertTwo = true;
                                                        //////Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX, y + 1, rowIterateZ + 1) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                                ...
                                else if (_yy == 0 && _xx > 0)
                                {
                                    ...
                                    if (blockExistsInArray(rowIterateX, rowIterateY + 1, zi))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxHeight = _yy;
                                            foundVertThree = true;
                                            //////Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX + 1, y + 1, rowIterateZ - ziz) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                                        ...
                                        else if (_block == 1 || _block == 2)
                                        {
                                            ...
                                            if (blockExistsInArray(rowIterateX, rowIterateY + 1, zi + 1))
                                            {
                                                ...
                                                if (_block == 1 || _block == 2)
                                                {
                                                    ...
                                                    _maxHeight = _yy;
                                                    foundVertThree = true;
                                                    //////Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX + 1, y + 1, rowIterateZ - ziz) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                            ...
                            if (blockExistsInArray(rowIterateX, rowIterateY, zi))
                            {
                                ...
                                //////Instantiate(_blockZero, new Vector3(rowIterateX + 0.5f, y, rowIterateZ + 0.5f) * planeSize * levelofdetail * levelofdetailmul + _chunkPos, Quaternion.identity);
                            }
                        }
                    }
                        ...
                        for (int _zz = 0; _zz < _maxDepth; _zz++)
                        {
                            ...
                            if (rowIterateX < width && rowIterateZ < depth)
                            {
                                if (_xx == 0 && _zz == 0)
                                {
                                    ...
                                    oneVertIndexY = yi;
                                    oneVertIndexZ = rowIterateZ;
                                    //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, yi + 1, rowIterateZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                    foundVertOne = true;
                                    ...
                                    if (blockExistsInArray(rowIterateX + 1, yi, rowIterateZ))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxWidth = _xx;
                                            foundVertThree = true;
                                            //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX + 1, yi + 1, rowIterateZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                    ...
                                    else
                                    {
                                        ...
                                        if (rowIterateZ + 1 == twoVertIndexZ && rowIterateX + 1 == threeVertIndexX)
                                        {
                                            ...
                                            fourVertIndexY = yi;
                                            fourVertIndexZ = twoVertIndexZ;
                                            //Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX + 1, yi + 1, twoVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                        }
                                    }
                                    ...
                                    if (blockExistsInArray(rowIterateX, yi, rowIterateZ + 1))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxDepth = _zz + 1;
                                            foundVertTwo = true;
                                            //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX, yi + 1, rowIterateZ + 1) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                            ...
                                            if (_block == 1)
                                            {
                                                if (blockExistsInArray(rowIterateX, yi - 1, rowIterateZ + 1))
                                                {
                                                    ...
                                                    if (_block == 1 || _block == 2)
                                                    {
                                                        ...
                                                        _maxDepth = _zz + 1;
                                                        foundVertTwo = true;
                                                        //Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX, yi + 1, rowIterateZ + 1) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                ...
                                else if (_xx == 0 && _zz > 0)
                                {
                                    ...
                                    if (blockExistsInArray(rowIterateX + 1, yi, rowIterateZ))
                                    {
                                        ...
                                        if (_block == 0)
                                        {
                                            ...
                                            _maxWidth = _xx;
                                            foundVertThree = true;
                                            //Instantiate(_sphereVisualOtherColorBlack, new Vector3(rowIterateX + 1, yi + 1, rowIterateZ - _zz) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                        ...
                                        else if (_block == 1 || _block == 2)
                                        {
                                            ...
                                            if (blockExistsInArray(rowIterateX + 1, yi - 1, rowIterateZ))
                                            {
                                                ...
                                                if (_block == 1 || _block == 2)
                                                {
                                                    ...
                                                    _maxWidth = _xx;
                                                    foundVertThree = true;
                                                    //Instantiate(_sphereVisualOtherColor, new Vector3(rowIterateX + 1, yi + 1, rowIterateZ - _zz) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                    ...
                                    if (blockExistsInArray(rowIterateX + 1, yi, rowIterateZ))
                                    {
                                        ...
                                        else if (_block == 1 || _block == 2)
                                        {
                                            if (rowIterateZ + 1 == twoVertIndexZ && rowIterateX + 1 == threeVertIndexX)
                                            {
                                                ...
                                                fourVertIndexY = yi;
                                                fourVertIndexZ = twoVertIndexZ;
                                                ////Instantiate(_sphereVisualOtherColorOrange, new Vector3(rowIterateX + 1, yi + 1, twoVertIndexZ) * planeSize * levelofdetail * levelofdetailmul + chunkPos, Quaternion.identity);
                                            }
