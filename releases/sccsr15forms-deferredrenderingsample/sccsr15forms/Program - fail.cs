...
//references:
//https://stackoverflow.com/questions/6371846/using-system-func-anonymous-and-the-return-object-with-callback-function
    ...
    internal static class Program
    {
       //static IAsyncResult someres;
        ...
        /*private static void Callback(IAsyncResult ar)
        {
            ...
            Func<string, int> d = (Func<string, int>)asyncResult.AsyncDelegate;
        ...
        static int intreturn(string somestr)
        {
            return 1;
        }
        ...
        static void Main()
        {
            ...
            Func<string, int> d = strA =>
            {
                return intreturn(strA);
            };

            var test = d.BeginInvoke(a, Callback, null);*/
            ...
            RenderLoop.Run(sccsr15forms.Form1.currentform, () =>
            {
                        ...
                        loopgoto:
                            ...
                            else
                            {
                                ...
                                if (canworksysthread == 0)
                                {
                                    ...
                                    /*
                                    updatesec.SetupPipelineUIThread.EndInvoke(updatesec.resultsetuppipelineUIThread);// = null;
                                    updatesec.RenderDeferredUIThread.EndInvoke(updatesec.resultrenderdeferredUIThread);// = null;
                                    updatesec.renderrowUIThread.EndInvoke(updatesec.resultrenderrowUIThread);// = null;
                                    */


                                    /*
                                    updatesec.SetupPipelineUIThread.EndInvoke(null);// = null;
                                    updatesec.RenderDeferredUIThread.EndInvoke(null);// = null;
                                    updatesec.renderrowUIThread.EndInvoke(null);// = null;*/


                                    updatesec.SetupPipelineUIThread = null;
                                    updatesec.RenderDeferredUIThread = null;
                                    updatesec.renderrowUIThread = null;


                                    updatesec.createsysthreadactions();
                ...
                if (canworkuithread == 0)
                {
                   //MessageBox((IntPtr)0, "", "msg", 0);
                    ...
                    updatesec.SetupPipelineSysThread = null;
                    updatesec.RenderDeferredSysThread= null;
                    updatesec.renderrowSysThread = null;
                    /*
                    updatesec.SetupPipelineSysThread.EndInvoke(updatesec.resultsetuppipelineSysThread);// = null;
                    updatesec.RenderDeferredSysThread.EndInvoke(updatesec.resultrenderdeferredSysThread);// = null;
                    updatesec.renderrowSysThread.EndInvoke(updatesec.resultrenderrowSysThread);// = null;
                    */

                    /*
                    updatesec.SetupPipelineSysThread.EndInvoke(null);// = null;
                    updatesec.RenderDeferredSysThread.EndInvoke(null);// = null;
                    updatesec.renderrowSysThread.EndInvoke(null);// = null;*/





                    updatesec.createuithreadactions();
