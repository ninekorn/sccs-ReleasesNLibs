...
namespace SCCoreSystems.SC_Graphics.SC_ShaderManager
{
    public class SC_ShaderManager                 // 77 lines
    {
        ...
        sc_voxel.DLightBuffer[] _DLightBuffer23;
        sc_voxel.DLightBuffer[] _DLightBuffer24;
        ...
        public sc_voxel_shader_final _SC_sdr_lft_pelvisjoint { get; set; }
        public sc_voxel_shader_final _SC_sdr_rght_pelvisjoint { get; set; }
        ...
        SC_instancedChunk_shader_final shaderOfChunk;
        SC_instancedChunk_shader_final shaderOfplayerlocationChunk;

        public bool Initialize(Device device, IntPtr windowsHandle) //, float x, float y, float z, Vector4 color,Matrix worldMatrix
        {

            shaderOfChunk = new SC_instancedChunk_shader_final(device);
            shaderOfplayerlocationChunk = new SC_instancedChunk_shader_final(device);
            ...
            */
            ...
            //sc_voxel
            //////////////////////
            _DLightBuffer23 = new sc_voxel.DLightBuffer[1];
            _DLightBuffer23[0] = new sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = lightDirection,
            ...
            _SC_sdr_lft_pelvisjoint = new sc_voxel_shader_final();
            _SC_sdr_lft_pelvisjoint.Initialize(device, windowsHandle, ConstantLightBuffer, _DLightBuffer23);
            //////////////////////
            ...
            //sc_voxel
            //////////////////////
            _DLightBuffer24 = new sc_voxel.DLightBuffer[1];
            _DLightBuffer24[0] = new sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = lightDirection,
            ...
            ConstantLightBuffer = new SharpDX.Direct3D11.Buffer(device, lightBufferDesc);
            _SC_sdr_rght_pelvisjoint = new sc_voxel_shader_final();
            _SC_sdr_rght_pelvisjoint.Initialize(device, windowsHandle, ConstantLightBuffer, _DLightBuffer24);
            //////////////////////
            //SC_sdr_lft_elbow_target
            //////////////////////
        ...
        public bool renderinstancedchunk(SC_instancedChunkPrim.chunkData chunkdat, int indexBuilt, ShaderResourceView shaderResourceView2D_, int voxeltype_)
        {
            shaderOfChunk.Renderer(chunkdat, indexBuilt, shaderResourceView2D_, voxeltype_);
            return true;
        }


        public bool renderinstancedplayerlocationchunk(SC_instancedChunkPrim.chunkData chunkdat, int indexBuilt, ShaderResourceView shaderResourceView2D_, int voxeltype_)
        {
            shaderOfChunk.Renderer(chunkdat, indexBuilt, shaderResourceView2D_, voxeltype_);
            return true;
        }
        ...
        public bool _rend_lft_pelvisjoint(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, sc_voxel.DLightBuffer[] _DLightBuffer_, sc_voxel _cuber)
        {
            _SC_sdr_lft_pelvisjoint.Render(deviceContext, VertexCount, InstanceCount, worldMatrix, viewMatrix, projectionMatrix, texture, _DLightBuffer_, _cuber);
            return true;
        }

        public bool _rend_rght_pelvisjoint(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, sc_voxel.DLightBuffer[] _DLightBuffer_, sc_voxel _cuber)
        {
            _SC_sdr_rght_pelvisjoint.Render(deviceContext, VertexCount, InstanceCount, worldMatrix, viewMatrix, projectionMatrix, texture, _DLightBuffer_, _cuber);
            return true;
        }
