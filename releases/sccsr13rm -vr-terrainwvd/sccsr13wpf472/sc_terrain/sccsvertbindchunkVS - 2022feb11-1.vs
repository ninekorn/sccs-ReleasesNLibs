...
{   
	...
	float4 mapmatrix0b : POSITION10;
	float4 mapmatrix1b : POSITION11;
	float4 mapmatrix2b : POSITION12;
	float4 mapmatrix3b : POSITION13;
	float4 mapmatrix0c : POSITION14;
	float4 mapmatrix1c : POSITION15;
	float4 mapmatrix2c : POSITION16;
	float4 mapmatrix3c : POSITION17;
	float4 mapmatrix0d : POSITION18;
	float4 mapmatrix1d : POSITION19;
	float4 mapmatrix2d : POSITION20;
	float4 mapmatrix3d : POSITION21;
	/*int one : PSIZE3;	
	int oneTwo : PSIZE4;
	int two : PSIZE5;	
	int twoTwo : PSIZE6;	
...
{ 
	...
	{  
		...
		if (currentIndex >= 0 && currentIndex <= ((somecountermul * maxdigits)/2)-1)
        {
            int somemax = ((somecountermul * maxdigits)/2)-1;
            someOtherIndex = 1 + ((somemax - someOtherIndex) * 2);
        }
        else if (currentIndex >= ((somecountermul * maxdigits)/2) && currentIndex <= ((somecountermul * maxdigits)))
        {
            int somemax = ((somecountermul * maxdigits));
            someOtherIndex = 0 + ((somemax - someOtherIndex) * 2);
        }
    ...
    //3 byte locations per digits


    if(round(arrayOfDigits[someOtherIndex])  == 0)
    {
        //000

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 1)
    {
        //100

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 2)
    {
        //010

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 3)
    {
        //001

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 4)
    {
        //101

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 5)
    {
        //110

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 6)
    {
        //111

    }
    else if(round(arrayOfDigits[someOtherIndex])  == 7)
    {
        //011
	...
	if(round(arrayOfDigits[someOtherIndex]) == somedesiredbyte)  //( x + (tinyChunkWidth * (y + (tinyChunkHeight * z)))) >= (tinyChunkWidth * tinyChunkHeight * tinyChunkDepth))
	{	
		input.position.w = 1.0f;
