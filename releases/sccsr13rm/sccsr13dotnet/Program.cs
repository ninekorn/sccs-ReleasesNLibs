...
//COMMENTED OUT BY NINEKORN 2021-29AUGUST - NOT WORKING HERE
...
//using SCCoreSystems.systemdotspeech;
...
namespace SCCoreSystems
{
    ...
    internal class Program
    {
        ...
        public static int usethirdpersonview = 1;
        ...
        //SCCoreSystems.systemdotspeech createsystemdotspeechrecognition = new sccssystemdotspeech();

        //createsystemdotspeechrecognition.createsystemdotspeechrecognition();
        ...
        _main_thread_Loop_x00:
            ...
            if (_init_main == 1)
            {
                try
                {
                    ...
                    _mainTasker00.Priority = ThreadPriority.Lowest;
                ...
                try
                {
                    if (_mainFrameStarterItemz)
                    {
                        ...
                        _mainTasker00 = new Thread((tester0000) =>
                        {
                            ...
                            //_thread_start:
                        }, 0); //100000 //999999999 //using netcoreapp2.1 you have to put this to 0.but for some reasons the setting 3 works in wpf 4.7.2. to double check
                        ...
                        //MessageBox((IntPtr)0, "has program attempted to start?", "sccs error message", 0);
                    }
                }
                catch (Exception ex)
                {
        ...
        public static void _mainUpdateThread()
        {
            ...
            if (resetVoidExpanserecog.Elapsed.TotalSeconds >  5) // 5 seconds for 120 frames per seconds in void expanse.
            {
                ...
                {
                    Program.MessageBox((IntPtr)0, "counter over", "sc core systems message", 0);
        ...
        static void recEngine_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            //Program.MessageBox((IntPtr)0,"test","sccoresystems",0);
            ...
            switch (e.Result.Text.ToLower())
            {
                ...
                case "play":
                    ...
                    case "select": // pick
                        ...
                        //SC_Console.WriteAt(functionCounter00 + "", 0, 14, false);
                        //Console.WriteLine(lastWord);
                        //Program.MessageBox((IntPtr)0, "select", "sccs message", 0);
                        //totalCombination += lastWord;
                        functionCounter03++;
                        counterTotalWords++;
                        frameCounterForVoiceRecognitionRecognizedWords++;
                    ...
                    case "backward": // pick
                        ...
                        //SC_Console.WriteAt(functionCounter00 + "", 0, 14, false);
                        //Console.WriteLine(lastWord);
                        //Program.MessageBox((IntPtr)0, "backward", "sccs message", 0);
                        //totalCombination += lastWord;
                        functionCounter03++;
                        counterTotalWords++;
                        frameCounterForVoiceRecognitionRecognizedWords++;
