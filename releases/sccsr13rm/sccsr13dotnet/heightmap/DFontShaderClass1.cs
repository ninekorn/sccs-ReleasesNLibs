    ...
    public class DFontShader                    // 275 lines
    {
        ...
        private bool InitializeShader(SharpDX.Direct3D11.Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                vsFileName = "../../../sc not-instanced shader/" + "font.vs";
                psFileName = "../../../sc not-instanced shader/" + "font.ps";

                // Setup full paths
                //vsFileName = MainWindow.config.FontFilePath + vsFileName;
                //psFileName = MainWindow.config.FontFilePath + psFileName;
                //vsFileName = SCCoreSystems.Properties.Resources.font1;// "../../../_sc_instance_shader/" + "texture.vs";
                //psFileName = SCCoreSystems.Properties.Resources.font;// "../../../_sc_instance_shader/" + "texture.ps";
            ...
            catch (Exception ex)
            {
                ...
                Program.MessageBox((IntPtr)0, "Error initializing shader. Error is " + ex.Message, "sccs error message", 0);
                return false;
            };
        }
