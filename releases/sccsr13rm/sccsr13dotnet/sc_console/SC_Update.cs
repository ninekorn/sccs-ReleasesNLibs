            ...
            try
            {
                ...
                */
                ...
                else if (Program.usethirdpersonview == 1)
                {
                    ...
                    viewPosition = viewPosition + (dirikvoxelbodyInstanceForward0 * Program.offsetthirdpersonview);
                }
                ...
                for (int eyeIndex = 0; eyeIndex < 2; eyeIndex++)
                {
                    ...
                    else if (Program.usethirdpersonview == 1)
                    {
                        ...
                        var dirikvoxelbodyInstanceUp0 = sc_maths._newgetdirup(somedirquat1);
                        var dirikvoxelbodyInstanceForward0 = sc_maths._newgetdirforward(somedirquat1);
                        viewPosition = somepostrialanderrortestingsuccessbystevechassé + (dirikvoxelbodyInstanceForward0 * Program.offsetthirdpersonview);
                    }
                    //FIRST/THIRD PERSON VR VIEW. COMMENT THIS PART OUT TO HAVE FIRST PERSON VIEW 
