...
namespace SCCoreSystems.sc_console
{
    ...
    public class sc_console_writer
    {
        ...
        static _messager[] _message_to_pass = new _messager[Program.MaxSizeMessageObject];
        ...
        public sc_console_writer(SCCoreSystems.scmessageobject.scmessageobject[] tester)// : base(tester)
        {
