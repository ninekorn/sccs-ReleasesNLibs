            ...
            */
            ...
            try
            {
                mainthreadupdate = new Thread(() =>
                {
                    ...
                    {
                        jitter_sc = new jitter_sc[Program._physics_engine_instance_x * Program._physics_engine_instance_y * Program._physics_engine_instance_z];
                        sccsjittertasks = new scmessageobjectjitter[Program._physics_engine_instance_x * Program._physics_engine_instance_y * Program._physics_engine_instance_z][];
                        ...
                        for (int xx = 0; xx < Program._physics_engine_instance_x; xx++)
                        {
                            for (int yy = 0; yy < Program._physics_engine_instance_y; yy++)
                            {
                                for (int zz = 0; zz < Program._physics_engine_instance_z; zz++)
                                {
                                    ...
                                    sccsjittertasks[indexer00] = new scmessageobjectjitter[Program.world_width * Program.world_height * Program.world_depth];
                        ...
                        sccsjittertasks = init_update_variables(sccsjittertasks, Program.config, Program.consoleHandle, Program.SC_GLOBALS_ACCESSORS.SC_CONSOLE_WRITER);
                    }
                ...
                _thread_looper:
                    ...
                    try
                    {
                        ...
                        /*if (Program.useArduinoOVRTouchKeymapper == -2)
                        {
                            if (serialPort != null)
                            {
