...
namespace SCCoreSystems
{
    public class SC_instancedChunk_shader_final
    {
        ...
        //SC_instancedChunk.DVertex[] indexArray;
        ...
        public SC_instancedChunk_shader_final(SharpDX.Direct3D11.Device _device, SharpDX.Direct3D11.Buffer _constantBuffer, InputLayout _Layout, VertexShader _VertexShader, PixelShader _PixelShader, GeometryShader GeometryShader_, int usegeometryshader_)
        {
            ...
            this.GeometryShader = GeometryShader_;
       ...
       public ShaderResourceView shaderResourceView2D;
            ...
            device.ImmediateContext.InputAssembler.SetVertexBuffers(3, new[]
        {
            ...
            */
            ...
            {
                device.ImmediateContext.GeometryShader.Set(GeometryShader); //GeometryShader
            }
            ...
            //numberOfInstancesPerObjectInWidth* numberOfInstancesPerObjectInHeight *numberOfInstancesPerObjectInDepth
