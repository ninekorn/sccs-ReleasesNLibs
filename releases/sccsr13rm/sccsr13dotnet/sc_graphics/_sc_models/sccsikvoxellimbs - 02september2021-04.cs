...
namespace SCCoreSystems.SC_Graphics
{
    public class sccsikvoxellimbs
    {
        ...
        public scmessageobjectjitter[][] createikbody(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, Matrix worldmatofobj_, int somechunkpriminstanceikarmvoxelindex_, int humaninstupperrigx_, int humaninstupperrigy_, int humaninstupperrigz_)
        {
            ...
            _tempMatroxer.M41 = 0;
            _tempMatroxer.M42 = -0.485f + initchunkposition.Y; // 0
            _tempMatroxer.M43 = 0;
            _tempMatroxer.M44 = 1;
            ...
            _tempMatroxer.M42 = -0.15f + initchunkposition.Y; // -0.1f ///0;//
            _tempMatroxer.M43 = 0;
            _tempMatroxer.M44 = 1;
            ...
            _tempMatroxer = WorldMatrix;
            _tempMatroxer.M41 = 0;
            _tempMatroxer.M42 = 0.45f + initchunkposition.Y; // -0.1f 0;//
            _tempMatroxer.M43 = 0;
            _tempMatroxer.M44 = 1;
            offsetPosX = _dist_between * 2;
            offsetPosY = _dist_between * 2;
        ...
        public scmessageobjectjitter[][] setikbodytargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, Matrix hmd_matrix_current, Matrix extramatrix, Matrix hmdmatrixcurrentforpelvis)
        {
            ...
            for (int _iterator = 0; _iterator < _player_torso[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                /*MOVINGPOINTER = new Vector3(_player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42 - (heightOftorso * 0.5f), _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                ...
                */
                ...
                var torsooripos = new Vector3(_player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_torso[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43); ;
                _rotMatrixer = _player_torso[0][0]._arrayOfInstances[_iterator].current_pos;
                Quaternion.RotationMatrix(ref _rotMatrixer, out forTest);
                ...
                //tempPoint = tempPoint + -(direction_feet_right_ori * (diffNormPosX));
                ...
                /*
                var oriposhead = new Vector3(_player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);

                //var realPosOfHead = TORSOPIVOT + (dirToPoint * ((_player_torso[0][0]._total_torso_height + (_player_head[0][0]._total_torso_height * 4))));
                var realPosOfHead = oriposhead + (dirToPoint * ((_player_torso[0][0]._total_torso_height + (_player_head[0][0]._total_torso_height * 4))));




                var pivotOfHead = oriposhead + (dirToPoint * ((_player_torso[0][0]._total_torso_height)));
                */
                ...
                matrixerer = finalRotationMatrix;// theheadrotmatrix;


                /*pivotOfHead = new Vector3(_player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42 - (heightOftorso * 2), _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                //MOVINGPOINTER = new Vector3(_player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42 - (-direction_feet_up_torso.Y * (heightOftorso * 0.5f)) - (-direction_feet_up_torso.Y * (heightofhead * 0.5f)), _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                //- (heightofhead * 0.5f) - (heightOftorso * 0.5f)
                ...
                pivotOfHead = pivotOfHead + (direction_feet_up_torso * (heightofhead));
                pivotOfHead = pivotOfHead + (direction_feet_up_torso * (heightOftorso));
                */
                ...
                if (Program.usethirdpersonview == 0)
                {
                    ...
                    realPosOfHead = pivotOfHead;// tempOffset;
                ...
                */
                ...
                // - (-direction_feet_up_torso.Y * (heightofhead * 0.5f)) - (-direction_feet_up_torso.Y * (heightofpelvis * 0.5f))
                ...
                // - (heightOftorso * 2) - (heightofpelvis * 2)
