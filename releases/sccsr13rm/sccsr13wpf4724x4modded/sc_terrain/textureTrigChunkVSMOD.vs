...
//row_major matrix instancePosition : WORLD;
struct PixelInputType
{ 
	float4 position : SV_POSITION;
	float4 indexPos : POSITION1;
...
PixelInputType TextureVertexShader(VertexInputType input)
{
	...
	//input.position.x += input.one;
	//input.position.y += input.two;
	...
	//mod_input_vertex_pos.x += MOVINGPOINT.x;
	//mod_input_vertex_pos.y += MOVINGPOINT.y;
	//mod_input_vertex_pos.z += MOVINGPOINT.z;
	...
	//output.color.r == 1.0 && output.color.g == 1.0  && output.color.b == 1.0  && output.color.a == 1.0)//||

	/*if(output.color.r == 0 && output.color.g == 0 && output.color.b == 0 && output.color.a == 0)
	{   
		//input.position.x += 100;//input.instancePosition.x;
		//input.position.y += 100;//input.instancePosition.y;
		//input.position.z += 100;//input.instancePosition.z;
