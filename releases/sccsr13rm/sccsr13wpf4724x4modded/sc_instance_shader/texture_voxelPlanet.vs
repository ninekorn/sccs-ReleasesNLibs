...
PixelInputType TextureVertexShader(VertexInputType input)
{
	...
	float xx = x;
	float3 color = lerp(float3(input.color.x*0.85*xx, input.color.y*0.85*xx, input.color.z*0.85*xx), float3(input.color.x*0.95*xx, input.color.y*0.95*xx, input.color.z*0.95*xx), x);
