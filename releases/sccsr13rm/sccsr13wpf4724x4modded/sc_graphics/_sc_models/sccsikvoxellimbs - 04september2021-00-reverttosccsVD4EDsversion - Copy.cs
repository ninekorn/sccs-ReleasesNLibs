...
namespace SCCoreSystems.SC_Graphics
{
    public class sccsikvoxellimbs
    {
        ...
        public scmessageobjectjitter[][] createikarm(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxellimbsindex_, int humaninstlimbsx_, int humaninstlimbsy_, int humaninstlimbsz_)
        {
            ...
            tempmatrix.M42 = 0  + parentobject.initchunkposition.Y;// parentobject.initchunkposition.Y + ikarmpivotinitposition.Y;
            tempmatrix.M43 = 0;
            tempmatrix.M44 = 1;
            float offsetPosX = _dist_between * 2;
            float offsetPosY = _dist_between * 2;
                ...
                */
                ...
                else if (somechunkpriminstanceikarmvoxellimbsindex == 3)
                {
                    ...
                    */
                    ...
                    //Program.MessageBox((IntPtr)0, "TESt", "sc core systems message", 0);
                    //var movingpoint = new Vector3(parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION.M41, parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION.M42, parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION.M43);




                    /*//var movingpoint = new Vector3(parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION.M41, parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION.M42, parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION.M43);
                    var movingpoint = new Vector3(0,0,0);
                    ...
                    worldMatrix_instances_r_shoulder[0][0][i] = tempmatrix1;// parentobject_._player_head[0][0]._arrayOfInstances[i]._ORIGINPOSITION;
                    _player_rght_shldr[0][0]._arrayOfInstances[i].current_pos = tempmatrix1;
                    */
                    ...
                    tempmatrix1.M41 = 0;// movingpoint.X;
                    tempmatrix1.M42 = 2;//movingpoint.Y;
                    tempmatrix1.M43 = 0;//movingpoint.Z;
