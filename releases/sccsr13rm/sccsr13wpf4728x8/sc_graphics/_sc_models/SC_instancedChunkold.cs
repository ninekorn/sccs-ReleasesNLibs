...
namespace SCCoreSystems
{
    public class SC_instancedChunk
    {
        ...
        public SC_instancedChunk(float xxi, float yyi, float zzi, Vector4 color, int width, int height, int depth, Vector3 pos, Matrix _maininstancematrix)
        {
