...
PixelInputType TextureVertexShader(VertexInputType input)
{
	...
	/*if(textureColor.r == 0 && textureColor.g == 0 && textureColor.b == 0 && textureColor.a == 0 ||
	   textureColor.r == 1.0 && textureColor.g == 1.0  && textureColor.b == 1.0  && textureColor.a == 1.0)
	{
	...
	/*if(output.color.r == 1.0 && output.color.g == 1.0  && output.color.b == 1.0  && output.color.a == 1.0)
	{   
