...
{ 
	...
	if(someOtherIndex == 0 || someOtherIndex == 1)
	{
		if(someOtherIndex == 0)
		{
			...
			//theByte = round((((currentMapData * 0.1) - round(currentMapData * 0.1)) * 10)); // 51 * 0.1 = 5.1 floor = 5 * 10 = 50 => 51 - 50 = 1		

			//float someremains = floor(currentMapData * 0.1) * 10;
			//theByte = round(currentMapData - (floor(currentMapData * 0.1) * 10));

			//somemap = (somemap * 0.1);

			//theByte = floor((somemap - (int(somemap)))  * 10);
			...
			//arrayOfDigits[0] = somevalue;

			//511111111 * 0.1 = 51111111.1 - 51111111.0 = 0.1 * 10 = 1
			//5111111100
			//5111111110

			//float someval0 = somemap * 10; //511111111 * 10 => 5111111110
			//float someval1 = ((int(somemap * 0.1) * 100)); //511111111 *0.1 => 51111111.1 rounded == 51111111.0 * 10 = 511111110 * 10 == 5111111100
			//somemap = round(((somemap * 10) - ((floor(somemap * 0.1) * 100))) * 0.1);

			//float someval = somemap + 1;
			//theByte = somemap - someval;
			...
			int somemap0 = int(currentMapData / 10);
			...
			if(int(currentMapData / 10) == test00)
			{
				arrayOfDigits[0] = 1.0;
			}
			else
			...
			//511111111.0 / 10 = 51111111.1
			//round(511111111.0 / 10) = 51111111.0

			
			//float test3 = somemap * 0.1;

			//not working
			//if(round((float)(int)(((somemap*0.1) - int(currentMapData *0.1)))*10) == 1.0)

			/*
			test0 = (test0 * 0.1);
			if((((float)((test0 - (int)test0) * 10))) > 0.0)
			{
				arrayOfDigits[0] = 1.0;
			}
			else
			...
			//printf("%.1^3f", float4(1,0,0,1));

			/*if(somemap + 1 == 511111112)
			{
				arrayOfDigits[0] = 1.0;
			}
			else
		...
		else if(someOtherIndex == 1)
		{
			...
			float someremains = floor(currentMapData * 0.1) * 10;
			//theByte = round(currentMapData - (floor(currentMapData * 0.1) * 10));
			theByte = round((currentMapData * 0.1) - (floor(currentMapData * 0.1)) * 10);
