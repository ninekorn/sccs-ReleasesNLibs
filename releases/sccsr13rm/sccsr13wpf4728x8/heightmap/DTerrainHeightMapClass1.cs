...
namespace SCCoreSystems//DSharpDXRastertek.TutTerr02.Graphics.Models
{
    public class DTerrainHeightMap // 273 lines
    {
        ...
        // Variables
        public int m_TerrainWidth, m_TerrainHeight;
        ...
        private bool reinitbuffertemp(SharpDX.Direct3D11.Device device)
        {
            try
            {
                return true;
        ...
        private bool LoadHeightMap(string heightMapFileName)
        {
            ...
            try
            {
                ...
                bitmap = new Bitmap(heightMapFileName);// @"heightmap\heightmap01.bmp"); //MainWindow.config.DataFilePath +  //heightMapFileName
        ...
        public bool InitializeBuffers(SharpDX.Direct3D11.Device device)
        {
            try
            {
