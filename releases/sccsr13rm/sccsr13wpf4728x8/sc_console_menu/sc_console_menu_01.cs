...
namespace SCCoreSystems.sc_console_menu
{
    ...
    {
        static SCCoreSystems.scmessageobject.scmessageobject _someReceivedObject0 = new SCCoreSystems.scmessageobject.scmessageobject();
        static SCCoreSystems.scmessageobject.scmessageobject _data00_IN;
        static SCCoreSystems.scmessageobject.scmessageobject _toReturnObject;

        public static SCCoreSystems.scmessageobject.scmessageobject _console_menu(object _main_object)
        {
            try
            {
                _data00_IN = (SCCoreSystems.scmessageobject.scmessageobject)_main_object;
