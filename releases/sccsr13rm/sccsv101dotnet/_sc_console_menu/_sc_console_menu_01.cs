...
namespace _sc_core_systems._sc_console_menu
{
    ...
    {
        static sc_message_object.sc_message_object _someReceivedObject0 = new sc_message_object.sc_message_object();
        static sc_message_object.sc_message_object _data00_IN;
        static sc_message_object.sc_message_object _toReturnObject;

        public static sc_message_object.sc_message_object _console_menu(object _main_object)
        {
            try
            {
                _data00_IN = (sc_message_object.sc_message_object)_main_object;
