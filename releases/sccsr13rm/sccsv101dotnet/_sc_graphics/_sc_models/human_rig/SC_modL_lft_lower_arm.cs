...
{
    public class SC_modL_lft_lower_arm : ITransform, IComponent
    {
        ...
        public SC_sdr_lower_left_arm _this_object_texture_shader { get; set; }
        ...
        /*public bool _initTexture(SharpDX.Direct3D11.Device device, IntPtr windowsHandle)
        {
            ...
            _this_object_texture_shader = new SC_sdr_lower_left_arm();
