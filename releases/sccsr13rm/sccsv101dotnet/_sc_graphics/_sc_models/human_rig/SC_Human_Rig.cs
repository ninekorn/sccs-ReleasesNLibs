...
namespace _sc_core_systems.SC_Graphics.SC_Models.human_rig
{
    public class SC_human_RIG
    {
        ...
        public SC_human_RIG(SC_console_directx D3D, IntPtr HWND, World World, Matrix WorldMatrix, float size_screen, float r, float g, float b, float a, int _physics_engine_instance_x, int _physics_engine_instance_y, int _physics_engine_instance_z, float offsetPosX, float offsetPosY, float offsetPosZ, float mass)
        {
            _mass = mass;
            worldMatrix_base = new Matrix[1];
            worldMatrix_base[0] = Matrix.Identity;

            _player_right_hnd = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_lft_upper_arm = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_left_hnd = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_torso = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_pelvis = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_right_shldr = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_lft_shldr = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_head = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_rght_lower_arm = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_lft_lower_arm = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_rght_upper_arm = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_rght_elbow_target = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_lft_elbow_target = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_rght_elbow_target_two = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
            _player_lft_elbow_target_two = new SC_cube[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
        ...
        public void SC_human_RIG_create(SC_console_directx D3D, IntPtr HWND, World World, Matrix WorldMatrix, float size_screen, float r, float g, float b, float a, float offsetPosX, float offsetPosY, float offsetPosZ, int _index)
        {
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_torso[_index] = new SC_cube();
            ...
            _hasinit0 = _player_torso[_index].Initialize(D3D, D3D.SurfaceWidth, D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), _inst_p_torso_x, _inst_p_torso_y, _inst_p_torso_z, _HWND, _tempMatroxer, 2, offsetPosX, offsetPosY, offsetPosZ, World, SC_console_directx.BodyTag.PlayerTorso, _static, 1, _mass); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_pelvis[_index] = new SC_cube();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_right_shldr[_index] = new SC_cube();
            ...
            _player_lft_shldr[_index] = new SC_cube();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_head[_index] = new SC_cube();
            ...
            _player_rght_lower_arm[_index] = new SC_cube();
            ...
            _player_lft_lower_arm[_index] = new SC_cube();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_rght_upper_arm[_index] = new SC_cube();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_lft_upper_arm[_index] = new SC_cube();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_rght_elbow_target[_index] = new SC_cube();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_lft_elbow_target[_index] = new SC_cube();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_rght_elbow_target_two[_index] = new SC_cube();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_lft_elbow_target_two[_index] = new SC_cube();
        ...
        public void update_human_rig(Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Matrix viewMatrix, Matrix _projectionMatrix, Vector3 oculusRiftDir, Matrix rotatingMatrix, Vector3 OFFSETPOS, Matrix rotatingMatrixForPelvis, out Matrix _handPositionLeft, out Matrix _handPositionRight, int _index)
        {
            ...
            try
            {
                ...
                _cuber_00 = _player_right_hnd[_index];
                _cuber_00.Render(_D3D.device.ImmediateContext);
                SC_Console_GRAPHICS._shaderManager._rend_torso(_D3D.device.ImmediateContext, _cuber_00.IndexCount, _cuber_00.InstanceCount, _cuber_00._POSITION, viewMatrix, _projectionMatrix, null, _SC_modL_torso_BUFFER, oculusRiftDir, _cuber_00);
                ...
                var currentDirShoulderLeftToHandLeft = currentPositionOfLeftHand - new Vector3(_player_lft_shldr[_index]._POSITION.M41, _player_lft_shldr[_index]._POSITION.M42, _player_lft_shldr[_index]._POSITION.M43);

                if (currentDirShoulderLeftToHandLeft.Length() > totalArmLengthLeft)
                {
                    currentDirShoulderLeftToHandLeft.Normalize();
                    currentPositionOfLeftHand = new Vector3(_player_lft_shldr[_index]._POSITION.M41, _player_lft_shldr[_index]._POSITION.M42, _player_lft_shldr[_index]._POSITION.M43) + (currentDirShoulderLeftToHandLeft * totalArmLengthLeft);
                }
                ...
                somePosOfRightHand = new Vector3(_player_lft_shldr[_index]._POSITION.M41, _player_lft_shldr[_index]._POSITION.M42, _player_lft_shldr[_index]._POSITION.M43);
                ...
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_up * ((float)hyp));
                MOVINGPOINTER.X += OFFSETPOS.X;// + _player_lft_elbow_target[_index]_two._ORIGINPOSITION.M41;
                MOVINGPOINTER.Y += OFFSETPOS.Y;// + _player_lft_elbow_target[_index]_two._ORIGINPOSITION.M42;// + _player_lft_elbow_target[_index]_two._ORIGINPOSITION.M42;
                MOVINGPOINTER.Z += OFFSETPOS.Z;// + _player_lft_elbow_target[_index]_two._ORIGINPOSITION.M43;
                ...
                //_player_lft_elbow_target[_index]_two.Render(_D3D.device.ImmediateContext);
                //_player_lft_elbow_target[_index]_two.RenderInstancedObject(_D3D.device.ImmediateContext, _player_lft_elbow_target[_index]_two.IndexCount, _player_lft_elbow_target[_index]_two.InstanceCount, _player_lft_elbow_target[_index]_two._POSITION, viewMatrix, _projectionMatrix, null, worldMatrix_Terrain_instances, _SC_modL_lft_elbow_target_two_BUFFER, oculusRiftDir);
                //_player_lft_elbow_target[_index]_two._singleObjectOnly.transform.Component.rigidbody.Position = new JVector(_player_lft_elbow_target[_index]_two._POSITION.M41, _player_lft_elbow_target[_index]_two._POSITION.M42, _player_lft_elbow_target[_index]_two._POSITION.M43);
                //ELBOW TARGET LEFT TWO
                //////////////////////////
                ...
                //Vector3 somePosOfRightShoulder = new Vector3(_player_lft_shldr[_index]._POSITION.M41, _player_lft_shldr[_index]._POSITION.M42, _player_lft_shldr[_index]._POSITION.M43);
                var somePosOfLeftHand = new Vector3(_player_left_hnd[_index]._POSITION.M41, _player_left_hnd[_index]._POSITION.M42, _player_left_hnd[_index]._POSITION.M43);
                ...
                lengthOfLowerArmLeft = _player_lft_lower_arm[_index]._total_torso_height * 2.55f;
                lengthOfUpperArmLeft = _player_lft_upper_arm[_index]._total_torso_height * 2.45f;
        ...
        public void _update_human_rig_physics(Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Vector3 OFFSETPOS, int _index)
        {
            /*for (int x = 0; x < SC_Console_GRAPHICS._physics_engine_instance_x; x++)
            {
                for (int y = 0; y < SC_Console_GRAPHICS._physics_engine_instance_y; y++)
                {
                    for (int z = 0; z < SC_Console_GRAPHICS._physics_engine_instance_z; z++)
                    {
                ...
                if (_World.RigidBodies.Count > 0)
                {
                    ...
                    foreach (RigidBody rigidbody in _World.RigidBodies)
                    {
                        ...
                        if ((SC_console_directx.BodyTag)body.Tag == SC_console_directx.BodyTag.PlayerHandRight)
                        {
                            ...
                            // _player_right_hnd[_index]._singleObjectOnly.transform.Component.rigidbody.LinearVelocity = JVector.Zero;
                            // _player_right_hnd[_index]._singleObjectOnly.transform.Component.rigidbody.AngularVelocity = JVector.Zero;
                            //_player_right_hnd._POSITION = _tempMatrix;
                            //_player_right_hnd._singleObjectOnly._POSITION = _tempMatrix;
                            //_player_right_hnd[_index]._singleObjectOnly._LASTPOSITION = _tempMatrix;
                        }
                        else if ((SC_console_directx.BodyTag)body.Tag == SC_console_directx.BodyTag.PlayerHandLeft)
                        {
                            ...
                            //_player_left_hnd[_index]._singleObjectOnly.transform.Component.rigidbody.LinearVelocity = JVector.Zero;
                            //_player_left_hnd[_index]._singleObjectOnly.transform.Component.rigidbody.AngularVelocity = JVector.Zero;
                            //_player_left_hnd._POSITION = _tempMatrix;
                            //_player_left_hnd._singleObjectOnly._POSITION = _tempMatrix;
                            //_player_left_hnd[_index]._singleObjectOnly._LASTPOSITION = _tempMatrix;
                        }
