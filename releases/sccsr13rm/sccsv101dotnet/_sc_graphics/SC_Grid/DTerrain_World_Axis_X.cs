...
namespace SCCoreSystems
{
    public class DTerrain_World_Axis_X                   // 179 lines
    {
        ...
        // Methods.
        public bool Initialize(SCCoreSystems.SC_console_directx D3D, int width, int height, float size_screen, int divX, int divY,float a, float r, float g, float b)
        {
        ...
        private bool InitializeBuffers(SCCoreSystems.SC_console_directx D3D)
        {
            try
            {
