            ...
            try
            {
                ...
                if (_start_background_worker_01 == 0)
                {
                    if (_can_work_physics == 1)
                    {
                        ...
                        Program.MessageBox((IntPtr)0, "" + "created thread for jitter physics buffer to rigidbody positions and rotations", "sccoresystems", 0);
                ...
                if (_can_work_physics == 1)
                {
                    if (startworkbuffers == 0)
                    {
                        ...
                        Thread main_thread_update = new Thread(() =>
                        {
                            ...
                            //Program.MessageBox((IntPtr)0, "" + "starting buffer work", "sccoresystems", 0);
