...
{
    public class _sc_sphere_shader_final                 // 228 lines
    {
        ...
        public _sc_sphere_shader_final() 
        {
        ...
        public _sc_core_systems.SC_Graphics._sc_sphere.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, _sc_core_systems.SC_Graphics._sc_sphere.DLightBuffer[] DLightBuffer)
        {
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, _sc_sphere.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, _sc_sphere _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, _sc_sphere.DLightBuffer[] _DLightBuffer_, _sc_sphere _cuber)
        {
