...
var AIPathFindUtilities =
{
    ...
    getGridWorldPosition: function (initialPos, seekerPos, gridWorldSize)  //yep still fail. yep. yeah... godamnit.
    {
        ...
        var testY00 = diffY - gridWorldSize.yB - (flooredRemainsDivY * (gridWorldSize.yB + gridWorldSize.yT + 1));
        var testY01 = diffY - gridWorldSize.yT - (flooredRemainsDivY * (gridWorldSize.yB + gridWorldSize.yT + 1));
    ...
    getNewGridIndex: function (initialPos, seekerPos, gridWorldSize) {
        var gridData = AIPathFindUtilities.getGridWorldPosition(initialPos, seekerPos, gridWorldSize);
