...
{
    public class sc_pathfind
    {

        public struct gridWorldSize
        {
            float _size_x_left;
            float _size_x_right;
            float _size_y_left;
        ...
        void npcPathFind(gridWorldSize gridWorldSize, cData ) // cData.objt.sid for generator.AddContainer when testing
        {
            var someExtratiles = [];
