...
namespace _sc_core_systems.SC_Graphics
{
    public class SC_sdr_lft_hnd                 // 228 lines
    {
        ...
        _sc_core_systems.SC_Graphics.SC_modL_lft_hnd.DInstanceData[] instancesDataRIGHT;// = new SC_modL_lft_hnd.DInstanceData[];
        _sc_core_systems.SC_Graphics.SC_modL_lft_hnd.DInstanceData[] instancesDataUP;

        int _initDirectionsArray = 1;

        public bool Render(DeviceContext deviceContext, int vertexCount, int instanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture,_sc_core_systems.SC_Graphics.SC_modL_lft_hnd.DInstanceType[] instances, _sc_core_systems.SC_Graphics.SC_modL_lft_hnd.DInstanceData[] instancesData, _sc_core_systems.SC_Graphics.SC_modL_lft_hnd.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, int _instX, int _instY, int _instZ, _sc_core_systems.SC_Graphics.SC_cube.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
