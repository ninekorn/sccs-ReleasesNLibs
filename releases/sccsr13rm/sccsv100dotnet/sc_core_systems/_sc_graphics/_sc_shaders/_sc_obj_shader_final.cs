...
{
    public class _sc_obj_shader_final                 // 228 lines
    {
        ...
        public _sc_core_systems.SC_Graphics._sc_obj.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, _sc_core_systems.SC_Graphics._sc_obj.DLightBuffer[] DLightBuffer)
        {
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, _sc_obj.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, _sc_obj _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, _sc_obj.DLightBuffer[] _DLightBuffer_, _sc_obj _cuber)
        {
