...
{
    public class SC_modL_rght_elbow_target_two : ITransform, IComponent
    {
        ...
        public SC_sdr_rght_elbow_target_two _this_object_texture_shader { get; set; }
        ...
        //int _isTerrain;
        // Constructor
        public SC_modL_rght_elbow_target_two() { }
       ...
       /* public bool _initTexture(SharpDX.Direct3D11.Device device, IntPtr windowsHandle)
        {
            ...
            _this_object_texture_shader = new SC_sdr_rght_elbow_target_two();
