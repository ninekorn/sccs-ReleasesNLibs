...
{
    public class SC_modL_lft_lower_leg : ITransform, IComponent
    {
        ...
        public SC_sdr_lower_left_leg _this_object_texture_shader { get; set; }


        //int _isTerrain;
        // Constructor
        public SC_modL_lft_lower_leg() { }
        ...
        /*public bool _initTexture(SharpDX.Direct3D11.Device device, IntPtr windowsHandle)
        {
            ...
            _this_object_texture_shader = new SC_sdr_lower_left_leg();
