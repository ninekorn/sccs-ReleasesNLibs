...
{
    public class SC_modL_lft_shldr : ITransform, IComponent
    {
        ...
        public SC_sdr_lft_shldr _this_object_texture_shader { get; set; }
        ...
        /*public bool _initTexture(SharpDX.Direct3D11.Device device, IntPtr windowsHandle)
        {
            ...
            _this_object_texture_shader = new SC_sdr_lft_shldr();
