...
namespace _sc_core_systems
{
    ...
    {
        private static sc_perko_voxel sc_perko_voxeler;
        ...
        int randX = 3420;
        int randY = 3420;
        public static int countingArrayOfsc_perko_voxels = 0;
        ...
        //byte
        public void startBuildingArray(Vector3 currentPosition,
                                 out SC_cube.DVertex[] vertexArray,
                                 out int[] triangleArray,
                                 float _planeSize,
                                 int _sc_perko_voxelWidth_L,
                                 int _sc_perko_voxelWidth_R,
                                 int _sc_perko_voxelHeight_L,
                                 int _sc_perko_voxelHeight_R,
                                 int _sc_perko_voxelDepth_L,
                                 int _sc_perko_voxelDepth_R)
        {



            width_left = _sc_perko_voxelWidth_L;
            height_left = _sc_perko_voxelHeight_L;
            depth_left = _sc_perko_voxelDepth_L;
            width_right = _sc_perko_voxelWidth_R;
            height_right = _sc_perko_voxelHeight_R;
            depth_right = _sc_perko_voxelDepth_R;
            ...
            var Vertices = new SC_cube.DVertex[positions.Count];

            for (int v = 0; v < positions.Count; v++)
            {
                Vertices[v] = new SC_cube.DVertex
                {
                    position = positions[v],
                    texture = textureCoordinates[v],
                    color = new Vector4(0.15f, 0.15f, 0.15f,1),
                    normal = normals[v],
                };
            }
            vertexArray = Vertices;
            triangleArray = triangleIndices.ToArray();
        }
            ...
            for (int x = -width_left; x <= width_right; x++)
            {
                for (int y = -height_left; y <= height_right; y++)
                {
                    for (int z = -depth_left; z <= depth_right; z++)
                    {
                        ...
                        if (block == 0) continue;
                        {
                            DrawBrick(x, y, z, currentPosition,xx,yy,zz);
                        }
                    }
                }
            }
        ...
        //sc_perko_voxelPosBig sc_perko_voxelbig;

        public void DrawBrick(int x, int y, int z, Vector3 currentPosition,int xx,int yy, int zz)
        {

            Vector3 start = new Vector3(xx * planeSize, yy* planeSize, zz * planeSize);
        ...
        /*public bigsc_perko_voxel getBigsc_perko_voxel(float xi, float yi, float zi)
        {
            int x = (int)xi;
            int y = (int)yi;
            int z = (int)zi;
            ...
            return bigFuckingsc_perko_voxel[x, y, z];
        }*/
    }
}
