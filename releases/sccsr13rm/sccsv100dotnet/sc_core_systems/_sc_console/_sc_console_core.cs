...
namespace _sc_core_systems._sc_console
{
    public class _sc_console_core : _sc_icomponent
    {
        ...
        public _sc_console_core(_sc_core_systems._sc_message_object._sc_message_object[] tester)
        {
        ...
        public void _createConsole(_sc_core_systems._sc_message_object._sc_message_object[] tester)
        {
