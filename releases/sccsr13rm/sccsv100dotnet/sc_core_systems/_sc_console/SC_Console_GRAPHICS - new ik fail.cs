                        ...
                        for (int y = 0; y < _physics_engine_instance_y; y++)
                        {
                            for (int z = 0; z < _physics_engine_instance_z; z++)
                            {
                                ...
                                for (int _iterator = 0; _iterator < _player_rght_hnd[_index]._arrayOfInstances.Length; _iterator++) //
                                {
                                    ...
                                    Vector3 tempvec = new Vector3(_player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos.M41, _player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos.M42, _player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos.M43);


                                    Matrix tempmatter = _player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos;
                                    Quaternion.RotationMatrix(ref tempmatter, out otherQuat);
                                    var dir_forward_shld_r = _getDirection(Vector3.ForwardRH, otherQuat);
                                    var dir_right_shld_r = _getDirection(Vector3.Right, otherQuat);
                                    var dir_up_shld_r = _getDirection(Vector3.Up, otherQuat);




                                    realPIVOTOfUpperArm = tempvec + (dir_forward_shld_r * (_player_rght_upper_arm[_index]._total_torso_height * 0.5f));
                                    //realPIVOTOfUpperArm = realPIVOTOfUpperArm + -(dir_forward_shld_r * (_player_rght_shldr[_index]._total_torso_height * 0.5f));
                                    //realPIVOTOfUpperArm = realPIVOTOfUpperArm + -(direction_feet_up * (diffNormPosY));
                                    //realPIVOTOfUpperArm = realPIVOTOfUpperArm + -(direction_feet_forward * (diffNormPosZ));


                                    var currentPositionOfUPPERARMROTATION3DPOSITION = realPIVOTOfUpperArm;
                                    ...
                                    /*var dirPivotUpperRIghtToElbowRight
                                    ...
                                    shoulderRotationMatrixRight = Matrix.LookAtRH(currentPositionOfUPPERARMROTATION3DPOSITION, currentPositionOfUPPERARMROTATION3DPOSITION + someCross0, dirPivotUpperRIghtToElbowRight);
                                    shoulderRotationMatrixRight.Invert();
                                    matrixerer = shoulderRotationMatrixRight;*/
                                    

                                    //_player_rght_upper_arm[_index]._arrayOfInstances[_iterator]._SHOULDERROT = shoulderRotationMatrixRight;// shoulderRotationMatrixRight;
                                    ...
                                    Vector3 someCross1;
                                    Vector3 someCross0 = _player_rght_upper_arm[_index]._arrayOfInstances[_iterator]._ELBOWCROSSVEC;
                                    ...
                                    var currentFINALPIVOTUPPERARM = realPIVOTOfUpperArm;
                                    ...
                                    somePosOfRightHand = new Vector3(_player_lft_hnd[_index]._arrayOfInstances[_iterator].current_pos.M41, _player_lft_hnd[_index]._arrayOfInstances[_iterator].current_pos.M42, _player_lft_hnd[_index]._arrayOfInstances[_iterator].current_pos.M43);
                                    var somePosOfUpperElbowTargetTwo = new Vector3(_player_lft_elbow_target_two[_index]._arrayOfInstances[_iterator].current_pos.M41, _player_lft_elbow_target_two[_index]._arrayOfInstances[_iterator].current_pos.M42, _player_lft_elbow_target_two[_index]._arrayOfInstances[_iterator].current_pos.M43);
                                    var somePosOfUpperElbowTargetOne = new Vector3(_player_lft_elbow_target[_index]._arrayOfInstances[_iterator].current_pos.M41, _player_lft_elbow_target[_index]._arrayOfInstances[_iterator].current_pos.M42, _player_lft_elbow_target[_index]._arrayOfInstances[_iterator].current_pos.M43);
