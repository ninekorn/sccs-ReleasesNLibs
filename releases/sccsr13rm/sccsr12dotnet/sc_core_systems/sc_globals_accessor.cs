...
namespace SCCoreSystems.sc_core
{
    public class sc_globals_accessor : sc_icomponent, sc_globals
    {
        ...
        public virtual SCCoreSystems.sc_console.sc_console_core SC_CONSOLE_CORE { get; set; }
        public virtual SCCoreSystems.sc_console.sc_console_writer SC_CONSOLE_WRITER { get; set; }
        public virtual SCCoreSystems.sc_console.sc_console_reader SC_CONSOLE_READER { get; set; }
        public virtual SCCoreSystems.sc_core.sc_globals_accessor SC_GLOBALS_ACCESSORS { get; set; }

        public virtual int _Activate_Desktop_Image { get; set; }

        private SCCoreSystems.sc_message_object.sc_message_object testingInit(SCCoreSystems.sc_message_object.sc_message_object _main_object)
        {   
            return _main_object;
        }
        ...
        public sc_globals_accessor(SCCoreSystems.sc_message_object.sc_message_object[] _main_object)
        {
            SC_GLOB = this;
            SC_ICOMPONENT = this;
