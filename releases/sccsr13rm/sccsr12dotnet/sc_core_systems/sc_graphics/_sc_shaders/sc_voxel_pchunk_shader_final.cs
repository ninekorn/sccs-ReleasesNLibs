        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                //Program.MessageBox((IntPtr)0, "" + Environment.CurrentDirectory, "sccsmsg", 0);
                //Program.MessageBox((IntPtr)0, "" + System.IO.Directory.GetCurrentDirectory(), "sccsmsg", 0);
                //Program.MessageBox((IntPtr)0, "" + "../../../sc_instance_shader/", "sccsmsg", 0);


                vsFileName = "../../../sc_instance_shader/" + "texture_voxelPlanet.vs";
                psFileName ="../../../sc_instance_shader/" + "texture_voxelPlanet.ps";
                var gsFileName = "../../../sc_instance_shader/" + "HLSL.gs";
                ...
                vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "TextureVertexShader", "vs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "TexturePixelShader", "ps_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                var geometryShaderByteCode = ShaderBytecode.CompileFromFile(gsFileName, "GS", "gs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
