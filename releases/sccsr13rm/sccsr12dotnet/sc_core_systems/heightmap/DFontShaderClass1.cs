    ...
    public class DFontShader                    // 275 lines
    {
        ...
        private bool InitializeShader(SharpDX.Direct3D11.Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                vsFileName = "../../../sc_instance_shader/" + "font.vs";
                psFileName = "../../../sc_instance_shader/" + "font.ps";
            ...
            catch (Exception ex)
            {
                ...
                Program.MessageBox((IntPtr)0, "Error initializing shader. Error is " + ex.Message, "sccs message", 0);
                return false;
            };
        }
