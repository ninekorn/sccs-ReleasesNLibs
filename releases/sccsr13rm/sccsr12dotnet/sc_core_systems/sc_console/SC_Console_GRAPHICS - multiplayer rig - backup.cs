...
namespace SCCoreSystems
{
    public class SC_Console_GRAPHICS
    {
        ...
        public const int _physics_engine_instance_y = 4; //1
        ...
        float _world_allowed_penetration = 0.0123f; //0.00123f
        ...
        int _inst_cube_y = 4;
        int _inst_cube_z = 4;
        float _cube_size_x = 0.01f; //0.0115f //1.5f
        float _cube_size_y = 0.01f; //0.0115f //1.5f
        float _cube_size_z = 0.01f;
        //END OF
                ...
                for (int x = 0; x < _physics_engine_instance_x; x++)
                {
                    for (int y = 0; y < _physics_engine_instance_y; y++)
                    {
                        for (int z = 0; z < _physics_engine_instance_z; z++)
                        {
                            ...
                            /*_screenDirMatrix[_index][0].M41 = _world_screen_list[_index].Vertices[8].position.X;// + originPosScreen.X;
                            _screenDirMatrix[_index][0].M42 = _world_screen_list[_index].Vertices[8].position.Y;// + originPosScreen.Y;
                            _screenDirMatrix[_index][0].M43 = _world_screen_list[_index].Vertices[8].position.Z;// + originPosScreen.Z;

                            _screenDirMatrix[_index][1].M41 = _world_screen_list[_index].Vertices[9].position.X;// + originPosScreen.X;
                            _screenDirMatrix[_index][1].M42 = _world_screen_list[_index].Vertices[9].position.Y;// + originPosScreen.Y;
                            _screenDirMatrix[_index][1].M43 = _world_screen_list[_index].Vertices[9].position.Z;// + originPosScreen.Z;

                            _screenDirMatrix[_index][2].M41 = _world_screen_list[_index].Vertices[10].position.X;// + originPosScreen.X;
                            _screenDirMatrix[_index][2].M42 = _world_screen_list[_index].Vertices[10].position.Y;// + originPosScreen.Y;
                            _screenDirMatrix[_index][2].M43 = _world_screen_list[_index].Vertices[10].position.Z;// + originPosScreen.Z;

                            _screenDirMatrix[_index][3].M41 = _world_screen_list[_index].Vertices[11].position.X;// + originPosScreen.X;
                            _screenDirMatrix[_index][3].M42 = _world_screen_list[_index].Vertices[11].position.Y;// + originPosScreen.Y;
                            _screenDirMatrix[_index][3].M43 = _world_screen_list[_index].Vertices[11].position.Z;// + originPosScreen.Z;
                            */
                            //16//13//15//17 
                            //8//9//10//11
                            /*
                            ...
                            {
                                _objects_rigid_static_00[_index][i] = null;
                                _objects_static_00[_index][i] = 0;
                                _objects_static_counter_00[_index][i] = 0;

                                _objects_rigid_inactive_00[_index][i] = null;
                                ...
                                _some_last_frame_rigibodies[_index][i] = null;
                            }*/
                            ...
                            _tempMatroxer = _WorldMatrix;
                            _tempMatroxer.M41 = 0.25f + x;
                            _tempMatroxer.M42 = (_player_rght_upper_arm[tempIndex]._POSITION.M42 + (_player_rght_upper_arm[tempIndex]._total_torso_height * 0.5f) + 0.45f) + y;// - 0.25f;
                            ...
                            _tempMatroxer = _WorldMatrix;
                            _tempMatroxer.M41 = -0.25f + x;
                            _tempMatroxer.M42 = (_player_lft_upper_arm[tempIndex]._POSITION.M42 + (_player_lft_upper_arm[tempIndex]._total_torso_height * 0.5f) + 0.45f) + x;// - 0.25f;
                            _tempMatroxer.M43 = -0.25f + z;
                            _tempMatroxer.M44 = 1;
                            offsetPosX = _dist_between * 2;
                            offsetPosY = _dist_between * 2;
                            ...
                            _tempMatroxer.M42 = (_player_rght_upper_arm[tempIndex]._POSITION.M42 + (_player_rght_upper_arm[tempIndex]._total_torso_height * 0.5f) + 1) + x;
                            _tempMatroxer.M43 = 0 + z;
                            _tempMatroxer.M44 = 1;
                            offsetPosX = _dist_between * 2;
                            offsetPosY = _dist_between * 2;
                            ...
                            _tempMatroxer = _WorldMatrix;
                            _tempMatroxer.M41 = -1.5f + x;
                            _tempMatroxer.M42 = (_player_lft_upper_arm[tempIndex]._POSITION.M42 + (_player_lft_upper_arm[tempIndex]._total_torso_height * 0.5f) + 1) + y;
                            _tempMatroxer.M43 = 0 + z;
                            _tempMatroxer.M44 = 1;
                            offsetPosX = _dist_between * 2;
                            offsetPosY = _dist_between * 2;
                                                    ...
                                                    if (body != null && body.Tag != null)
                                                    {
                                                        ...
                                                        else if ((SC_console_directx.BodyTag)body.Tag == SC_console_directx.BodyTag.physicsInstancedCube)
                                                        {
                                                            ...
                                                            if (handTriggerLeft[0] >= 0.001f)
                                                            {
                                                                ...
                                                                var _force = handTriggerLeft[0] * 0.0075f; //0.025f
                                                                var force = new JVector(dirToRightHand.X, dirToRightHand.Y, dirToRightHand.Z) * _force;
                            ...
                            for (int y = 0; y < _physics_engine_instance_y; y++)
                            {
                                for (int z = 0; z < _physics_engine_instance_z; z++)
                                {
                                    ...
                                    for (int _iterator = 0; _iterator < _player_rght_hnd[tempIndex]._arrayOfInstances.Length; _iterator++) //
                                    {
                                        ...
                                        currentDirShoulderRightToHandRight = currentPositionOfRightHand - new Vector3(_player_lft_upper_arm[tempIndex]._arrayOfInstances[_iterator]._UPPERARMPIVOT.X, _player_lft_upper_arm[tempIndex]._arrayOfInstances[_iterator]._UPPERARMPIVOT.Y, _player_lft_upper_arm[tempIndex]._arrayOfInstances[_iterator]._UPPERARMPIVOT.Z);// new Vector3(_player_rght_shldr[tempIndex].current_pos.M41, _player_rght_shldr[tempIndex].current_pos.M42, _player_rght_shldr[tempIndex].current_pos.M43);;// new Vector3(_player_rght_hnd[tempIndex]._arrayOfInstances[_counter_hand_r].current_pos.M41, _player_rght_hnd[tempIndex]._arrayOfInstances[_counter_hand_r].current_pos.M42, _player_rght_hnd[tempIndex]._arrayOfInstances[_counter_hand_r].current_pos.M43);// new Vector3(_player_rght_shldr[tempIndex].current_pos.M41, _player_rght_shldr[tempIndex].current_pos.M42, _player_rght_shldr[tempIndex].current_pos.M43);

                                        if (currentDirShoulderRightToHandRight.Length() > _player_lft_upper_arm[tempIndex]._arrayOfInstances[_iterator]._ARMLENGTH)
                                        {
                                            currentDirShoulderRightToHandRight.Normalize();
                                            currentPositionOfRightHand = new Vector3(_player_lft_shldr[tempIndex]._arrayOfInstances[_iterator].current_pos.M41, _player_lft_shldr[tempIndex]._arrayOfInstances[_iterator].current_pos.M42, _player_lft_shldr[tempIndex]._arrayOfInstances[_iterator].current_pos.M43) + (currentDirShoulderRightToHandRight * totalArmLengthRight);
                                        }
                                        ...
                                        MOVINGPOINTER = _player_rght_upper_arm[tempIndex]._arrayOfInstances[_iterator]._UPPERARMPIVOT + (dirShoulderToHand * 2.5f);
                                        ...
                                        MOVINGPOINTER = _player_lft_upper_arm[tempIndex]._arrayOfInstances[_iterator]._UPPERARMPIVOT + (dirShoulderToHand * 2.5f);
                                        ...
                                        lengthOfLowerArmRight = _player_lft_lower_arm[tempIndex]._total_torso_height * 2.55f;
                                        lengthOfUpperArmRight = _player_lft_upper_arm[tempIndex]._total_torso_height * 2.45f;
                                        totalArmLengthRight = lengthOfLowerArmRight + lengthOfUpperArmRight;
                ...
                for (int x = 0; x < _physics_engine_instance_x; x++)
                {
                    for (int y = 0; y < _physics_engine_instance_y; y++)
                    {
                        for (int z = 0; z < _physics_engine_instance_z; z++)
                        {
                            ...
                            var screenNormalToper = dirInstance = _newgetdirup(_testQuater);
                            ...
                            screenNormal = dirInstance = _newgetdirup(_testQuater);
                            screenNormal.Normalize();
                            ...
                            resulter.M42 = currentScreenPos.Y;
                            resulter.M43 = currentScreenPos.Z;
                            _screenDirMarix_correct_pos[0][1] = resulter;
