...
namespace SCCoreSystems.sc_console
{
    public class sc_console_core : sc_icomponent
    {
        ...
        public sc_console_core(SCCoreSystems.sc_message_object.sc_message_object[] tester)
        {
        ...
        public void _createConsole(SCCoreSystems.sc_message_object.sc_message_object[] tester)
        {
