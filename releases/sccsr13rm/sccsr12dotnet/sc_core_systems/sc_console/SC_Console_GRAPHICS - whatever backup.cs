...
namespace SCCoreSystems
{
    public class SC_Console_GRAPHICS
    {
        ...
        int _inst_cube_y = 10;
        int _inst_cube_z = 10;
        float _cube_size_x = 0.1f; //0.0115f //1.5f
        float _cube_size_y = 0.1f; //0.0115f //1.5f
        float _cube_size_z = 0.1f;
        //END OF
        ...
        int[][] _objects_inactive_00;
        int[][] _objects_inactive_counter_00;
        RigidBody[][] _objects_rigid_inactive_00;
        ...
        public bool Initialize(SCCoreSystems.sc_core.sc_system_configuration configuration, IntPtr windowsHandle, sc_console.sc_console_writer _writer)
        {
            ...
            try
            {
                ...
                _objects_inactive_00 = new int[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z][];
                _objects_inactive_counter_00 = new int[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z][];
                _objects_rigid_inactive_00 = new RigidBody[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z][];



                //HUMAN RIG STUFF
                _player_rght_hnd = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_lft_upper_arm = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_lft_hnd = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_torso = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_pelvis = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_rght_shldr = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_lft_shldr = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_head = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_rght_lower_arm = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_lft_lower_arm = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_rght_upper_arm = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_rght_elbow_target = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_lft_elbow_target = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_rght_elbow_target_two = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                _player_lft_elbow_target_two = new sc_voxel[_physics_engine_instance_x * _physics_engine_instance_y * _physics_engine_instance_z];
                ...
                for (int x = 0; x < _physics_engine_instance_x; x++)
                {
                    for (int y = 0; y < _physics_engine_instance_y; y++)
                    {
                        for (int z = 0; z < _physics_engine_instance_z; z++)
                        {
                            ...
                            offsetPosX = _cube_size_x * 2 * 10; //x between each world instance
                            offsetPosY = _cube_size_y * 2 * 10; //y between each world instance
                            offsetPosZ = _cube_size_z * 2 * 10; //z between each world instance
                            ...
                            _some_reset_for_applying_force[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _some_frame_counter_raycast_00[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _some_frame_counter_raycast_01[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _switch_for_collision[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _some_last_frame_vector[_index] = new JVector[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z][];
                            //_some_last_frame_rigibodies[_index] = new RigidBody[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z][];

                            _switch_for_collision[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _objects_static_00[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _objects_static_counter_00[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _objects_rigid_static_00[_index] = new RigidBody[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];


                            _objects_inactive_00[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _objects_inactive_counter_00[_index] = new int[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];
                            _objects_rigid_inactive_00[_index] = new RigidBody[_inst_screen_assets_x * _inst_screen_assets_y * _inst_screen_assets_z];

                            for (int i = 0; i < _some_frame_counter_raycast_00[_index].Length; i++)
                            {
                                _objects_rigid_static_00[_index][i] = _world_cube_list[_index]._arrayOfInstances[i].transform.Component.rigidbody;
                                _objects_static_00[_index][i] = 0;
                                _objects_static_counter_00[_index][i] = 0;

                                _objects_rigid_inactive_00[_index][i] = _world_cube_list[_index]._arrayOfInstances[i].transform.Component.rigidbody;
                                _objects_inactive_00[_index][i] = 0;
                                _objects_inactive_counter_00[_index][i] = 0;
                                ...
                                _switch_for_collision[_index][i] = 0;
                                //_some_last_frame_vector[_index][i] = JVector.Zero;
                                //_some_last_frame_rigibodies[_index][i] = _world_cube_list[_index]._arrayOfInstances[i].transform.Component.rigidbody;
                            }
                            ...
                            vertoffsety = 0;
                            vertoffsetz = -13;
                            _player_rght_hnd[_index] = new sc_voxel();
                            ...
                            _mass = 100;
                            //_player_lft_hnd[_index] = new sc_voxel();
                            ...
                            //_player_torso[_index] = new sc_voxel();
                            ...
                            _mass = 100;
                            //_player_pelvis[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_rght_shldr[_index] = new sc_voxel();
                            ...
                            voxel_type = 1;
                            _type_of_cube = 2;
                            //_player_lft_shldr[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_head[_index] = new sc_voxel();
                            ...
                            //_player_lft_lower_arm[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_lft_upper_arm[_index] = new sc_voxel();
                            ...
                            //_player_rght_lower_arm[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_rght_upper_arm[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_rght_elbow_target[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_lft_elbow_target[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_rght_elbow_target_two[_index] = new sc_voxel();
                            ...
                            offsetPosY = _dist_between * 2;
                            offsetPosZ = _dist_between * 2;
                            //_player_lft_elbow_target_two[_index] = new sc_voxel();
        ...
        private sc_message_object.sc_message_object[] Render(sc_message_object.sc_message_object[] _main_received_object)
        {
            ...
            for (int x = 0; x < _physics_engine_instance_x; x++)
            {
                for (int y = 0; y < _physics_engine_instance_y; y++)
                {
                    for (int z = 0; z < _physics_engine_instance_z; z++)
                    {
                        ...
                        {
                            /*//_objects_rigid_static_00[_index][i] = _objects_rigid_inactive_00[_index][i];
                            if (_objects_static_00[_index][i] == 2)
                            {
                                _objects_rigid_static_00[_index][i].IsStatic = true;
                                _objects_static_00[_index][i] = 0;
                            }
                            else if (_objects_static_00[_index][i] == 1)
                            {
                                _objects_rigid_static_00[_index][i].IsStatic = false;
                                _objects_static_00[_index][i] = 0;
                            }


                            if (_objects_inactive_00[_index][i] == 2)
                            {
                                _objects_rigid_inactive_00[_index][i].IsActive = false;
                                _objects_inactive_00[_index][i] = 0;
                            }
                            else if (_objects_inactive_00[_index][i] == 1)
                            {
                                _objects_rigid_inactive_00[_index][i].IsActive = true;
                                _objects_inactive_00[_index][i] = 0;
                            }*/
                        }
                    }
            ...
            //RECORD SOUND
            if (MainWindow._keyboard_input._KeyboardState.PressedKeys.Contains(Key.R))
            {
            ...
            //SAVE SOUND
            if (MainWindow._keyboard_input._KeyboardState.PressedKeys.Contains(Key.S))
            {
            ...
            //PLAY SOUND AT INDEX
            if (MainWindow._keyboard_input._KeyboardState.PressedKeys.Contains(Key.P))
            {
                if (sc_play_file == 0)
                {
            ...
            {
                if (MainWindow._keyboard_input._KeyboardState.PressedKeys.Contains(Key.L))
                {
                    _can_work_physics = 1;
                    _hasLockedkey = 1;
            ...
            {
                if (buttonPressedOculusTouchLeft == 256)//MainWindow._KeyboardState.PressedKeys.Contains(Key.Space))
                {
            ...
            try
            {
                            ...
                            for (int x = 0; x < _physics_engine_instance_x; x++)
                            {
                                for (int y = 0; y < _physics_engine_instance_y; y++)
                                {
                                    for (int z = 0; z < _physics_engine_instance_z; z++)
                                    {
                                                    ...
                                                    if (body != null && body.Tag != null)
                                                    {
                                                        if ((SC_console_directx.BodyTag)body.Tag == SC_console_directx.BodyTag.physicsInstancedScreen)
                                                        {
                                                            ...
                                                            /*if (_has_locked_screen_pos == 0)
                                                            {
                                                                if (body.IsStatic)
                                                                {
                                                                    if (body == _grabbed_body_right)
                                                                    {
                                                                        if (_has_grabbed_right_swtch == 2)
                                                                        {
                                                                            ...
                                                                            if (_swtch_hasRotated == 0)
                                                                            {
                                                                                ...
                                                                                Matrix bodyMatrix;
                                                                                Matrix.RotationQuaternion(ref tester, out bodyMatrix);
                                                                                ...
                                                                                var someRotationFinal = bodyMatrix * originRot * rotatingMatrix * rotatingMatrixForGrabber;

                                                                                //TORSO PIVOT
                                                                                Vector3 MOVINGPOINTER = new Vector3(_player_torso[0]._arrayOfInstances[0]._ORIGINPOSITION.M41, _player_torso[0]._arrayOfInstances[0]._ORIGINPOSITION.M42, _player_torso[0]._arrayOfInstances[0]._ORIGINPOSITION.M43);

                                                                                //SAVING IN MEMORY THE ORIGINAL TORSO MATRIX NOT AFFECTED BY CURRENT POSITION AND ROTATION CHANGES.
                                                                                Matrix _rotMatrixer = _player_torso[0]._arrayOfInstances[0]._ORIGINPOSITION;
                                                                                Quaternion forTest;
                                                                                ...
                                                                                Vector3 TORSOPIVOT = MOVINGPOINTER + -(direction_feet_up_ori_torso * (_player_torso[0]._total_torso_height * 0.5f));
                                                                                ...
                                                                                someRotationFinal = _process_stuff(originRot, rotatingMatrix, rotatingMatrixForPelvis, rotatingMatrixForGrabber, _rightTouchMatrix, bodyMatrix);
                                                                                ...
                                                                                worldMatrix_instances_screens[_index][_screen_counter] = someRotationFinal;
                                                                                ...
                                                                                body.Position = new JVector(handPoser.X, handPoser.Y, handPoser.Z);
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        worldMatrix_instances_screens[_index][_screen_counter] = translationMatrix0;

                                                                        //_objects_static_00[_index][count] = 1;
                                                                        //_objects_rigid_static_00[_index][count] = body;
                                                                ...
                                                                {
                                                                    if (_has_locked_screen_pos == 0 && _has_grabbed_right == 0)
                                                                    {
                                                                        if (!body.IsStatic)
                                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                worldMatrix_instances_screens[_index][_screen_counter] = _current_screen_pos;


                                                            }
                                                            _world_screen_list[0]._arrayOfInstances[0].current_pos = worldMatrix_instances_screens[_index][_screen_counter];
                                                        ...
                                                        else if ((SC_console_directx.BodyTag)body.Tag == SC_console_directx.BodyTag.physicsInstancedCube)
                                                        {
                                                            if (handTriggerLeft[0] >= 0.001f)
                                                            {
                                                                //_process_rigidbody_two(body, x, y, z, _cube_counter);
                                                                /*if (body.IsStatic)
                                                                {
                                                                    _objects_static_00[_index][_cube_counter] = 1;
                                                                    _objects_rigid_static_00[_index][_cube_counter] = body;
                                                                }
                                                                if (!body.IsActive)
                                                                {
                                                                    _objects_inactive_00[_index][_cube_counter] = 1;
                                                                    _objects_rigid_inactive_00[_index][_cube_counter] = body;
                                                                }*/
                                                                /*Matrix.Translation(body.Position.X, body.Position.Y, body.Position.Z, out translationMatrix);
                                                                quatterer = JQuaternion.CreateFromMatrix(body.Orientation);
                                                                tester = new Quaternion(quatterer.X, quatterer.Y, quatterer.Z, quatterer.W);
                                        ...
                                        Console.Title = "inactive objects: " + _inactive_counter;
                ...
                else
                {
                    ...
                    pitch = (float)((Math.PI * -45) / 180);
                    roll = (float)(0);

                    matroxer2 = SharpDX.Matrix.RotationYawPitchRoll(yaw, pitch, roll);
                ...
                /*var screen_mat = _world_screen_list[0]._arrayOfInstances[0].current_pos;//_player_lft_hnd[0]._arrayOfInstances[0].current_pos; 
                ...
                */
                ...
                b = Math.Sqrt((r * r) - (d2 * d2));
                currentPosWidth = d1; //widthLength - 
                currentPosHeight = heightLength - b;
                percentXRight = currentPosWidth / widthLength;
                percentYRight = currentPosHeight / heightLength;
                percentXRight *= D3D.SurfaceWidth;
                ...
                /*var dirFromVertTopLeftToIntersectAddScreenPos = pointOnScreen - vertTopLeft;// (new Vector3(_intersectTouchRightMatrix.M41, _intersectTouchRightMatrix.M42, _intersectTouchRightMatrix.M43) - new Vector3(worldMatrix_instances_screens[0][0].M41, worldMatrix_instances_screens[0][0].M42, worldMatrix_instances_screens[0][0].M43)) - new Vector3(point3DCollection[0][0].X, point3DCollection[0][0].Y, point3DCollection[0][0].Z);
                var lengthOfbigR = dirFromVertTopLeftToIntersectAddScreenPos.Length();

                var dirFromVertBottomRightToIntersectAddScreenPos = pointOnScreen - vertBottomRight;
                var lengthOfsmallr = dirFromVertBottomRightToIntersectAddScreenPos.Length();

                widthLength = (point3DCollection[0][2] - point3DCollection[0][0]).Length();
                heightLength = (point3DCollection[0][1] - point3DCollection[0][0]).Length();

                d = (point3DCollection[0][2] - point3DCollection[0][0]).Length();
                var upperEquationCirCirIntersecter = (d * d) - (lengthOfsmallr * lengthOfsmallr) + (lengthOfbigR * lengthOfbigR);
                var adjacentSolvingForXer = upperEquationCirCirIntersecter / (2 * d);

                Console.WriteLine((adjacentSolvingForXer / widthLength) * D3D.SurfaceWidth);
                */




                //var lengthOfOpposite = Math.Sqrt((lengthOfAdjacent * lengthOfAdjacent) - (lengthOfDirOrHypothenuse * lengthOfDirOrHypothenuse));
                //d = (point3DCollection[0][2] - point3DCollection[0][0]).Length();
                //var upperEquationCirCirIntersecter = (d * d) - (lengthOfDirOrHypothenuse * lengthOfDirOrHypothenuse) + (lengthOfAdjacent * lengthOfAdjacent);
                //var adjacentSolvingForXer = upperEquationCirCirIntersecter / (2 * d);

                //Console.WriteLine("" + lengthOfOpposite);

                /*var resultar = Math.Pow(lengthOfUpperArmRight, 2) - Math.Pow(adjacentSolvingForX, 2);
                if (resultar < 0)
                {
                    resultar *= -1;
                }
                resultar = Math.Min(resultar, lengthOfUpperArmRight - lengthOfUpperArmRight * 0.001f);*/
                ...
                //b = Math.Sqrt((r * r) - (d2 * d2));
                /*
                //stabilizedIntersectionPosRight = new Vector3(_intersectTouchRightMatrix.M41, _intersectTouchRightMatrix.M42, _intersectTouchRightMatrix.M43);
                //CIRCLE CIRCLE INTERSECTION //http://mathworld.wolfram.com/Circle-CircleIntersection.html
                d = (point3DCollection[0][2] - point3DCollection[0][0]).Length();
                ...
                Console.WriteLine("r: " + (r / widthLength) * D3D.SurfaceWidth);
        ...
        void _process_rigidbody_two(RigidBody rigidbody, int x, int y, int z, int count, int type_of_object)
        {
            ...
            tempmat = translationMatrix;// Matrix.Identity;

            /*if (type_of_object == 0)
            {
                tempmat translationMatrix;
            }
            else
            {
                tempmat = translationMatrix;
            ...
            if (!rigidbody.IsActive)
            {
                if (_has_grabbed_right_swtch == 1)
                {
                    ...
                    Vector3 poser = new Vector3(tempmat.M41, tempmat.M42, tempmat.M43);// new Vector3(worldMatrix_instances_cubes[_index][count].M41, worldMatrix_instances_cubes[_index][count].M42, worldMatrix_instances_cubes[_index][count].M43);
                    ...
                    if (dist < 1)
                    {
                        ...
                        bool _boundingBox = _world_list[_index].CollisionSystem.CheckBoundingBoxes(rigidbody, _player_rght_hnd[0]._arrayOfInstances[0].transform.Component.rigidbody);
                        ...
                        if (!_boundingBox)
                        {
                            ...
                            if (type_of_object == 0)
                            {
                                worldMatrix_instances_cubes[_index][count] = translationMatrix0;
                            }
                            else
                            {
                                worldMatrix_instances_screens[_index][count] = translationMatrix0;
                            }
                        ...
                        else
                        {
                            ...
                            //if (rigidbody == _body_collision)
                            {
                                ...
                                _objects_inactive_00[_index][count] = 2;
                                _objects_rigid_inactive_00[_index][count] = body;
                                //if (_has_grabbed_right == 0)
                                //{
                                //var rigibody_pos = new Vector3(final_hand_pos_right.M41, final_hand_pos_right.M42, final_hand_pos_right.M43) + (_offset_grabbed_pos_norm * _offset_grabbed_pos_dist);
                                //    var rigibody_pos = new Vector3(_last_final_hand_pos_right.X, _last_final_hand_pos_right.Y, _last_final_hand_pos_right.Z) + (_last_offset_grabbed_pos_norm * _last_offset_grabbed_pos_norm_dist);
            ...
            else
            {
                if (_has_grabbed_right_swtch == 1)
                {
                    //Vector3 poser = new Vector3(rigidbody.Position.X, rigidbody.Position.Y, rigidbody.Position.Z); //OFFSETPOS
                    Vector3 handPos = _last_final_hand_pos_right;// new Vector3(final_hand_pos_right.M41, final_hand_pos_right.M42, final_hand_pos_right.M43);
                    Vector3 poser = new Vector3(tempmat.M41, tempmat.M42, tempmat.M43);
        ...
        void _process_rigidbody_that_are_currently_activated_or_not(RigidBody rigidbody, int x, int y, int z, int count)
        {
            ...
            if (!rigidbody.IsActive)
            {
                bool _boundingBox = _world_list[_index].CollisionSystem.CheckBoundingBoxes(rigidbody, _world_screen_list[0]._arrayOfInstances[0].transform.Component.rigidbody);
                ...
                else
                {
                    ...
                    //MessageBox((IntPtr)0, "collision screen", "sc core systems message", 0);
                    //_switch_for_collision[_index][count] = 1;
                }
            }
            else
            {
        ...
        //https://stackoverflow.com/questions/9855438/a-call-to-a-pinvoke-function-has-unbalanced-the-stack
