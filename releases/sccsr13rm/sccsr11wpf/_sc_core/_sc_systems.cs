...
namespace _sc_core_systems._sc_core
{
    public class _sc_systems : _sc_icomponent, _sc_globals
    {
        ...
        private sc_message_object.sc_message_object testingInit(sc_message_object.sc_message_object _main_object)
        {   
            return _main_object;
        }
        ...
        public _sc_systems(sc_message_object.sc_message_object[] _main_object)
        {
            _SC_GLOB = this;
            _SC_ICOMPONENT = this;
