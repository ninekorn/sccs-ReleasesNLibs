...
using _sc_console = _sc_core_systems._sc_console;
using _sc_console_menu = _sc_core_systems._sc_console_menu;
using _sc_core_systems.SC_Graphics;
using sc_message_object=  _sc_core_systems.sc_message_object;
...
using _sc_core_systems;
using _messager = _sc_core_systems._sc_console._messager;

namespace sccsr11wpf
{
    ...
    //internal class Program
    {
        ...
        public static int usemultithreadedrenderingormainthread = 1;
