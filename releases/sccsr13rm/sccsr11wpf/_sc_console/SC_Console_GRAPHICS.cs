...
using _sc_core_systems.sc_message_object;
...
using SimplexNoise;
//using sc_message_object = SCCoreSystems.sc_message_object.sc_message_object;
...
namespace _sc_core_systems
{
    public class SC_Console_GRAPHICS
    {
        ...
        const int maxarrayframemousesursorstabiliserl = 50;
        const int maxarrayframemousesursorstabiliserr = 49;
        ...
        float speedRot = 0.275f; //0.085f
        float speedPos = 0.15f; //0.05f

        public static int world_instance_x = 1; //4
        public static int world_instance_y = 1; //1
        public static int world_instance_z = 1; //4
        ...
        SharpDX.Vector3 originPosScreen = new SharpDX.Vector3(0, 3, -0.25f);
        //END OF

        //SCREEN SETTINGS
        int _inst_screen_x = 10;
        int _inst_screen_y = 10;
        ...
        int _inst_voxel_cube_x = 5; //7
        int _inst_voxel_cube_y = 5; //7
        int _inst_voxel_cube_z = 5; //7

        float _voxel_cube_size_x = 0.0015f; //0.0115f
        float _voxel_cube_size_y = 0.0015f; //0.0115f
        float _voxel_cube_size_z = 0.0015f;//0.0015f
        ...
        int _inst_spectrum_x = 420; // 36 // 210 //75 // 420
        int _inst_spectrum_y = 1;
        int _inst_spectrum_z = 210; // 36 // 210 //75 //5625 //210
        ...
        public bool Initialize(_sc_core_systems._sc_core._sc_system_configuration configuration, IntPtr windowsHandle, _sc_console._sc_console_writer _writer)
        {
            ...
            try
            {
                ...
                for (int x = 0; x < world_instance_x; x++)
                {
                    for (int y = 0; y < world_instance_y; y++)
                    {
                        for (int z = 0; z < world_instance_z; z++)
                        {
                            ...
                            _world_voxel_cube_lists[_index] = new _sc_voxel();

                            voxel_general_size = 0.0025f;
                            voxel_type = 0;
                            _type_of_cube = 2;
                            is_static = false;
                            //var _hasinit00 = _world_voxel_cube_lists[_index].Initialize(D3D, D3D.SurfaceWidth, D3D.SurfaceHeight, 1, 1, 1, _voxel_cube_size_x, _voxel_cube_size_y, _voxel_cube_size_z, new Vector4(r, g, b, a), _inst_voxel_cube_x, _inst_voxel_cube_y, _inst_voxel_cube_z, Hwnd, _object_worldmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, _voxel_mass, is_static, SC_console_directx.BodyTag._voxel_spheroid, 2, 2, 2, 2, 2, 2, 50, 49, 50, 49, 50, 49, voxel_general_size, Vector3.Zero, 250, 0, 0, 0, 2); //, "terrainGrassDirt.bmp" //0.00035f
                            _world_voxel_cube_lists[_index].Initialize(D3D, D3D.SurfaceWidth, D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.035f, 0.035f, new Vector4(r, g, b, a), _inst_voxel_cube_x, _inst_voxel_cube_y, _inst_voxel_cube_z, Hwnd, _object_worldmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, is_static, SC_console_directx.BodyTag._voxel_spheroid, 2, 2, 2, 2, 2, 2, 50, 49, 50, 49, 50, 49, voxel_general_size, new Vector3(0, 0, -0.1f), 250, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld); //, "terrainGrassDirt.bmp" //0.00035f
                            ...
                            {
                                worldMatrix_instances_voxel_cube[_index][i] = _world_voxel_cube_lists[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_cubes[_index][i] = _world_cube_list[_index]._arrayOfInstances[i].current_pos;//  Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_r_hand[_index][i] = _player_rght_hnd[_index]._arrayOfInstances[i].current_pos;//  Matrix.Identity; Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_l_hand[_index][i] = _player_lft_hnd[_index]._arrayOfInstances[i].current_pos;//  Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_torso[_index][i] = _player_torso[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_pelvis[_index][i] = _player_pelvis[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_r_shoulder[_index][i] = _player_rght_shldr[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_l_shoulder[_index][i] = _player_lft_shldr[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_l_lowerarm[_index][i] = _player_lft_lower_arm[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_l_upperarm[_index][i] = _player_lft_upper_arm[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_r_lowerarm[_index][i] = _player_rght_lower_arm[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            //RIGHT UPPER ARM
                            r = 0.035f;
                            g = 0.035f;
                            ...
                            {
                                worldMatrix_instances_r_upperarm[_index][i] = _player_rght_upper_arm[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_r_elbow_target[_index][i] = _player_rght_elbow_target[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_l_elbow_target[_index][i] = _player_lft_elbow_target[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_r_elbow_target_two[_index][i] = _player_rght_elbow_target_two[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                            ...
                            {
                                worldMatrix_instances_l_elbow_target_two[_index][i] = _player_lft_elbow_target_two[_index]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                            }
                        }
                    }
                }
                ...
                {
                    worldMatrix_instances_screens[0][i] = _world_screen_list[0]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                    world_last_Matrix_instances_screens[0][i] = _world_screen_list[0]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                }
                ...
                {
                    worldMatrix_instances_screen_assets[0][i] = _world_screen_assets_list[0]._arrayOfInstances[i].current_pos;// Matrix.Identity;
                }
                                ...
                                if (_index < _world_spectrum_list[0]._arrayOfInstances.Length && _index < _sound_byte_array.Length) //_inst_spectrum_x * _inst_spectrum_y * _inst_spectrum_z)
                                {
                                    if (_sound_byte_array != null)
                                    {
                                        if (_sound_byte_array.Length > 0)
                                        {
                                            ...
                                            spectrum_mat.M41 = _left_touch_pos.X + _world_spectrum_list[0]._arrayOfInstances[_index]._POSITION.M41;
                                            spectrum_mat.M42 = _left_touch_pos.Y + _world_spectrum_list[0]._arrayOfInstances[_index]._POSITION.M42 + spectrum_noise_value + (_sound_byte_array[_index] * 0.005f); //0.0015f
                                            spectrum_mat.M43 = _left_touch_pos.Z + _world_spectrum_list[0]._arrayOfInstances[_index]._POSITION.M43;
            ...
            try
            {
                ...
                if (_start_background_worker_01 == 0)
                {
                    if (_can_work_physics == 1)
                    {
                        ...
                        MainWindow.MessageBox((IntPtr)0, "" + "created thread for jitter physics buffer to rigidbody positions and rotations", "sccoresystems", 0);
                ...
                if (_can_work_physics == 1)
                {
                    if (startworkbuffers == 0)
                    {
                        ...
                        Thread main_thread_update = new Thread(() =>
                        {
                            ...
                            //MainWindow.MessageBox((IntPtr)0, "" + "starting buffer work", "sccoresystems", 0);
        ...
        Vector3[] arrayOfStabilizerPosRight = new Vector3[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosXRight = new double[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosDifferenceXRight = new double[maxarrayframemousesursorstabiliserr];
        double[] arrayOfStabilizerPosYRight = new double[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosDifferenceYRight = new double[maxarrayframemousesursorstabiliserr];

        double[] arrayOfStabilizerPosZRight = new double[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosDifferenceZRight = new double[maxarrayframemousesursorstabiliserr];



        Vector3[] arrayOfStabilizerPosLeft = new Vector3[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosXLeft = new double[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosDifferenceXLeft = new double[maxarrayframemousesursorstabiliserr];
        double[] arrayOfStabilizerPosYLeft = new double[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosDifferenceYLeft = new double[maxarrayframemousesursorstabiliserr];

        double[] arrayOfStabilizerPosZLeft = new double[maxarrayframemousesursorstabiliserl];
        double[] arrayOfStabilizerPosDifferenceZLeft = new double[maxarrayframemousesursorstabiliserr];

        //
        Vector3[] _arrayOfStabilizerPosRight = new Vector3[maxarrayframemousesursorstabiliserl];
        double[] _arrayOfStabilizerPosXRight = new double[maxarrayframemousesursorstabiliserl];
        double[] _arrayOfStabilizerPosDifferenceXRight = new double[maxarrayframemousesursorstabiliserr];
        double[] _arrayOfStabilizerPosYRight = new double[maxarrayframemousesursorstabiliserl];
        double[] _arrayOfStabilizerPosDifferenceYRight = new double[maxarrayframemousesursorstabiliserr];

        Vector3[] _arrayOfStabilizerPosLeft = new Vector3[maxarrayframemousesursorstabiliserl];
        double[] _arrayOfStabilizerPosXLeft = new double[maxarrayframemousesursorstabiliserl];
        double[] _arrayOfStabilizerPosDifferenceXLeft = new double[maxarrayframemousesursorstabiliserr];
        double[] _arrayOfStabilizerPosYLeft = new double[maxarrayframemousesursorstabiliserl];
        double[] _arrayOfStabilizerPosDifferenceYLeft = new double[maxarrayframemousesursorstabiliserr];
