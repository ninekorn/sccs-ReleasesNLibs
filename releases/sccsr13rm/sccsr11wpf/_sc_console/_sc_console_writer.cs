...
namespace _sc_core_systems._sc_console
{
    ...
    public class _sc_console_writer
    {
        ...
        public static _sc_console_writer _CONSOLE_WRITER;
        ...
        public _sc_console_writer(sc_message_object.sc_message_object[] tester)// : base(tester)
        {
