        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                var vsFileNameByteArray = "../../../sc_instance_shader/" + "texture.vs";
                var psFileNameByteArray = "../../../sc_instance_shader/" + "texture.ps";
                //var gsFileNameByteArray = "../../../sc_instance_shader/" + "HLSL.gs";

                vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileNameByteArray, "TextureVertexShader", "vs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileNameByteArray, "TexturePixelShader", "ps_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
