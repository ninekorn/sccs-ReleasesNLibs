...
{
    public class _sc_voxel_spheroid_shader_final                 // 228 lines
    {
        ...
        public _sc_voxel_spheroid_shader_final()
        {
        ...
        public _sc_core_systems.SC_Graphics._sc_voxel.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, _sc_core_systems.SC_Graphics._sc_voxel.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                vsFileName = sccsr11wpf.Properties.Resources.texture_voxel1;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsr11wpf.Properties.Resources.texture_voxel;// "../../../_sc_instance_shader/" + "texture.ps";




                //vsFileName = "../../../_sc_instance_shader/" + "texture_voxel.vs";
                //psFileName = "../../../_sc_instance_shader/" + "texture_voxel.ps";
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, _sc_voxel.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, _sc_voxel _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, _sc_voxel.DLightBuffer[] _DLightBuffer_, _sc_voxel _cuber)
        {
