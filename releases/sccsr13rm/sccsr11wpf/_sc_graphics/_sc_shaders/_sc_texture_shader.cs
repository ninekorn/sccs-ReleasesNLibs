        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler)
        {
            try
            {
                try
                {
                    ...
                    string vsFileName = sccsr11wpf.Properties.Resources.InstancedTexture1;// "../../../_sc_instance_shader/" + "texture.vs";
                    string psFileName = sccsr11wpf.Properties.Resources.InstancedTexture;// "../../../_sc_instance_shader/" + "texture.ps";
                    ...
                    /*string vsFileName = "../../../_sc_instance_shader/" + "InstancedTexture.vs";
                    string psFileName = "../../../_sc_instance_shader/" + "InstancedTexture.ps";
