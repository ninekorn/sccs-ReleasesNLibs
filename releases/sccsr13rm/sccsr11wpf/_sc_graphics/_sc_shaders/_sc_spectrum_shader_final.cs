...
{
    public class _sc_spectrum_shader_final                 // 228 lines
    {
        ...
        public _sc_spectrum_shader_final() 
        {
        ...
        public _sc_core_systems.SC_Graphics._sc_spectrum.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, _sc_core_systems.SC_Graphics._sc_spectrum.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                vsFileName = sccsr11wpf.Properties.Resources.texture1;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsr11wpf.Properties.Resources.texture;// "../../../_sc_instance_shader/" + "texture.ps";
                //var gsFileName = SCCoreSystems.Properties.Resources.HLSL;

                ShaderBytecode vertexShaderByteCode = ShaderBytecode.Compile(vsFileName, "TextureVertexShader", "vs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                ShaderBytecode pixelShaderByteCode = ShaderBytecode.Compile(psFileName, "TexturePixelShader", "ps_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                ...
                /*
                vsFileName = "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = "../../../_sc_instance_shader/" + "texture.ps";

                ShaderBytecode vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "TextureVertexShader", "vs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                ShaderBytecode pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "TexturePixelShader", "ps_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                */
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, _sc_spectrum.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, _sc_spectrum _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, _sc_spectrum.DLightBuffer[] _DLightBuffer_, _sc_spectrum _cuber)
        {
