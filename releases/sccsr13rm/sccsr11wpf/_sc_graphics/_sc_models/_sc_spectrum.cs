...
namespace _sc_core_systems.SC_Graphics
{
    public class _sc_spectrum : ITransform, IComponent
    {
            ...
            try
            {
                ...
                {               
                    ...
                    new DVertex()
                    {
                     ...
                     //ninekorn note 2021july27-PointList
                     new DVertex()
                     {
                         position = new Vector3(-1*_sizeX, -1*_sizeY, -1*_sizeZ) ,
                    ...
                    for (int y = 0; y < instY; y++)
                    {
                        for (int z = 0; z < instZ; z++)
                        {
                            ...
                            if (isTerrain == 2)
                            {
                                ...
                                _cube.transform.Component.rigidbody = new RigidBody(new BoxShape(_sizeX * 2, _sizeY * 2, _sizeZ * 2),_the_world.RigidBodies.Count+1,0);
                                ...
                                _cube.transform.Component.rigidbody.Tag = _sc_core_systems.SC_console_directx.BodyTag.physicsInstancedCube;
        ...
        private void RenderBuffers(DeviceContext deviceContext)
        {
            ...
            //ninekorn note 2021july27-TriangleList
