...
{
    public class SC_modL_rght_upper_leg : ITransform, IComponent
    {
        ...
        public SC_sdr_upper_right_leg _this_object_texture_shader { get; set; }


        //int _isTerrain;
        // Constructor
        public SC_modL_rght_upper_leg() { }

        public bool Initialize(SC_console_directx D3D, int width, int height, float tileSize, int divX, int divY, float _sizeX, float _sizeY, float _sizeZ, Vector4 color, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ)
        {
        ...
        /*public bool _initTexture(SharpDX.Direct3D11.Device device, IntPtr windowsHandle)
        {
            ...
            _this_object_texture_shader = new SC_sdr_upper_right_leg();
        ...
        private bool InitializeBuffer(SC_console_directx D3D, float _sizeX, float _sizeY, float _sizeZ, float tileSize, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ)
        {
            try
            {
                    ...
                    for (int y = 0; y < instY; y++)
                    {
                        for (int z = 0; z < instZ; z++)
                        {
                            ...
                            if (isTerrain == 0)
                            {
                                ...
                                //position.X -= (instX * offsetPosX) * 0.5f;
                                //position.Y -= (instY * offsetPosY) * 0.5f;
                                //position.Z -= (instZ * offsetPosZ) * 0.5f;
                                //position.Y += matroxer.M42;
                                ...
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.Terrain;
                            ...
                            else if (isTerrain == 1)
                            {
                                ...
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.physicsInstancedCube;
                            ...
                            else if (isTerrain == 3)
                            {
                                ...
                                _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                _cube.transform.Component.rigidbody.IsStatic = false;
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.pseudoCloth;


                                _cube.transform.Component.rigidbody.Material.Restitution = 0.25f;
                                _cube.transform.Component.rigidbody.Material.StaticFriction = 0.45f;
                                //_cube.transform.Component.rigidbody.Material.KineticFriction = 0.45f;
                                _cube.transform.Component.rigidbody.Mass = 20;
                            ...
                            else if (isTerrain == 4)
                            {
                                ...
                                _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                _cube.transform.Component.rigidbody.IsStatic = true;
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.PlayerHandRight;
                            ...
                            else if (isTerrain == 5)
                            {
                                ...
                                _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                _cube.transform.Component.rigidbody.IsStatic = true;
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.PlayerHandLeft;
                            ...
                            else if (isTerrain == 6)
                            {
                                ...
                                _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                _cube.transform.Component.rigidbody.IsStatic = true;
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.PlayerShoulderRight;
                            ...
                            else if (isTerrain == 7)
                            {
                                ...
                                _cube.transform.Component.rigidbody.LinearVelocity = new Jitter.LinearMath.JVector(0, 0, 0);
                                _cube.transform.Component.rigidbody.IsStatic = true;
                                _cube.transform.Component.rigidbody.Tag = SC_console_directx.BodyTag.PlayerShoulderLeft;
                ...
                //device.ImmediateContext.InputAssembler.SetVertexBuffers(0, new VertexBufferBinding(VertexBuffer, Utilities.SizeOf<SC_Cube_Shader.DVertex>(), 0));
