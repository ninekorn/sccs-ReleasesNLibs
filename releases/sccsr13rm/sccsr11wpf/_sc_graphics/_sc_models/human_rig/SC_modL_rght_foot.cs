...
{
    public class SC_modL_rght_foot : ITransform, IComponent
    {
        ...
        public SC_sdr_rght_foot _this_object_texture_shader { get; set; }


        //int _isTerrain;
        // Constructor
        public SC_modL_rght_foot() { }
        ...
        /*public bool _initTexture(SharpDX.Direct3D11.Device device, IntPtr windowsHandle)
        {
            ...
            _this_object_texture_shader = new SC_sdr_rght_foot();
