    ...
    public class sccsikvoxellimbs
    {
        ...
        public scmessageobjectjitter[][] createikbody(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, Matrix worldmatofobj_, int somechunkpriminstanceikarmvoxelindex_, int humaninstupperrigx_, int humaninstupperrigy_, int humaninstupperrigz_)
        {
            ...
            for (int i = 0; i < worldMatrix_instances_torso[0][0].Length; i++)
            {
               ...
               // movingpoint = movingpoint + (-direction_feet_up_torso * _player_pelvis[0][0]._total_torso_height);
                ...
                worldMatrix_instances_torso[0][0][i] = tempmatrix1;// _player_torso[0][0]._arrayOfInstances[i].current_pos;// Matrix.Identity;
            }
        ...
        public scmessageobjectjitter[][] setikbodytargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, Matrix hmd_matrix_current, Matrix extramatrix, Matrix hmdmatrixcurrentforpelvis)
        {
            ...
            for (int _iterator = 0; _iterator < _player_torso[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                if (Program.usethirdpersonview == 0)
                {
                    ...
                    //tempOffset.Y = _player_head[0][0]._arrayOfInstances[_iterator]._TEMPPIVOT.M42;
                    tempOffset.Y = SC_Update.viewpositionorigin.Y;
                    tempOffset.Z = SC_Update.viewpositionorigin.Z;

                    //tempOffset.Y = tempOffset.Y - (dirikvoxelbodyInstanceUp2.Y * _player_head[0][0]._arrayOfInstances[_iterator]._TEMPPIVOT.M42 * 0.75f);



                    //(_player_torso[0][0].ChunkHeight_L + _player_torso[0][0].ChunkHeight_R + 1) +
                    //tempOffset.Y = tempOffset.Y + (_player_head[0][0]._arrayOfInstances[_iterator]._TEMPPIVOT.M42 * 0.75f);
                    //tempOffset = tempOffset + (dirikvoxelbodyInstanceUp2 * (_player_head[0][0]._arrayOfInstances[_iterator]._TEMPPIVOT.M42 * 0.75f));
                    ...
                    //tempOffset.Y = tempOffset.Y + _player_head[0][0]._arrayOfInstances[_iterator]._TEMPPIVOT.M42;
                ...
                //MOVINGPOINTER = new Vector3(_player_head[0][0]._arrayOfInstances[_iterator].current_pos.M41, _player_head[0][0]._arrayOfInstances[_iterator].current_pos.M42, _player_head[0][0]._arrayOfInstances[_iterator].current_pos.M43);
                //MOVINGPOINTER = new Vector3(0, 0, 0);//

                MOVINGPOINTER = new Vector3(_player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42, _player_head[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43);
                ...
                MOVINGPOINTER = MOVINGPOINTER + (-direction_feet_up_torso * (heightofhead * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (widthofhead * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (heightofhead * 0.5f));

                MOVINGPOINTER = MOVINGPOINTER + (-direction_feet_up_torso * (heightOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (lengthOftorso * 0.5f));
                MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (depthoftorso * 0.5f));
                ...
                //finalRotationMatrix.M41 = MOVINGPOINTER.X;
                //finalRotationMatrix.M42 = MOVINGPOINTER.Y;
                //finalRotationMatrix.M43 = MOVINGPOINTER.Z;
                ...
                */
                ...
                _rotMatrixer = _player_pelvis[0][0]._ORIGINPOSITION;
                Quaternion.RotationMatrix(ref _rotMatrixer, out forTest);
                var direction_feet_forward_pelvis = sc_maths._getDirection(Vector3.ForwardRH, forTest);
                var direction_feet_right_pelvis = sc_maths._getDirection(Vector3.Right, forTest);
                var direction_feet_up_pelvis = sc_maths._getDirection(Vector3.Up, forTest);
                diffNormPosX = (MOVINGPOINTER.X) - _player_pelvis[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M41;
                diffNormPosY = (MOVINGPOINTER.Y) - _player_pelvis[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M42;
                diffNormPosZ = (MOVINGPOINTER.Z) - _player_pelvis[0][0]._arrayOfInstances[_iterator]._ORIGINPOSITION.M43;
                tempPoint = MOVINGPOINTER;
                tempPoint = tempPoint + -(direction_feet_right_pelvis * (diffNormPosX));
                tempPoint = tempPoint + -(direction_feet_up_pelvis * (diffNormPosY));
                tempPoint = tempPoint + -(direction_feet_forward_pelvis * (diffNormPosZ));
                ...
                /*heightofhead = _player_head[0][0]._total_torso_height * 1.0f;
                lengthOftorso = _player_torso[0][0]._total_torso_height * 1.0f;
                heightofpelvis = _player_pelvis[0][0]._total_torso_height * 1.0f;

                MOVINGPOINTER = MOVINGPOINTER + (-direction_feet_up_torso * (heightofhead));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (heightofhead * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (heightofhead * 0.5f));

                MOVINGPOINTER = MOVINGPOINTER + (-direction_feet_up_torso * (lengthOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (lengthOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (lengthOftorso * 0.5f));

                MOVINGPOINTER = MOVINGPOINTER + (-direction_feet_up_torso * (heightofpelvis));*/
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (lengthOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (lengthOftorso * 0.5f));
                ...
                heightofhead = _player_head[0][0]._total_torso_height * 1.0f;
                heightOftorso = _player_torso[0][0]._total_torso_height * 1.0f;
                //widthOftorso = _player_torso[0][0]._total_torso_width * 1.0f;           
                heightofpelvis = _player_pelvis[0][0]._total_torso_height * 1.0f;
                var widthOfpelvis = _player_pelvis[0][0]._total_torso_width * 1.0f;
                ...
                MOVINGPOINTER = MOVINGPOINTER + (direction_feet_up_torso * (heightOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (lengthOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (widthOftorso * 0.5f));

                MOVINGPOINTER = MOVINGPOINTER + (direction_feet_up_torso * (heightofpelvis * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_right_torso * (lengthOftorso * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (lengthOftorso * 0.5f));
                MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (widthOfpelvis * 0.5f));
                */
                ...
                widthofhead = _player_head[0][0]._total_torso_width * 1.0f;
                widthoftorso = _player_torso[0][0]._total_torso_width * 1.0f;
                widthofpelvis = _player_pelvis[0][0]._total_torso_width * 1.0f;

                depthofhead = _player_head[0][0]._total_torso_depth * 1.0f;
                depthoftorso = _player_torso[0][0]._total_torso_depth * 1.0f;
                depthofpelvis = _player_pelvis[0][0]._total_torso_depth * 1.0f;
                ...
                MOVINGPOINTER = MOVINGPOINTER + (direction_feet_up_torso * (heightofpelvis * 0.5f));
                //MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_torso * (widthOfpelvis * 0.5f));
                MOVINGPOINTER = MOVINGPOINTER + -(direction_feet_forward_pelvis * (depthofpelvis * 0.5f));
        ...
        public scmessageobjectjitter[][] createikarm(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxellimbsindex_, int humaninstlimbsx_, int humaninstlimbsy_, int humaninstlimbsz_)
        {
            ...
            for (int i = 0; i < worldMatrix_instances_r_shoulder[0][0].Length; i++)
            {
                ...
                //var movingpoint = +(direction_feet_up_torso * heightOftorso * 0.5f);
                var movingpoint = new Vector3(_player_rght_shldr[0][0]._arrayOfInstances[i].current_pos.M41, _player_rght_shldr[0][0]._arrayOfInstances[i].current_pos.M42, _player_rght_shldr[0][0]._arrayOfInstances[i].current_pos.M43);
                ...
                var tempmatrix1 = _player_rght_shldr[0][0]._arrayOfInstances[i].current_pos; //Matrix.Identity; //_player_rght_shldr[0][0]._arrayOfInstances[i].current_pos;
        ...
        public scmessageobjectjitter[][] setiktargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_)
        {
            ...
            for (int _iterator = 0; _iterator < _player_rght_hnd[0][0]._arrayOfInstances.Length; _iterator++) //
            {
                ...
                */
                ...
                //newpoint = newpoint + (newdir * (lengthOfLowerArmRight + lengthOfUpperArmRight) * 0.5f);
