...
namespace SCCoreSystems
{
    public class SC_instancedChunk_shader_final
    {
        ...
        public SC_instancedChunk_shader_final(SharpDX.Direct3D11.Device _device, InputLayout _Layout, VertexShader _VertexShader, PixelShader _PixelShader, SharpDX.Direct3D11.Buffer indexBuffer, SC_instancedChunk.DVertex[] vertexArray, SC_instancedChunk.DIndexType[] _indexArray, SharpDX.Direct3D11.Buffer vertexBuffer, SharpDX.Direct3D11.Buffer indicesBuffer)
        {
            chunkShader = this;
       ...
       public ShaderResourceView shaderResourceView2D;
        ...
        public SCCoreSystems.sc_console.sc_graphics_sec.chunkData Renderer(SCCoreSystems.sc_console.sc_graphics_sec.chunkData chunkdat, int indexBuilt) //async
        {
            ...
            if (chunkdat.InstanceRotationBufferFORWARD != null)
            {
                //MainWindow.MessageBox((IntPtr)0, " some test", "Oculus Error", 0);
            ...
            //InstanceRotationBufferFORWARD
            //InstanceRotationBufferRIGHT
            //InstanceRotationBufferUP

            device.ImmediateContext.InputAssembler.SetVertexBuffers(7, new[]
            {
                new VertexBufferBinding(chunkdat.InstanceRotationBufferFORWARD, Marshal.SizeOf(typeof(SC_instancedChunk.DInstanceType)),0),
            });
            device.ImmediateContext.InputAssembler.SetVertexBuffers(8, new[]
            {
                new VertexBufferBinding(chunkdat.InstanceRotationBufferRIGHT, Marshal.SizeOf(typeof(SC_instancedChunk.DInstanceType)),0),
            });
            device.ImmediateContext.InputAssembler.SetVertexBuffers(9, new[]
            {
                new VertexBufferBinding(chunkdat.InstanceRotationBufferUP, Marshal.SizeOf(typeof(SC_instancedChunk.DInstanceType)),0),
            });
