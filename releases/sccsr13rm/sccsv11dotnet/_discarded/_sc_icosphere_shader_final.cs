...
{
    public class _sc_icosphere_shader_final                 // 228 lines
    {
        ...
        public _sc_icosphere_shader_final() 
        {
        ...
        public _sc_core_systems.SC_Graphics._sc_icosphere.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, _sc_core_systems.SC_Graphics._sc_icosphere.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                vsFileName = "../../../_sc_instance_shader/" + "texture_ico.vs";
                psFileName = "../../../_sc_instance_shader/" + "texture_ico.ps";
        ...
        public bool Render(DeviceContext deviceContext, int VertexCount, int InstanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, _sc_icosphere.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, _sc_icosphere _cuber)
        {
        ...
        private void RenderShader(DeviceContext deviceContext, _sc_icosphere.DLightBuffer[] _DLightBuffer_, _sc_icosphere _cuber)
        {
            ...
            if (_switchOnce == 0)
            {
                ...
                {
                    _sc_console_graphics.MessageBox((IntPtr)0, ex.ToString() + "", "Oculus Error", 0);
                }
                _switchOnce = 1;
            }
