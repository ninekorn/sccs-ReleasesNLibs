            ...
            try
            {
                ...
                for (int x = -_divX; x < (_divX); x++)
                {
                    for (int y = -_divY; y < (_divY); y++)
                    {
                        ...
                        vertices[index].position = new Vector3(positionX * sizeWidther, positionZ * sizeHeighter, 0.0f) * _size_screen;
                ...
                SC_Console_GRAPHICS.MessageBox((IntPtr)0, "XGRID01", "Oculus Error", 0);
                return true;
            }
            catch
            {

                SC_Console_GRAPHICS.MessageBox((IntPtr)0, "XGRID02", "Oculus Error", 0);
                //SC_Console_GRAPHICS.MessageBox((IntPtr)0, "NULL XGRID001", "Oculus Error", 0);
