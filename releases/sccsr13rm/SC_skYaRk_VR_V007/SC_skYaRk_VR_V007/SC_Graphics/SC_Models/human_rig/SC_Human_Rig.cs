...
namespace SC_skYaRk_VR_V007.SC_Graphics.SC_Models.human_rig
{
    public class SC_human_RIG
    {
        ...
        public SC_human_RIG(SC_Console_DIRECTX D3D, IntPtr HWND, World World, Matrix WorldMatrix, float size_screen, float r, float g, float b, float a, int instX, int instY, int instZ, float offsetPosX, float offsetPosY, float offsetPosZ)
        {
            ...
            _player_right_hnd = new SC_modL_rght_hnd();
            _hasinit0 = _player_right_hnd.Initialize(_D3D, _D3D.SurfaceWidth, _D3D.SurfaceHeight, _size_screen, 1, 1, 0.0125f, 0.045f, 0.05f, new Vector4(r, g, b, a), instX, instY, instZ, _HWND, _tempMatroxer, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_torso.Initialize(_D3D, _D3D.SurfaceWidth, _D3D.SurfaceHeight, _size_screen, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), instX, instY, instZ, _HWND, _tempMatroxer, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_left_hnd = new SC_modL_lft_hnd();
            ...
            _player_torso = new SC_modL_torso();
            _hasinit0 = _player_torso.Initialize(_D3D, _D3D.SurfaceWidth, _D3D.SurfaceHeight, _size_screen, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), instX, instY, instZ, _HWND, _tempMatroxer, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_torso.Initialize(_D3D, _D3D.SurfaceWidth, _D3D.SurfaceHeight, _size_screen, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), instX, instY, instZ, _HWND, _tempMatroxer, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            _player_pelvis = new SC_modL_pelvis();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_right_shldr = new SC_modL_rght_shldr();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_lft_shldr = new SC_modL_lft_shldr();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_rght_lower_arm = new SC_modL_rght_lower_arm();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_lft_lower_arm = new SC_modL_lft_lower_arm();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_rght_upper_arm = new SC_modL_rght_upper_arm();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_lft_upper_arm = new SC_modL_lft_upper_arm();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_rght_elbow_target = new SC_modL_rght_elbow_target();
            ...
            vertOffsetY = 0;
            vertOffsetZ = 0;
            _player_lft_elbow_target = new SC_modL_lft_elbow_target();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_rght_elbow_target_two = new SC_modL_rght_elbow_target_two();
            ...
            offsetPosY = 0;
            offsetPosZ = 0;
            _player_lft_elbow_target_two = new SC_modL_lft_elbow_target_two();
        ...
        public void update_human_rig(Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Matrix viewMatrix, Matrix _projectionMatrix, Vector3 oculusRiftDir, Matrix rotatingMatrix, Vector3 OFFSETPOS, Matrix rotatingMatrixForPelvis, out Matrix _handPositionLeft, out Matrix _handPositionRight)
        {
            ...
            //TORSO////
            ///////////
            _SC_modL_torso_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
            ...
            _SC_modL_rght_hnd_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_lft_hnd_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_shldr_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            */
            ...
            ////////////////
            //SHOULDER LEFT
            _SC_modL_lft_shldr_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            */
            ...
            /////////////////////
            //ELBOW TARGET RIGHT
            _SC_modL_rght_elbow_target_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_elbow_target_two_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            //////////////////
            //UPPER ARM RIGHT
            _SC_modL_rght_upper_arm_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            /////////////////
            //RIGHT LOWER ARM
            _SC_modL_rght_lower_arm_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            /////////////////////
            //ELBOW TARGET LEFT
            _SC_modL_lft_elbow_target_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_lft_elbow_target_two_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            //////////////////
            //UPPER ARM LEFT
            _SC_modL_lft_upper_arm_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            /////////////////
            //LEFT LOWER ARM
            _SC_modL_lft_lower_arm_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            //HEAD
            _SC_modL_head_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            */
            ...
            _SC_modL_pelvis_BUFFER[0] = new SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
