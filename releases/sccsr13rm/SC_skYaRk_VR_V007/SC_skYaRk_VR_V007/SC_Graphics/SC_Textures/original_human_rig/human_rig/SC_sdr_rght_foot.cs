...
{
    public class SC_sdr_rght_foot                 // 228 lines
    {
        ...
        SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceData[] instancesDataRIGHT;// = new SC_modL_rght_foot.DInstanceData[];
        SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceData[] instancesDataUP;

        int _initDirectionsArray = 1;

        public bool Render(DeviceContext deviceContext, int vertexCount, int instanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture,SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceType[] instances, SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceData[] instancesData, SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, int _instX, int _instY, int _instZ, SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
            ...
            {
                instancesDataRIGHT = new SC_modL_rght_foot.DInstanceData[instancesData.Length];
                instancesDataUP = new SC_modL_rght_foot.DInstanceData[instancesData.Length];
...

    {
        ...
        private void RenderShader(DeviceContext deviceContext, int indexCount, int instanceCount, SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceType[] instances, SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceData[] instancesData, SC_skYaRk_VR_V007.SC_Graphics.SC_modL_rght_foot.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix,int _instX, int _instY, int _instZ, SC_skYaRk_VR_V007.SC_Graphics.SC_cube.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
            ...
            */
            ...
            {
                new VertexBufferBinding(InstanceBuffer, Marshal.SizeOf(typeof(SC_modL_rght_foot.DInstanceType)),0),
            });
            */
            ...
            {  
                new VertexBufferBinding(InstanceRotationBuffer, Marshal.SizeOf(typeof(SC_modL_rght_foot.DInstanceData)),0),
            });*/
