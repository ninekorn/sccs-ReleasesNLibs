...
{
    public class DTextureShader4Cloth                 // 228 lines
    {
        // Structs
        ...
        // Constructor
        public DTextureShader4Cloth() { }

        public SharpDX.Direct3D11.Buffer _constantLightBuffer;
        DataStream mappedResourceLight;


        public SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DLightBuffer[] _DLightBuffer;
        // Methods
        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DLightBuffer[] DLightBuffer)
        {
        ...
        SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceData[] instancesDataRIGHT;// = new SC_Desk_Screen.DInstanceData[];
        SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceData[] instancesDataUP;

        int _initDirectionsArray = 1;

        public bool Render(DeviceContext deviceContext, int vertexCount, int instanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture,SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceType[] instances, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceData[] instancesData, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, int _instX, int _instY, int _instZ, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
            ...
            {
                instancesDataRIGHT = new DTerrain_Screen.DInstanceData[instancesData.Length];
                instancesDataUP = new DTerrain_Screen.DInstanceData[instancesData.Length];
...

    {
        ...
        private void RenderShader(DeviceContext deviceContext, int indexCount, int instanceCount, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceType[] instances, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceData[] instancesData, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix,int _instX, int _instY, int _instZ, SC_skYaRk_VR_V007.SC_Graphics.DTerrain_Screen.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
            ...
            */
            ...
            {
                new VertexBufferBinding(InstanceBuffer, Marshal.SizeOf(typeof(SC_Desk_Screen.DInstanceType)),0),
            });
            */
            ...
            {  
                new VertexBufferBinding(InstanceRotationBuffer, Marshal.SizeOf(typeof(SC_Desk_Screen.DInstanceData)),0),
            });*/
