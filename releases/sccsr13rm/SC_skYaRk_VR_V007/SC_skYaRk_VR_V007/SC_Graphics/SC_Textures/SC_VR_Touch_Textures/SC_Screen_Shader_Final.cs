...
{
    public class SC_Screen_Shader_Final                 // 228 lines
    {
        // Structs
        ...
        // Constructor
        public SC_Screen_Shader_Final() { }

        public SharpDX.Direct3D11.Buffer _constantLightBuffer;
        DataStream mappedResourceLight;


        public SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DLightBuffer[] _DLightBuffer;
        // Methods
        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DLightBuffer[] DLightBuffer)
        {
        ...
        SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceData[] instancesDataRIGHT;// = new SC_ShaderManager.DInstanceData[];
        SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceData[] instancesDataUP;

        int _initDirectionsArray = 1;

        public bool Render(DeviceContext deviceContext, int vertexCount, int instanceCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture,SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceType[] instances, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceData[] instancesData, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, int _instX, int _instY, int _instZ, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
            ...
            {
                instancesDataRIGHT = new DModelClass2.DInstanceData[instancesData.Length];
                instancesDataUP = new DModelClass2.DInstanceData[instancesData.Length];
...

    {
        ...
        private void RenderShader(DeviceContext deviceContext, int indexCount, int instanceCount, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceType[] instances, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceData[] instancesData, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DInstanceDataMatrixRotter[] instancesDataRotter, SharpDX.Direct3D11.Buffer InstanceBuffer, SharpDX.Direct3D11.Buffer InstanceRotationBuffer, SharpDX.Direct3D11.Buffer InstanceRotationMatrixBuffer, Matrix[] worldMatrix_instances, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix,int _instX, int _instY, int _instZ, SC_skYaRk_VR_V007.SC_Graphics.DModelClass2.DLightBuffer[] _DLightBuffer_, Vector3 oculusRiftDir, SharpDX.Direct3D11.Buffer InstanceRotationBufferRIGHT, SharpDX.Direct3D11.Buffer InstanceRotationBufferUP)
        {
            ...
            */
            ...
            {
                new VertexBufferBinding(InstanceBuffer, Marshal.SizeOf(typeof(SC_ShaderManager.DInstanceType)),0),
            });
            */
            ...
            {  
                new VertexBufferBinding(InstanceRotationBuffer, Marshal.SizeOf(typeof(SC_ShaderManager.DInstanceData)),0),
            });*/
