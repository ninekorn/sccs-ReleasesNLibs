...
namespace SC_skYaRk_VR_V007.SC_Graphics.SC_Textures.SC_VR_Touch_Textures
{
    public class SC_VR_Terrain_Shader                   // 199 lines
    {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandle) //, string vsFileName, string psFileName
        {
            try
            {
                ...
                var vsFileNameByteArray = SC_skYaRk_VR_V007.Properties.Resources.Color1;
                var psFileNameByteArray = SC_skYaRk_VR_V007.Properties.Resources.Color;
