...
namespace SC_skYaRk_VR_V007
{
    public class SC_Console_DIRECTX                  // 269 lines
    {
        ...
        public static RasterizerState _rasterState;
        public static RasterizerState _RasterState => _rasterState;



        public static SharpDX.Direct3D11.DeviceContext _deviceContext;
        public static SharpDX.Direct3D11.DeviceContext _DeviceContext => _deviceContext;

        public static Texture2D _depthStencilBuffer;
        public static Texture2D _DepthStencilBuffer => _depthStencilBuffer;


        //OCULUS RIFT

        public int _useOculusRift = 1;
        public SharpDX.Direct3D11.Device device;
        protected SharpDX.Direct3D11.Device Device => device;



        public static SharpDX.Direct3D11.Device _devicer;
        ...
        public SharpDX.Direct3D11.DeviceContext DeviceContext => deviceContext;
        ...
        public static SharpDX.Direct3D11.Device _device;
        protected SharpDX.Direct3D11.Device _Device => _device;
        ...
        //public static List<DModelClass4_cube> _arrayOfClothCubes = new List<DModelClass4_cube>();
        ...
        public bool Initialize(SC_skYaRk_VR_V007.DSystemConfiguration.DSystemConfiguration configuration, IntPtr Hwnd, SC_Console_WRITER _writer)
        {
            try
            {
                ...
                */
                ...
                _oculusRiftVirtualRealityProvider = new OculusWrapVirtualRealityProvider(OVR, multisamplingCount: 0);
                ...
                {
                    //Console.WriteLine("The HMD is enabled: " + result.ToString());
                }
                ...
                try
                {
                    ...
                    var factory = new SharpDX.DXGI.Factory4();// Factory1();
                ...
                catch
                {
                    ...
                    /*SharpDX.DXGI.SwapChain _swapChainer;
                    SwapChainDescription swapChainDescriptioner = new SwapChainDescription();

                    swapChainDescriptioner.BufferCount = 1;
                    swapChainDescriptioner.IsWindowed = true;
                    swapChainDescriptioner.OutputHandle = Hwnd; //form.Handle
                    swapChainDescriptioner.SampleDescription = new SampleDescription(1, 0);
                    swapChainDescriptioner.Usage = Usage.RenderTargetOutput | Usage.ShaderInput;
                    swapChainDescriptioner.SwapEffect = SwapEffect.Sequential;
                    swapChainDescriptioner.Flags = SwapChainFlags.AllowModeSwitch;
                    swapChainDescriptioner.ModeDescription.Width = SurfaceWidth; //form.Width
                    swapChainDescriptioner.ModeDescription.Height = SurfaceHeight; //form.Height
                    swapChainDescriptioner.ModeDescription.Format = Format.R8G8B8A8_UNorm;
                    swapChainDescriptioner.ModeDescription.RefreshRate.Numerator = 0;
                    swapChainDescriptioner.ModeDescription.RefreshRate.Denominator = 1;


                    var rational = new Rational(0, 1);
                    // Initialize the swap chain description.
                    var swapChainDescer = new SwapChainDescription()
                    {
                        // Set to a single back buffer.
                        BufferCount = 1,
                        // Set the width and height of the back buffer.
                    ...
                    SharpDX.Direct3D11.Device.CreateWithSwapChain(DriverType.Hardware, DeviceCreationFlags.None, swapChainDescer, out _devicer, out _swapChainer);
                    */
                        ...
                        try
                    {
                        ...
                        //Device = _device;
                        //_devicer = new SharpDX.Direct3D11.Device(SharpDX.Direct3D.DriverType.Hardware, DeviceCreationFlags.None);
                ...
                // Setup and create the viewport for rendering.
                _DeviceContext.Rasterizer.SetViewport(0, 0, configuration.Width, configuration.Height, 0, 1);
        ...
        public void BeginScene(float red, float green, float blue, float alpha, SC_object_messenger_dispatcher.SC_message_object[] _someReceivedObject0)
        {
        ...
        int _getXAudio = 0;
        private void BeginScene(Color4 givenColour, SC_object_messenger_dispatcher.SC_message_object[] _someReceivedObject0)
        {
        ...
        public void ClearSceneVisual()
        {
            ...
            // Clear the back buffer.
            _DeviceContext.ClearRenderTargetView(_renderTargetView, new Color4(0, 0, 0, 1));
        }
        ...
        public void EndScene()
        {
            ...
            if (VerticalSyncEnabled)
                _swapChain.Present(1, PresentFlags.None); // Lock to screen refresh rate.
            else
                _swapChain.Present(0, PresentFlags.None); // Present as fast as possible.


        }


        SC_object_messenger_dispatcher.SC_message_object[] _someReceivedObject0;
