...
namespace SC_skYaRk_VR_Edition_v005
{
    ...
    /// </summary>
    public abstract class SC_Console_DIRECTXCOMPONENT: Program
    {
        ...
        protected SC_Console_DIRECTXCOMPONENT()
        {
        ...
        protected virtual void InternalInitialize()
        {
            ...
            SurfaceWidth = ActualWidth; //(int)(ActualWidth < 0 ? 0 : Math.Ceiling(ActualWidth * dpiScale ));
            SurfaceHeight = ActualHeight;// (int)(ActualHeight < 0 ? 0 : Math.Ceiling(ActualHeight * dpiScale)); 
