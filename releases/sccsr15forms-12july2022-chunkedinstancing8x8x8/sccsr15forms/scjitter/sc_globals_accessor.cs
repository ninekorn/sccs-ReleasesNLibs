...
namespace sccsr15forms
{
    public class sc_globals_accessor : sc_icomponent, sc_globals
    {
        ...
        public virtual sccsr15forms.sc_globals_accessor SC_GLOBALS_ACCESSORS { get; set; }

        public virtual int _Activate_Desktop_Image { get; set; }

        private scmessageobject testingInit(scmessageobject _main_object)
        {   
            return _main_object;
        }
        ...
        public sc_globals_accessor(scmessageobject[] _main_object)
        {
            SC_GLOB = this;
            SC_ICOMPONENT = this;
