...
namespace sccsr15forms
{
    public class sccslevelgen
    {
        ...
        public int maxarraychunkdataval = 16;


        public tutorialcubeaschunkinst.chunkdata[][] arraychunkdatalod0;
        /*public tutorialcubeaschunkinst.chunkdata[] arraychunkdatalod0bottom;
        public tutorialcubeaschunkinst.chunkdata[] arraychunkdatalod0left;
        public tutorialcubeaschunkinst.chunkdata[] arraychunkdatalod0right;
        public tutorialcubeaschunkinst.chunkdata[] arraychunkdatalod0front;
        public tutorialcubeaschunkinst.chunkdata[] arraychunkdatalod0back;*/
        ...
        public void createlevel()
        {
            ...
            if (loadmap == 0)
            {
                ...
                //arraychunkdatalod0 = new tutorialcubeaschunkinst.chunkdata[levelmap.Length];
                ...
                //arraychunkdatalod0 = new tutorialcubeaschunkinst.chunkdata[levelmap.Length];
                /*arraychunkdatalod0top = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * 8];
                arraychunkdatalod0bottom = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * 8];
                arraychunkdatalod0left = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * 8];
                arraychunkdatalod0right = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * 8];
                arraychunkdatalod0front = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * 8];
                arraychunkdatalod0bottom = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * 8];*/


                arraychunkdatalod0 = new tutorialcubeaschunkinst.chunkdata[6][];


                for (int i = 0;i < arraychunkdatalod0.Length;i++ )
                {
                    arraychunkdatalod0[i] = new tutorialcubeaschunkinst.chunkdata[totaltilescounter * maxarraychunkdataval];
                }
