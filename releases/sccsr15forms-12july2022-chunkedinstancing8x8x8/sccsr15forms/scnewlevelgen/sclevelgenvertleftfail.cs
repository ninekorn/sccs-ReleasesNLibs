...
{
    public class sclevelgenvertleft
    {
        ...
        public List<Vector4> vertexlistfront = new List<Vector4>(); //listOfVerts

        public List<Vector4> vertexlistleft = new List<Vector4>();
        public List<Vector4> vertexlistright = new List<Vector4>();
        public List<Vector4> vertexlisttop = new List<Vector4>();
        public List<Vector4> vertexlistbottom = new List<Vector4>();
        public List<Vector4> vertexlistback = new List<Vector4>();
        ...
        //public static Dictionary<sclevelgenvertleft, Vector3> chunkz = new Dictionary<sclevelgenvertleft, Vector3>();

        int typeofterraintiles;
        sclevelgenvertleft[] listofchunksadjacent = new sclevelgenvertleft[6];
        sclevelgenvertleft[] listofchunksadjacentfloor = new sclevelgenvertleft[6];
        ...
        public int[] startBuildingArray(Vector4 currentPosition, out Vector4[] dVertexArray, out int[] indicesArray ) //, out int vertexNum, out int indicesNum
        //public void startBuildingArray(Vector4 currentPosition, out sclevelgenclass.DVertex[] vertexArray, out int[] triangleArray, out int[] mapper, int padding0_, int padding1_, int padding2_, int numberOfObjectInWidth_, int numberOfObjectInHeight_, int numberOfObjectInDepth_, int numberOfInstancesPerObjectInWidth_, int numberOfInstancesPerObjectInHeight_, int numberOfInstancesPerObjectInDepth_, int width_, int height_, int depth_, float planeSize_, sclevelgenclassPrim componentparentprim_, sclevelgenclass componentparentinstance_, sclevelgenclass_instances componentparentthischunk_, int fullface_, int voxeltype_)
        {
            ...
            chunkoriginpos = new Vector4(currentPosition.X, currentPosition.Y, currentPosition.Z, 0.0f);
            ...
            vertexlistfront = new List<Vector4>();
            vertexlistback = new List<Vector4>();
            vertexlistleft = new List<Vector4>();
            vertexlistright = new List<Vector4>();
            vertexlisttop = new List<Vector4>();
            vertexlistbottom = new List<Vector4>();
            ...
            */
            ...
            for (int i = 0; i < vertexlistleft.Count; i++)
            {
                listofverts.Add(vertexlistleft[i]);
            }
            for (int i = 0; i < listOfTriangleIndicesleft.Count; i++)
            {
                listoftrigs.Add(listOfTriangleIndicesleft[i]);
            }

            int originallength = listofverts.Count;
            for (int i = 0; i < vertexlistright.Count; i++)
            {
                listofverts.Add(vertexlistright[i]);
            }

            for (int i = 0; i < listOfTriangleIndicesright.Count; i++)
            {
                listoftrigs.Add(listOfTriangleIndicesright[i] + originallength);
            }

            originallength = listofverts.Count;
            for (int i = 0; i < vertexlistfront.Count; i++)
            {
                listofverts.Add(vertexlistfront[i]);
            }

            for (int i = 0; i < listOfTriangleIndicesfront.Count; i++)
            {
                listoftrigs.Add(listOfTriangleIndicesfront[i] + originallength);
            }

            originallength = listofverts.Count;
            for (int i = 0; i < vertexlistback.Count; i++)
            {
                listofverts.Add(vertexlistback[i]);
            }

            for (int i = 0; i < listOfTriangleIndicesback.Count; i++)
            {
                listoftrigs.Add(listOfTriangleIndicesback[i] + originallength);
            }
            ...
            {
                listofverts.Add(vertexlisttop[i]);
            }

            for (int i = 0; i < listOfTriangleIndicestop.Count; i++)
            {
                listoftrigs.Add(listOfTriangleIndicestop[i] + originallength);
            }
            originallength = listofverts.Count;
            for (int i = 0; i < vertexlistbottom.Count; i++)
            {
                listofverts.Add(vertexlistbottom[i]);
            }

            for (int i = 0; i < listOfTriangleIndicesbottom.Count; i++)
            {
                listoftrigs.Add(listOfTriangleIndicesbottom[i] + originallength);
            }


            dVertexArray = listofverts.ToArray();
            indicesArray = listoftrigs.ToArray();
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertleft someChunk = (sclevelgenvertleft)componentparent.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    sclevelgenvertleft someChunk = (sclevelgenvertleft)componentparent.getChunklod0(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
                    if (someChunk != null)
                    {
                        if (someChunk.map != null)
                        {
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= 1.0f;
                                //var someChunk = (sclevelgenvertleft)componentparent.getChunklod0(somechunkpos.X, 0, somechunkpos.Z);
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertleft someChunk = (sclevelgenvertleft)componentparent.getChunklod0(somechunkpos.X,0, somechunkpos.Z);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        if (levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz) != null)
                        {
                            ...
                            sclevelgenvertleft someChunk = (sclevelgenvertleft)levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                            if (someChunk != null)
                            {
                                if (xi == 0 && someChunk.map != null)
                                {
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        if (componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz) != null)
                        {
                            ...
                            sclevelgenvertleft someChunk = (sclevelgenvertleft)componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
            ...
            if (_block == 1) //|| _block == 2
            {
                ...
                if (IsTransparent(xi, yi + 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        _index0 = vertexlisttop.Count;
                        vertexlisttop.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlisttop.Add(topfacecolor);
                    ...
                    {
                        _index1 = vertexlisttop.Count;
                        vertexlisttop.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlisttop.Add(topfacecolor);
                    ...
                    {
                        _index2 = vertexlisttop.Count;
                        vertexlisttop.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlisttop.Add(topfacecolor);
                    ...
                    {
                        _index3 = vertexlisttop.Count;
                        vertexlisttop.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlisttop.Add(topfacecolor);
                        ...
                        //if (someChunk.IsTransparent(width - 1, yi, zi))
                        {
                            ...
                            if (IsTransparent(xi - 1, yi, zi))// && someChunk.IsTransparent(width - 1, yi, zi))
                            {
                                ...
                                if (getChunklod0Vertexint1(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                                {
                                    ...
                                    _index0 = vertexlistleft.Count;
                                    vertexlistleft.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                                    //vertexlist.Add(new Vector4(xit, yit, zit, block));
                                    vertexlistleft.Add(leftfacecolor);
                                ...
                                {
                                    _index1 = vertexlistleft.Count;
                                    vertexlistleft.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                                    //vertexlist.Add(new Vector4(xit, yit, zit, block));
                                    vertexlistleft.Add(leftfacecolor);
                                ...
                                {
                                    _index2 = vertexlistleft.Count;
                                    vertexlistleft.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                                    //vertexlist.Add(new Vector4(xit, yit, zit, block));
                                    vertexlistleft.Add(leftfacecolor);
                                ...
                                {
                                    _index3 = vertexlistleft.Count;
                                    vertexlistleft.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                                    //vertexlist.Add(new Vector4(xit, yit, zit, block));
                                    vertexlistleft.Add(leftfacecolor);
            ...
            if (_block == 1) //|| _block == 2
            {
                if (IsTransparent(xi + 1, yi, zi))
                {
                    ...
                    if (getChunklod0Vertexint2(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        _index0 = vertexlistright.Count;
                        vertexlistright.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistright.Add(rightfacecolor);
                    ...
                    {
                        _index1 = vertexlistright.Count;
                        vertexlistright.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistright.Add(rightfacecolor);
                    ...
                    {
                        _index2 = vertexlistright.Count;
                        vertexlistright.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistright.Add(rightfacecolor);
                    ...
                    {
                        _index3 = vertexlistright.Count;
                        vertexlistright.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistright.Add(rightfacecolor);
            ...
            if (_block == 1) //|| _block == 2
            {
                if (IsTransparent(xi, yi, zi + 1))
                {
                    ...
                    if (getChunklod0Vertexint3(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        _index0 = vertexlistfront.Count;
                        vertexlistfront.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistfront.Add(frontfacecolor);
                    ...
                    {
                        _index1 = vertexlistfront.Count;
                        vertexlistfront.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistfront.Add(frontfacecolor);
                    ...
                    {
                        _index2 = vertexlistfront.Count;
                        vertexlistfront.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistfront.Add(frontfacecolor);
                    ...
                    {
                        _index3 = vertexlistfront.Count;
                        vertexlistfront.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistfront.Add(frontfacecolor);
            ...
            if (_block == 1) //|| _block == 2
            {
                if (IsTransparent(xi, yi, zi - 1))
                {
                    ...
                    if (getChunklod0Vertexint4(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        _index0 = vertexlistback.Count;
                        vertexlistback.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistback.Add(backfacecolor);
                    ...
                    {
                        _index1 = vertexlistback.Count;
                        vertexlistback.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistback.Add(backfacecolor);
                    ...
                    {
                        _index2 = vertexlistback.Count;
                        vertexlistback.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistback.Add(backfacecolor);
                    ...
                    {
                        _index3 = vertexlistback.Count;
                        vertexlistback.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistback.Add(backfacecolor);
            ...
            if (_block == 1) //|| _block == 2
            {
                if (IsTransparent(xi, yi - 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint5(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        _index0 = vertexlistbottom.Count;
                        vertexlistbottom.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistbottom.Add(bottomfacecolor);
                    ...
                    {
                        _index1 = vertexlistbottom.Count;
                        vertexlistbottom.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistbottom.Add(bottomfacecolor);
                    ...
                    {
                        _index2 = vertexlistbottom.Count;
                        vertexlistbottom.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistbottom.Add(bottomfacecolor);
                    ...
                    {
                        _index3 = vertexlistbottom.Count;
                        vertexlistbottom.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlistbottom.Add(bottomfacecolor);
