...
namespace sccsr15forms
{
    public class sccslevelgen
    {
        ...
        public void createlevel()
        {
            ...
            minx = (int)sc_maths.getSomeRandNumThousandDecimal(15, 20, 1, 2, 1);
            miny = 0;// (int)sc_maths.getSomeRandNumThousandDecimal(9, 13, 1, 2, 1);
            minz = (int)sc_maths.getSomeRandNumThousandDecimal(15, 20, 1, 2, 1);
        ...
        void checkAllSides(int xi, int yi, int zi)
        {
            ...
            if (levelmap[indexinlevelarray] == 0 && xi == minx ||
                ...
                levelmap[indexinlevelarray] == 999 && xi == minx ||
                levelmap[indexinlevelarray] == 999 && zi == minz ||
                levelmap[indexinlevelarray] == 999 && xi == maxx - 1 ||
                levelmap[indexinlevelarray] == 999 && zi == maxz - 1)
            {
        ...
        public void buildWallsRerolled(int x, int y, int z)
        {
            ...
            if (adjacenttiles[indexinarray] == 1001 && x == minx ||
               ...
               adjacenttiles[indexinarray] == 1001 && x == maxx ||
               adjacenttiles[indexinarray] == 1001 && z == maxz)
            {
                if (adjacenttiles[indexinarray] == 1001 && x == minx)
                {
