...
namespace sccsr15forms
{
    public class sclevelgenvert
    {
        ...
        public int[] buildchunkmaps(float[] currentPosition, int[] _chunkPos, int typeofterraintiles, tutorialcubeaschunk componentparent_, int levelofdetail_) //, out int vertexNum, out int indicesNum
        //public void startBuildingArray(Vector4 currentPosition, out sclevelgenchunk.DVertex[] vertexArray, out int[] triangleArray, out int[] mapper, int padding0_, int padding1_, int padding2_, int numberOfObjectInWidth_, int numberOfObjectInHeight_, int numberOfObjectInDepth_, int numberOfInstancesPerObjectInWidth_, int numberOfInstancesPerObjectInHeight_, int numberOfInstancesPerObjectInDepth_, int width_, int height_, int depth_, float planeSize_, sclevelgenchunkPrim componentparentprim_, sclevelgenchunk componentparentinstance_, sclevelgenchunk_instances componentparentthischunk_, int fullface_, int voxeltype_)
        {
            ...
            */
                ...
                for (int x = 0; x < width; x++)
                {
                    for (int y = 0; y < height; y++)
                    {
                        for (int z = 0; z < depth; z++)
                        {
                            ...
                            //noiseXZ *= OriginalSimplexNoise.Noise((((x * levelgenmapsplanesize) + chunkPos.X + seed) / _detailScale) * _heightScale, (((z* levelgenmapsplanesize) + chunkPos.Z + seed) / _detailScale) * _heightScale);
                            ...
                            if (chunkPos[1] == LevelGenerator4.wallheightsize)
                            {
                            ...
                            if (y == height - 1 && chunkPos[1] == LevelGenerator4.wallheightsize)
                            {
                                map[x + width * (y + height * z)] = 1;
                            }
            ...
            if (typeofterraintiles != 15 && typeofterraintiles != 0 && chunkPos[1] != 0)
            {
                for (int x = 0; x < width; x++)
                {
                    for (int y = 0; y < height; y++)
                    {
                        for (int z = 0; z < depth; z++)
                        {
                            ...
                            float noiseXZ = somenoisevalue;
                            //noiseXZ *= OriginalSimplexNoise.Noise((((x * levelgenmapsplanesize) + chunkPos[0] + seed) / _detailScale) * _heightScale, (((z* levelgenmapsplanesize) + chunkPos.Z + seed) / _detailScale) * _heightScale);
                        ...
                        for (int x = 0; x < width; x++)
                        {
                            ...
                            for (int y = 0; y < height; y++)
                            {
                                ...
                                for (int z = 0; z < width; z++)
                                {
                                    ...
                                    if (noiseValue > 0.2f && y < LevelGenerator4.wallheightsize)
                                    {
                                        map[x + width * (y + height * z)] = 1;
                                    }
                        ...
                        //if (block == 1)
                        {
                            ...
                            if (IsTransparent(xi - 1, yi, zi))
                            {
                                ...
                                else if (xi == 0)
                                {
                                    //Vector3 somechunkpos = chunkPos;
                                    //somechunkpos.X -= 1.0f;
                                    //sclevelgenvert someChunk = (sclevelgenvert)componentparent.getChunklod0(somechunkpos.X, somechunkpos.Y, somechunkpos.Z, out arrayindex);
                                    ...
                                    else
                                    {
                                        ...
                                        /*
                                        if (listofchunksadjacent[0] == null && levelofdetail == 1 && chunkPos.Y == levellimitfloory) //&& levelofdetail == 1
                                        {
                                            buildTopLeft(xi, yi, zi, 1.0f);
                                        }
                                        else if (listofchunksadjacent[0] == null && levelofdetail == 1 && chunkPos.Y == sclevelgen.wallheightsize)
                                        {
                                            //dont build
                                        }
                                        else
                                        {
                                            if (listofchunksadjacentfloor[0] != null && chunkPos.Y != sclevelgen.wallheightsize)
                                            {
                                                buildTopLeft(xi, yi, zi, 1.0f);
                                            }
                                        }*/
                            ...
                            if (IsTransparent(xi, yi - 1, zi))
                            {
                                ...
                                else if (yi == 0)
                                {
                                    ...
                                    if (listofchunksadjacent[4] != null && levelofdetail == 1 && chunkPos[1] != levellimitfloory) //&& levelofdetail == 1
                                    {
                                        //Console.WriteLine(chunkPos + " " + someChunk.chunkPos);
                                    ...
                                    else
                                    {
                                        ...
                                        if (listofchunksadjacent[4] == null && levelofdetail == 1 && chunkPos[1] == sclevelgen.wallheightsize) //&& levelofdetail == 1
                                        {
                                            buildBottomFace(xi, yi, zi, 1.0f);
                                        }
