...
namespace sccsr15forms
{
    public class sccslevelgen
    {
            ...
            for (var x = minx; x <= maxx; x++)
            {
                for (var y = miny; y <= maxy; y++)
                {
                    for (var z = minz; z <= maxz; z++)
                    {
                        ...
                        int indexinarray = xx + (minx + maxx) * (yy + (miny + maxy) * zz); //y is always 0 on floor tiles
                ...
                for (var y = miny; y <= maxy; y++)
                {
                    for (var z = minz; z <= maxz; z++)
                    {
                        ...
                        else
                        {
                            ...
                            int indexinlevelarray = xx + (minx + maxx) * (yy + (miny + maxy) * zz); //y is always 0 on floor tiles
                                    ...
                                    for (int xi = -neighbooraddx; xi <= neighbooraddx; xi++)
                                    {
                                        //for (int yi = y; yi <= y; yi++)
                                        {
                                            for (int zi = -neighbooraddz; zi <= neighbooraddz; zi++)
                                            {
                                                ...
                                                int indexinarray = xxi + (minx + maxx) * (yyi + (miny + maxy) * zzi); //y is always 0 on floor tiles
            ...
            for (int x = -1; x <= 1; x++)
            {
                for (int z = -1; z <= 1; z++)
                {
                        ...
                        checkx == xi - (1) && checkz == zi - (1))
                    {
                        ...
                        int indexinarray0 = xiii + (minx + maxx) * (yi + (miny + maxy) * ziii); //y is always 0 on floor tiles
                        ...
                        if (indexinarray0 < somewidth * someheight * somedepth)
                        {
                            if (levelmap[indexinarray0] == 999 )
                            {
                                ...
                                int indextile = xii + (minx + maxx) * (yi + (miny + maxy) * zii);
                                ...
                                indextile = xii + (minx + maxx) * (yi + (miny + maxy) * zii);
                                    ...
                                    istypeoflb == 0 && istypeofb == 0 && istypeofrb == 0)
                                {
                                    ...
                                    levelmapsortingtiles[indexinarray0] = 0;
                                        ...
                                        istypeoflb == -1 || istypeofb == -1 || istypeofrb == -1)
                                {
                                    ...
                                    levelmapsortingtiles[indexinarray0] = 998;
                                }
                                else
                                {
                                    
                                    levelmapsortingtiles[indexinarray0] = 997;
                                }
                            }
                        }
                    }
        ...
        void buildsomefloortiles(int x, int y, int z) //, int xx, int yy, int zz, int mainindexofintinmap
        {
            ...
            int indextile = xii + (minx + maxx) * (y + (miny + maxy) * zii);
            ...
            indextile = xii + (minx + maxx) * (y + (miny + maxy) * zii);
        ...
        public void buildWallsRerolled(int x, int y, int z)
        {
            ...
            if (indextile < somewidth * someheight * somedepth)
            {
                ...
                else if (levelmapsortingtiles[indextile] == 997)
                {
                    istypeofl = 2;
                }
                else
