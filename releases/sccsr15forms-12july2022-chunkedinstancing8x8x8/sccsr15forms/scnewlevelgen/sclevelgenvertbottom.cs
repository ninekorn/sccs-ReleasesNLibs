...
{
    public class sclevelgenvertbottom
    {
        ...
        sclevelgenvertbottom[] listofchunksadjacent = new sclevelgenvertbottom[6];
        sclevelgenvertbottom[] listofchunksadjacentfloor = new sclevelgenvertbottom[6];
