...
namespace sccsr15forms
{
    public class sc_voxel_shader_final                 // 228 lines
    {
        ...
        public sccsr15forms.sc_voxel.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccsr15forms.sc_voxel.DLightBuffer[] DLightBuffer)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                */
                ...
                vsFileName = sccsr15forms.Properties.Resources.texture_voxelVS;// "../../../_sc_instance_shader/" + "texture.vs";
                psFileName = sccsr15forms.Properties.Resources.texture_voxelPS;// "../../../_sc_instance_shader/" + "texture.ps";

                //vertexShaderByteCode = ShaderBytecode.Compile(vsFileName, "TextureVertexShader", "vs_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                //pixelShaderByteCode = ShaderBytecode.Compile(psFileName, "TexturePixelShader", "ps_4_0", ShaderFlags.None, SharpDX.D3DCompiler.EffectFlags.None);
                var gsFileName = sccsr15forms.Properties.Resources.geoshaderikrig;// "../../../_sc_instance_shader/" + "texture.ps";
