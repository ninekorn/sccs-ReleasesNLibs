...
using scmessageobjectjitter = sccsr15forms.scmessageobjectjitter;
using Jitter;

using Ab3d.OculusWrap;

//using directx = sccsr15forms.scdirectx;
...
namespace sccsr15forms
{
    public class sccsikvoxellimbs : IDisposable
    {
        ...
        public scmessageobjectjitter[][] createikbody(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, Matrix worldmatofobj_, int human_inst_rig_x, int human_inst_rig_y, int human_inst_rig_z, int grabtargetitem_, Matrix finalrotationmatrix)
        {
            ...
            initialmatrix.M41 = 0;
            initialmatrix.M42 = -0.38f + initchunkposition.Y + updateprim._hmdPoser.Y; //-0.485f
            initialmatrix.M43 = 0;
            initialmatrix.M44 = 1;
            ...
            //_hasinit0 = _player_pelvis.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.125f, 0.05f, 0.065f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 9, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_pelvis[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.05f, 0.065f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccsr15forms.directx.BodyTag.PlayerPelvis, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //float voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            ...
            //_player_pelvis[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.05f, 0.065f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerPelvis, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_pelvis[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz,
                new Vector4(r, g, b, a), _inst_p_pelvis_x, _inst_p_pelvis_y, _inst_p_pelvis_z,
                Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerPelvis,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
            ...
            //_hasinit0 = _player_torso.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f                                                                                                                                                                                                                                                                                        //_hasinit0 = _player_torso.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_player_torso[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), _inst_p_torso_x, _inst_p_torso_y, _inst_p_torso_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccsr15forms.directx.BodyTag.PlayerTorso, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            _player_torso[0][0].Initialize(
                directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                ...
                _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerTorso,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
                voxel_general_size,
            ...
            //_player_torso[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.125f, 0.175f, 0.065f, new Vector4(r, g, b, a), _inst_p_torso_x, _inst_p_torso_y, _inst_p_torso_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerTorso, 2, 9, 2, 2, 2, 2, 45, 44, 60, 59, 10, 9, 0.0025f, new Vector3(0, 0, 0), 500); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            _player_head[0][0].Initialize(
                ...
                _mass,
                is_static,
                sccsr15forms.directx.BodyTag.PlayerHead,
            ...
            _SC_modL_head_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
            ...
            _SC_modL_torso_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_pelvis_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
        ...
        public scmessageobjectjitter[][] setikbodytargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, Matrix hmd_matrix_current, Matrix extramatrix, Matrix hmdmatrixcurrentforpelvis)
        {
            ...
            for (int _iterator = 0; _iterator < 1; _iterator++) // _player_torso[0][0]._arrayOfInstances.Length
            {
                ...
                {
                    tempOffset.X = updateprim.viewpositionorigin.X;
                    //tempOffset.Y = _player_head[0][0]._arrayOfInstances[0]._TEMPPIVOT.M42;
                    tempOffset.Y = updateprim.viewpositionorigin.Y;
                    tempOffset.Z = updateprim.viewpositionorigin.Z;
        ...
        public scmessageobjectjitter[][] ikbodyrender(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {
            ...
            _cuber001.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_torso(directx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_torso_BUFFER, _cuber001);
            _cuber001 = _player_pelvis[0][0];
            _cuber001.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_pelvis(directx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_pelvis_BUFFER, _cuber001);

            //_player_head[0][0].Render(directx.D3D.Device.ImmediateContext);
            //updatePrim._shaderManager._rend_torso(directx.D3D.Device.ImmediateContext, _player_head[0][0].IndexCount, _player_head[0][0].InstanceCount, _player_head[0][0]._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_torso_BUFFER, _player_head[0][0]);
        ...
        public scmessageobjectjitter[][] createikarm(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxelindex, int human_inst_limbs_x, int human_inst_limbs_y, int human_inst_limbs_z, int grabtargetitem_, int typeoflimb, sccsikvoxellimbs ikvoxellimb, Matrix finalrotationmatrix)
        {
            ...
            //_hasinit0 = _player_rght_shldr.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 9, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_rght_shldr[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_shoulder_x, _inst_p_r_shoulder_y, _inst_p_r_shoulder_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccsr15forms.directx.BodyTag.PlayerShoulderRight, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            float _mass = 100;
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            _type_of_cube = 2;
            ...
            //_player_rght_shldr[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerShoulderRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            //_player_rght_shldr[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_shoulder_x, _inst_p_r_shoulder_y, _inst_p_r_shoulder_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerShoulderRight, 9, 9, 9, 9, 9, 9, 9, 9, 9, 20, 19, 20, 19, 20, 19, voxel_general_size, new Vector3(0, 0, 0), 17, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_shldr[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                ...
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerShoulderRight,
            ...
            _world_containment_grid_list_RH[0][0].Initialize(directx.D3D, 10, 10, _size_screen, 10, 10, _grid_size_x, _grid_size_y, _grid_size_z, new Vector4(r, g, b, a), _inst_terrain_tile_x, _inst_terrain_tile_y, _inst_terrain_tile_z, updateSec.HWND, _object_worldmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, sccsr15forms.directx.BodyTag.sc_containment_grid, true, 0, 10, 0, 0, 0, 0, 0, 0, false, true, false, false, false, false); //, "terrainGrassDirt.bmp" //0.00035f
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    //_world_containment_grid_list_RH[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0.1f, 1, 1, _inst_terrain_tile_x, _inst_terrain_tile_y, _inst_terrain_tile_z, new Vector4(r, g, b, a), _inst_screen_x, _inst_screen_y, _inst_screen_z, updateSec.HWND, _object_worldmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, sccsr15forms.directx.BodyTag.sc_containment_grid, false, 1, 100, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            //_hasinit0 = _player_rght_upper_arm.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_rght_upper_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a), _inst_p_r_upperarm_x, _inst_p_r_upperarm_y, _inst_p_r_upperarm_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccsr15forms.directx.BodyTag.PlayerUpperArmRight, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            //13, 12, 40, 39, 13, 12,
            ...
            //_player_rght_upper_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerUpperArmRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_upper_arm[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
            ...
            sccsr15forms.directx.BodyTag.PlayerUpperArmRight,
            ...
            */
            ...
            //_player_rght_upper_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerUpperArmRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_lower_arm[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
            _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
            sccsr15forms.directx.BodyTag.PlayerLowerArmLeft,
            //9, 9, 9, 14, 14, 14, 14, 14, 14, 13, 12, 40, 39, 13, 12,
            minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
            voxel_general_size, new Vector3(0, 0, 0), distance, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            //_hasinit0 = _player_rght_elbow_target.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_rght_elbow_target[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.075f, 0.075f, 0.075f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccsr15forms.directx.BodyTag.PlayerRightElbowTarget, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            _type_of_cube = 2;
            _player_rght_elbow_target[0][0] = new sc_voxel();
            _player_rght_elbow_target[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                ...
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerRightElbowTarget,
                      minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr, 
            ...
            _player_rght_elbow_target_two[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz,
                ...
                _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerRightElbowTargettwo,
            ...
            _player_rght_elbow_target_three[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, 
                new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, 
                _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerRightElbowTargettwo,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
            ...
            _player_rght_hnd[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerHandRight,
            ...
            _SC_modL_rght_shldr_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_elbow_target_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_elbow_target_two_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_upper_arm_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
                ...
                lightPosition = lightpos,
                padding1 = 100
            }; _SC_modL_rght_lower_arm_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_rght_hnd_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
            ...
            _SC_modL_r_hand_grab_BUFFER[0] = new sccsr15forms.sc_voxel.DLightBuffer()
            {
                ambientColor = ambientColor,
                diffuseColor = diffuseColour,
                lightDirection = dirLight,
        ...
        public scmessageobjectjitter[][] createikfingers(scmessageobjectjitter[][] _sc_jitter_tasks, int tempMultiInstancePhysicsTotal, Vector3 ikarmpivotinitposition, sccsikvoxellimbs parentobject_, int somechunkpriminstanceikarmvoxelindex, int human_inst_limbs_x, int human_inst_limbs_y, int human_inst_limbs_z, int grabtargetitem_, int typeoflimb, sccsikvoxellimbs ikvoxellimb, int somechunkpriminstanceikfingervoxelindex)
        {
            ...
            //_player_rght_upper_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerUpperArmRight, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_upper_arm[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
            _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
            sccsr15forms.directx.BodyTag.PlayerUpperArmRight,
            //9, 9, 9, 14, 14, 14, 14, 14, 14, 13, 12, 40, 39, 13, 12,
            ...
            */
            ...
            //_hasinit0 = _player_lft_lower_arm.Initialize(_directx.D3D, _directx.D3D.SurfaceWidth, _directx.D3D.SurfaceHeight, _size_screen, 1, 1, 0.035f, 0.08250f, 0.035f, new Vector4(r, g, b, a), instX, instY, instZ, Hwnd, initialmatrix, 0, offsetPosX, offsetPosY, offsetPosZ, vertOffsetX, vertOffsetY, vertOffsetZ); //, "terrainGrassDirt.bmp" //0.00035f
            //_hasinit0 = _player_lft_lower_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.08250f, 0.035f, new Vector4(r, g, b, a), _inst_p_l_lowerarm_x, _inst_p_l_lowerarm_y, _inst_p_l_lowerarm_z, Hwnd, initialmatrix, 2, offsetPosX, offsetPosY, offsetPosZ, World, sccsr15forms.directx.BodyTag.PlayerLowerArmLeft, _static, 1, _mass, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
            //voxel_general_size =  voxeliknewsize;
            //voxel_type = 0;
            _type_of_cube = 2;
            ...
            // _player_lft_lower_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.05f, 0.05f, 0.05f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerLowerArmLeft, 10, 10, 10, 10, 10, 10, 4, 3, 20, 19, 20, 19, 0.0025f, Vector3.Zero, 300); //, "terrainGrassDirt.bmp" //0.00035f
            _player_rght_lower_arm[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a),
                _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
                sccsr15forms.directx.BodyTag.PlayerLowerArmRight,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
                voxel_general_size, new Vector3(0, 0, 0), 30, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
                                                                                                                               //_player_rght_lower_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.08250f, 0.035f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerLowerArmRight, 7, 7, 9, 18, 21, 25, 10, 9, 33, 32, 11, 10, voxel_general_size, new Vector3(0, 0, 0), 72, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f

            //FOR VOXEL ARROW
            //_player_lft_lower_arm[0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 1, 1, 1, 0.035f, 0.08250f, 0.035f, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Hwnd, initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, World, _mass, false, sccsr15forms.directx.BodyTag.PlayerLowerArmLeft, 9, 9, 9, 18, 17, 100, 3, 10, 33, 32, 11, 10, voxel_general_size, new Vector3(0, 0, 0), 70, vertoffsetx, vertoffsety, vertoffsetz, _addToWorld, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            ...
            _player_rght_elbow_target[0][0] = new sc_voxel();
            _player_rght_elbow_target[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1,
            ...
            _type_of_cube = 2;
            _player_rght_elbow_target_two[0][0] = new sc_voxel();
            _player_rght_elbow_target_two[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight, 0, 1, 1, 1,
                 sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, 
                sccsr15forms.directx.BodyTag.PlayerRightElbowTargettwo,
                minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr, voxel_general_size, Vector3.Zero, 75, vertoffsetx, vertoffsety, vertoffsetz, 0, voxel_type); //, "terrainGrassDirt.bmp" //0.00035f
            worldMatrix_instances_r_elbow_target_two[0][0] = new Matrix[_inst_p_r_hand_x * _inst_p_r_hand_y * _inst_p_r_hand_z];
            for (int i = 0; i < worldMatrix_instances_r_elbow_target_two[0][0].Length; i++)
            {
            ...
            _type_of_cube = 2;
            _player_rght_elbow_target_three[0][0] = new sc_voxel();
            _player_rght_elbow_target_three[0][0].Initialize(directx.D3D, directx.D3D.SurfaceWidth, directx.D3D.SurfaceHeight,
                0, 1, 1, 1, sizelowerax, sizeloweray, sizeloweraz, new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, Program.consoleHandle,
                initialmatrix, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static, sccsr15forms.directx.BodyTag.PlayerRightElbowTargettwo,
               minx, miny, minz, diagmaxx, diagmaxy, diagmaxz, diagminx, diagminy, diagminz, chunkwidthl, chunkwidthr, chunkheightl, chunkheightr, chunkdepthl, chunkdepthr,
        ...
        public scmessageobjectjitter[][] setiktargetnlimbspositionsNrotations(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix, sc_voxel mainarmparentmeshobject, Vector3 lightpos_, Vector3 dirLight_, Matrix finalRotationMatrix_, sc_voxel mainarmparentmeshobjectmain, sccsikvoxellimbs ikvoxelbody, int somechunkpriminstanceikarmvoxelindex, Matrix hmd_matrix_current, Matrix extramatrix, Vector3[] directionvectoroffsets_, Vector3 targetfootleft, Vector3 targetfootright, int typeoflimb)
        {
            ...
            for (int _iterator = 0; _iterator < 1; _iterator++) // //_player_rght_hnd[0][0]._arrayOfInstances.Length
            {
                ...
                if (Program.usethirdpersonview == 0)
                {
                    tempOffset.X = updateprim.viewPosition.X;
                    tempOffset.Y = updateprim.viewPosition.Y;
                    tempOffset.Z = updateprim.viewPosition.Z;
                    /*
                ...
                float someplanesizediv = 1 / updateSec._planeSize;

                int someposdiffx = (int)(((float)Math.Floor(OFFSETPOS.X * someplanesizediv) / someplanesizediv) / (updateSec._planeSize));
                int someposdiffy = (int)(((float)Math.Floor(OFFSETPOS.Y * someplanesizediv) / someplanesizediv) / (updateSec._planeSize));
                int someposdiffz = (int)(((float)Math.Floor(OFFSETPOS.Z * someplanesizediv) / someplanesizediv) / (updateSec._planeSize));
            ...
            for (int _iterator = 0; _iterator < 1; _iterator++) // //_player_rght_hnd[0][0]._arrayOfInstances.Length
            {
                ...
                */
                ...
                if (somechunkpriminstanceikarmvoxelindex == 0)
                {
                    ...
                    if (sccsr15forms.updatePrim.typeofsensortouchR != 9999999)
                    {
                        if (somechunkpriminstanceikfingervoxelindex != 3)
                        {
                            //Vector3 tempVect = Vector3.Zero;
                            if (sccsr15forms.updatePrim.handTriggerRight[1] > 0.00000001f)
                            {
                                somevec0 = (somevec0) + (-dirshoulderright0 * ((lengthOfHandheight * sccsr15forms.updatePrim.handTriggerRight[1] * 0.5f)));
                            }
                            else
                            {
                            ...
                            if (sccsr15forms.updatePrim.handTriggerRight[1] > 0.00000001f) ///when over 0.52f
                            {
                                somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * (1 - sccsr15forms.updatePrim.handTriggerRight[1]) * 0.5f)));
                            }
                            else
                            {
                ...
                else if (somechunkpriminstanceikarmvoxelindex == 3)
                {
                    ...
                    if (Program.useOculusRift == 1)
                    {
                        if (sccsr15forms.updatePrim.typeofsensortouchL != 9999999)
                        {
                            if (somechunkpriminstanceikfingervoxelindex != 3)
                            {
                                //Vector3 tempVect = Vector3.Zero;
                                if (sccsr15forms.updatePrim.handTriggerLeft[0] > 0.00000001f)
                                {
                                    somevec0 = (somevec0) + (dirshoulderright0 * ((lengthOfHandheight * sccsr15forms.updatePrim.handTriggerLeft[0] * 0.5f)));
                                }
                                else
                                {
                                    somevec0 = (somevec0) + (dirshoulderright0 * ((lengthOfHandheight * 0.05f * 1.0923f)));
                                ...
                                if (sccsr15forms.updatePrim.handTriggerLeft[0] > 0.00000001f) ///when over 0.52f
                                {
                                    somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * (1 - sccsr15forms.updatePrim.handTriggerLeft[0]) * 0.5f)));
                                }
                                else
                                {
                                    somevec0 = (somevec0) + (dirshoulderforward0 * ((lengthOfHandheight * 0.5f * 1.0923f)));
        ...
        public scmessageobjectjitter[][] ikarmrender(scmessageobjectjitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, Matrix oriProjectionMatrix)
        {
            ...
            _player_rght_hnd[0][0].Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_hnd(directx.D3D.Device.ImmediateContext, _player_rght_hnd[0][0].IndexCount, _player_rght_hnd[0][0].InstanceCount, _player_rght_hnd[0][0]._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _player_rght_hnd[0][0]);
            var _cuber001 = _player_rght_shldr[0][0];
            _cuber001.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_shldr(directx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_shldr_BUFFER, _cuber001);
            _cuber001 = _player_rght_lower_arm[0][0];
            _cuber001.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_lower_arm(directx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_lower_arm_BUFFER, _cuber001);
            _cuber001 = _player_rght_upper_arm[0][0];
            _cuber001.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_upper_arm(directx.D3D.Device.ImmediateContext, _cuber001.IndexCount, _cuber001.InstanceCount, _cuber001._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_upper_arm_BUFFER, _cuber001);
            //IK TARGETS UPPER BODY.


            /*
            var _cuber01 = _player_rght_elbow_target[0][0];
            _cuber01.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_elbow_targ(directx.D3D.Device.ImmediateContext, _cuber01.IndexCount, _cuber01.InstanceCount, _cuber01._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _cuber01);

            _cuber01 = _player_rght_elbow_target_two[0][0];
            _cuber01.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_elbow_targ_two(directx.D3D.Device.ImmediateContext, _cuber01.IndexCount, _cuber01.InstanceCount, _cuber01._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_rght_hnd_BUFFER, _cuber01);
            _cuber01 = _player_r_hand_grab[0][0];
            _cuber01.Render(directx.D3D.Device.ImmediateContext);
            updatePrim._shaderManager._rend_rgt_hnd(directx.D3D.Device.ImmediateContext, _cuber01.IndexCount, _cuber01.InstanceCount, _cuber01._POSITION, viewMatrix, projectionMatrix, null, _SC_modL_r_hand_grab_BUFFER, _cuber01);
