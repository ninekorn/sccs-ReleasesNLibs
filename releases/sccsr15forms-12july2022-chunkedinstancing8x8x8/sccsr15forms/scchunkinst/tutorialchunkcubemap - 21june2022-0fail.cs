...
namespace sccsr15forms
{
    public class tutorialchunkcubemap
    {
        ...
        //int maxveclengthalt;
        public void setmapforfirstverts(int typeofterraintiles_, tutorialcubeaschunkinst componentparent_, int levelofdetail_, int maxveclengthalt, int facetype,
        ...
        //int maxveclengthalt;
        public void insertdimensionsinint(int typeofterraintiles_, tutorialcubeaschunkinst componentparent_, int levelofdetail_,int maxveclengthalt, int facetype,
           out double m11, out double m12, out double m13, out double m14,
           out double m21, out double m22, out double m23, out double m24, out double m31, out double m32, out double m33, out double m34, out double m41, out double m42, out double m43, out double m44,
            ...
            if (block == 1) //|| block == 2
            {
                ...
                //if (IsTransparent(xi, yi + 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        ...
                        someindextop = someixtop + width * ((someiytop) + height * (someiztop));
                        ...
                        //if (someChunk.IsTransparent(width - 1, yi, zi))
                        {
                            ...
                            if (IsTransparent(xi - 1, yi, zi))// && someChunk.IsTransparent(width - 1, yi, zi))
                            {
                                ...
                                if (getChunklod0Vertexint1(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint1(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint1(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint1(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                                {
                                    //var indexofmapvertindexfordimsone = firstvertx + width * ((firstverty) + height * (firstvertz));
                                    //var indexofmapvertindexfordimsone = oneVertIndexX + width * ((oneVertIndexY) + height * (oneVertIndexZ));
                                    someindexleft = someixleft + width * ((someiyleft) + height * (someizleft));
                                    ...
                                    //Vector3 firstvert = new Vector4(oneVertIndexX, oneVertIndexY, oneVertIndexZ, 1));
                                    mapfirstvertxleft[someindexleft] = oneVertIndexX;
                                    mapfirstvertyleft[someindexleft] = oneVertIndexY;
                                    mapfirstvertzleft[someindexleft] = oneVertIndexZ;

                                    ////Console.WriteLine("/v1d:" + vert0.Z + "/v2d:" + vert1.Z);
                                    ////Console.WriteLine("/v1h:" + vert0.Y + "/v2h:" + vert2.Y);

                                    widthdimleft[someindexleft] = (int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert2.X)); //0  3 == 3 
                                    heightdimleft[someindexleft] = (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
                                    depthdimleft[someindexleft] = (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi + 1, yi, zi))
                {
                    ...
                    if (getChunklod0Vertexint2(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint2(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint2(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint2(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        //var indexofmapvertindexfordimsone = firstvertx + width * ((firstverty) + height * (firstvertz));
                        //var indexofmapvertindexfordimsone = oneVertIndexX + width * ((oneVertIndexY) + height * (oneVertIndexZ));
                        someindexright = someixright + width * ((someiyright) + height * (someizright));

                        ////Console.WriteLine("index:" + someindex);

                        mapvertindexfordims[someindexright] = 1;

                        vertexlistright.Add(new tutorialcubeaschunkinst.DVertex()
                        {
                            position = new Vector4(oneVertIndexX * planeSize * levelofdetail * levelofdetailmul, oneVertIndexY * planeSize * levelofdetail * levelofdetailmul, oneVertIndexZ * planeSize * levelofdetail * levelofdetailmul, 1) + chunkoriginpos,
                            indexPos = new Vector4(xi, yi, zi, 1),
                            color = rightfacecolor,
                        ...
                        //Vector3 firstvert = new Vector4(oneVertIndexX, oneVertIndexY, oneVertIndexZ, 1));
                        mapfirstvertxright[someindexright] = oneVertIndexX;
                        mapfirstvertyright[someindexright] = oneVertIndexY;
                        mapfirstvertzright[someindexright] = oneVertIndexZ;
                        ...
                        widthdimright[someindexright] = (int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert2.X)); //0  3 == 3 
                        heightdimright[someindexright] = (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
                        depthdimright[someindexright] = (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
                        ...
                        someizright++;
                        if (someizright == depth)
                        {
                            someiyright++;
                            someizright = 0;
                        }
                        if (someiyright == height)
                        {
                            someixright++;
                            someiyright = 0;
                        }
                        if (someixright == width)
                        {
                            someixright = 0;
                        }
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi, yi, zi + 1))
                {
                    ...
                    if (getChunklod0Vertexint3(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint3(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint3(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint3(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        //var indexofmapvertindexfordimsone = firstvertx + width * ((firstverty) + height * (firstvertz));
                        //var indexofmapvertindexfordimsone = oneVertIndexX + width * ((oneVertIndexY) + height * (oneVertIndexZ));
                        someindexfront = someixfront + width * ((someiyfront) + height * (someizfront));

                        ////Console.WriteLine("index:" + someindex);

                        mapvertindexfordims[someindexfront] = 1;

                        vertexlistfront.Add(new tutorialcubeaschunkinst.DVertex()
                        {
                            position = new Vector4(oneVertIndexX * planeSize * levelofdetail * levelofdetailmul, oneVertIndexY * planeSize * levelofdetail * levelofdetailmul, oneVertIndexZ * planeSize * levelofdetail * levelofdetailmul, 1) + chunkoriginpos,
                            indexPos = new Vector4(xi, yi, zi, 1),
                            color = frontfacecolor,
                        ...
                        //Vector3 firstvert = new Vector4(oneVertIndexX, oneVertIndexY, oneVertIndexZ, 1));
                        mapfirstvertxfront[someindexfront] = oneVertIndexX;
                        mapfirstvertyfront[someindexfront] = oneVertIndexY;
                        mapfirstvertzfront[someindexfront] = oneVertIndexZ;
                        ...
                        widthdimfront[someindexfront] = (int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert1.X)); //0  3 == 3 
                        heightdimfront[someindexfront] = (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
                        depthdimfront[someindexfront] = (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
                        ...
                        someizfront++;
                        if (someizfront == depth)
                        {
                            someiyfront++;
                            someizfront = 0;
                        }
                        if (someiyfront == height)
                        {
                            someixfront++;
                            someiyfront = 0;
                        }
                        if (someixfront == width)
                        {
                            someixfront = 0;
                        }
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi, yi, zi - 1))
                {
                    ...
                    if (getChunklod0Vertexint4(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint4(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint4(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint4(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        //var indexofmapvertindexfordimsone = firstvertx + width * ((firstverty) + height * (firstvertz));
                        //var indexofmapvertindexfordimsone = oneVertIndexX + width * ((oneVertIndexY) + height * (oneVertIndexZ));
                        someindexback = someixback + width * ((someiyback) + height * (someizback));

                        ////Console.WriteLine("index:" + someindex);

                        mapvertindexfordims[someindexback] = 1;

                        vertexlistback.Add(new tutorialcubeaschunkinst.DVertex()
                        {
                            position = new Vector4(oneVertIndexX * planeSize * levelofdetail * levelofdetailmul, oneVertIndexY * planeSize * levelofdetail * levelofdetailmul, oneVertIndexZ * planeSize * levelofdetail * levelofdetailmul, 1) + chunkoriginpos,
                            indexPos = new Vector4(xi, yi, zi, 1),
                            color = backfacecolor,
                        ...
                        //Vector3 firstvert = new Vector4(oneVertIndexX, oneVertIndexY, oneVertIndexZ, 1));
                        mapfirstvertxback[someindexback] = oneVertIndexX;
                        mapfirstvertyback[someindexback] = oneVertIndexY;
                        mapfirstvertzback[someindexback] = oneVertIndexZ;
                        ...
                        widthdimback[someindexback] = (int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert1.X)); //0  3 == 3 
                        heightdimback[someindexback] = (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
                        depthdimback[someindexback] = (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi, yi - 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint5(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint5(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint5(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint5(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        //var indexofmapvertindexfordimsone = firstvertx + width * ((firstverty) + height * (firstvertz));
                        //var indexofmapvertindexfordimsone = oneVertIndexX + width * ((oneVertIndexY) + height * (oneVertIndexZ));
                        someindexbottom = someixbottom + width * ((someiybottom) + height * (someizbottom));

                        ////Console.WriteLine("index:" + someindex);

                        mapvertindexfordims[someindexbottom] = 1;

                        vertexlistbottom.Add(new tutorialcubeaschunkinst.DVertex()
                        {
                            position = new Vector4(oneVertIndexX * planeSize * levelofdetail * levelofdetailmul, oneVertIndexY * planeSize * levelofdetail * levelofdetailmul, oneVertIndexZ * planeSize * levelofdetail * levelofdetailmul, 1) + chunkoriginpos,
                            indexPos = new Vector4(xi, yi, zi, 1),
                            color = bottomfacecolor,
                        ...
                        //Vector3 firstvert = new Vector4(oneVertIndexX, oneVertIndexY, oneVertIndexZ, 1));
                        mapfirstvertxbottom[someindexbottom] = oneVertIndexX;
                        mapfirstvertybottom[someindexbottom] = oneVertIndexY;
                        mapfirstvertzbottom[someindexbottom] = oneVertIndexZ;
                        ...
                        widthdimbottom[someindexbottom] = (int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert2.X)); //0  3 == 3 
                        heightdimbottom[someindexbottom] = (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
                        depthdimbottom[someindexbottom] = (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
                        ...
                        someizbottom++;
                        if (someizbottom == depth)
                        {
                            someiybottom++;
                            someizbottom = 0;
                        }
                        if (someiybottom == height)
                        {
                            someixbottom++;
                            someiybottom = 0;
                        }
                        if (someixbottom == width)
                        {
                            someixbottom = 0;
                        }
