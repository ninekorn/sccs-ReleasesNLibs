            ...
            for (int x = 0; x < 4; x++)
            {
                for (int y = 0; y < 4; y++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        ...
                        int somewidth = widthdimtop[index];// widthdim[index];
                        int someheight = heightdimtop[index];
                        int somedepth = depthdimtop[index];// depthdim[index];
            ...
            for (int x = 0; x < 4; x++)
            {
                for (int y = 0; y < 4; y++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        ...
                        if (facetype == 0)
                        {
                            currentByte = (((somevertx * 100) + (somevertz)));
                        }
                        else if (facetype == 1)
                        {
                            currentByte = (((someverty * 100) + (somevertz)));
                        }
                        else if (facetype == 2)
                        {
                            currentByte = (((someverty * 100) + (somevertz)));
                        ...
                        {
                            currentByte = (((someverty * 100) + (somevertx)));
                        }
                        else if (facetype == 4)
                        {
                            currentByte = (((someverty * 100) + (somevertx)));
            ...
            for (int x = 0; x < 4; x++)
            {
                for (int y = 0; y < 4; y++)
                {
                    for (int z = 0; z < 4; z++)
                    {
                        ...
                        if (facetype == 0)
                        {
                            currentByte = (((somewidth * 100) + (somedepth)));
                        }
                        else if (facetype == 1)
                        {
                            currentByte = (((someheight * 100) + (somedepth)));
                        }
                        else if (facetype == 2)
                        {
                            currentByte = (((someheight * 100) + (somedepth)));
                        ...
                        {
                            currentByte = (((someheight * 100) + (somewidth)));
                        }
                        else if (facetype == 4)
                        {
                            currentByte = (((someheight * 100) + (somewidth)));
                ...
                //if (IsTransparent(xi, yi + 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                       ...
                       //Console.WriteLine("/x:" + vert2.X + "/y:" + vert2.Y  + "/z:" + vert2.Z);
                        ...
                        heightdimtop[someindextop] = oneVertIndexY;// (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
                        depthdimtop[someindextop] = (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));


                        //Console.WriteLine("/h:" + oneVertIndexY);
                        ...
                        //if (someChunk.IsTransparent(width - 1, yi, zi))
                        {
                            ...
                            if (IsTransparent(xi - 1, yi, zi))// && someChunk.IsTransparent(width - 1, yi, zi))
                            {
                                ...
                                if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                                {
                                    ...
                                    widthdimtop[someindexleft] = oneVertIndexX;//(int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert2.X)); //0  3 == 3 
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi + 1, yi, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        ...
                        widthdimtop[someindexright] = oneVertIndexX;//(int)Math.Abs(Math.Abs(vert0.X) - Math.Abs(vert2.X)); //0  3 == 3 
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi, yi, zi + 1))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        ...
                        depthdimtop[someindexfront] = oneVertIndexZ;//(int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi, yi, zi - 1))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        ...
                        depthdimtop[someindexback] = oneVertIndexZ;// (int)Math.Abs(Math.Abs(vert0.Z) - Math.Abs(vert1.Z));
            ...
            if (block == 1) //|| block == 2
            {
                if (IsTransparent(xi, yi - 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        ...
                        heightdimtop[someindexbottom] = oneVertIndexY;// (int)Math.Abs(Math.Abs(vert0.Y) - Math.Abs(vert2.Y));
