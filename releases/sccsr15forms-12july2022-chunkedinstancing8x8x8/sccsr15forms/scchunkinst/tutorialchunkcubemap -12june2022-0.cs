...
namespace sccsr15forms
{
    public class tutorialchunkcubemap
    {
        ...
        public void setmapfordims(out double m11, out double m12, out double m13, out double m14,
            ...
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
                {
                    for (int z = 0; z < depth; z++)
                    {
                        ...
                        int currentByte = somenewmap[index];
            ...
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
                {
                    for (int z = 0; z < depth; z++)
                    {
                        ...
                        int somevertx = somenewfirstvertx[index];// widthdim[index];
                        int someverty = somenewfirstverty[index];
                        int somevertz = somenewfirstvertz[index];// depthdim[index];
            ...
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
                {
                    for (int z = 0; z < depth; z++)
                    {
                        ...
                        int somewidth = somenewdimswidth[index];// widthdim[index];
                        int someheight = somenewdimsheight[index];
                        int somedepth = somenewdimsdepth[index];// depthdim[index];
            ...
            if (block == 1) //|| block == 2
            {
                ...
                if (IsTransparent(xi, yi + 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 1 && getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 1 && getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 1 && getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 1)//
                    {
                        ...
                        mapfirstvertx[indexofmapvertindexfordimsone] = oneVertIndexX;
                        mapfirstverty[indexofmapvertindexfordimsone] = oneVertIndexY;
                        mapfirstvertz[indexofmapvertindexfordimsone] = oneVertIndexZ;
