...
{
    public class sclevelgenvertfront
    {
        ...
        public List<Vector4> vertexlist = new List<Vector4>(); //listOfVerts
        ...
        //public static Dictionary<sclevelgenvertfront, Vector3> chunkz = new Dictionary<sclevelgenvertfront, Vector3>();

        int typeofterraintiles;
        sclevelgenvertfront[] listofchunksadjacent = new sclevelgenvertfront[6];
        sclevelgenvertfront[] listofchunksadjacentfloor = new sclevelgenvertfront[6];
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertfront someChunk = (sclevelgenvertfront)componentparent.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    sclevelgenvertfront someChunk = (sclevelgenvertfront)componentparent.getChunklod0(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
                    if (someChunk != null)
                    {
                        if (someChunk.map != null)
                        {
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= 1.0f;
                                //var someChunk = (sclevelgenvertfront)componentparent.getChunklod0(somechunkpos.X, 0, somechunkpos.Z);
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertfront someChunk = (sclevelgenvertfront)componentparent.getChunklod0(somechunkpos.X,0, somechunkpos.Z);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        if (levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz) != null)
                        {
                            ...
                            sclevelgenvertfront someChunk = (sclevelgenvertfront)levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                            if (someChunk != null)
                            {
                                if (xi == 0 && someChunk.map != null)
                                {
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        if (componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz) != null)
                        {
                            ...
                            sclevelgenvertfront someChunk = (sclevelgenvertfront)componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
            ...
            if (_block == 1) //|| _block == 2
            {
                ...
                if (IsTransparent(xi, yi + 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint0(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        vertexlist.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlist.Add(topfacecolor);
                    ...
                    if (getChunklod0Vertexint0(twoVertIndexX, twoVertIndexY, twoVertIndexZ) == 0)
                    {
                        ...
                        vertexlist.Add(new Vector4(twoVertIndexX * planeSize, twoVertIndexY * planeSize, twoVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlist.Add(topfacecolor);
                    ...
                    if (getChunklod0Vertexint0(threeVertIndexX, threeVertIndexY, threeVertIndexZ) == 0)
                    {
                        ...
                        vertexlist.Add(new Vector4(threeVertIndexX * planeSize, threeVertIndexY * planeSize, threeVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlist.Add(topfacecolor);
                    ...
                    if (getChunklod0Vertexint0(fourVertIndexX, fourVertIndexY, fourVertIndexZ) == 0)
                    {
                        ...
                        vertexlist.Add(new Vector4(fourVertIndexX * planeSize, fourVertIndexY * planeSize, fourVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlist.Add(topfacecolor);
            ...
            if (_block == 1) //|| _block == 2
            {
                if (IsTransparent(xi, yi - 1, zi))
                {
                    ...
                    if (getChunklod0Vertexint5(oneVertIndexX, oneVertIndexY, oneVertIndexZ) == 0)
                    {
                        ...
                        vertexlist.Add(new Vector4(oneVertIndexX * planeSize, oneVertIndexY * planeSize, oneVertIndexZ * planeSize, 1) + chunkoriginpos);
                        //vertexlist.Add(new Vector4(xit, yit, zit, block));
                        vertexlist.Add(bottomfacecolor);
