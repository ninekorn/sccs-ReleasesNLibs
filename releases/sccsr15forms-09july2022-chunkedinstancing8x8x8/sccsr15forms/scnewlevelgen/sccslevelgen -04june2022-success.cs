                ...
                for (var x = minx; x < maxx; x++)
                {
                    for (var y = miny; y < maxy; y++)
                    {
                        for (var z = minz; z < maxz; z++)
                        {
                            ...
                            /*if (levelmap[indexinlevelarray] == 0 && x == minx && y == 0 ||
                                levelmap[indexinlevelarray] == 0 && z == minz && y == 0 ||
                                levelmap[indexinlevelarray] == 0 && x == maxx - 1 && y == 0 ||
                                levelmap[indexinlevelarray] == 0 && z == maxz - 1 && y == 0 ||

                                levelmap[indexinlevelarray] == 0 && x == minx && z == minz && y == 0 ||
                                levelmap[indexinlevelarray] == 0 && z == minz && z == maxz - 1 && y == 0 ||
                                levelmap[indexinlevelarray] == 0 && x == maxx - 1 && z == minz && y == 0 ||
                                levelmap[indexinlevelarray] == 0 && z == maxz - 1 && z == maxz - 1 && y == 0 ||

                                levelmap[indexinlevelarray] == 999 && x == minx && y == 0 ||
                                levelmap[indexinlevelarray] == 999 && z == minz && y == 0 ||
                                levelmap[indexinlevelarray] == 999 && x == maxx - 1 && y == 0 ||
                                levelmap[indexinlevelarray] == 999 && z == maxz - 1 && y == 0 ||

                                levelmap[indexinlevelarray] == 999 && x == minx && z == minz && y == 0 ||
                                levelmap[indexinlevelarray] == 999 && z == minz && z == maxz - 1 && y == 0 ||
                                levelmap[indexinlevelarray] == 999 && x == maxx - 1 && z == minz && y == 0 ||
                                levelmap[indexinlevelarray] == 999 && z == maxz - 1 && z == maxz - 1 && y == 0)
                            {
                        ...
                        checkx == xi - (1) && checkz == zi - (1))
                    {
                        ...
                        if (indexinarray0 < somewidth * someheight * somedepth)
                        {
                            if (levelmap[indexinarray0] == 999)//|| levelmap[indexinarray0] == 0
                            {
                                ...
                                /*else
                                {
                                    adjacenttiles[indexinarray0] = 999;
                                }*/
