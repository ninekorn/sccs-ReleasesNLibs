...
{
    public class sclevelgenvertright
    {
        ...
        //public static Dictionary<sclevelgenvertright, Vector3> chunkz = new Dictionary<sclevelgenvertright, Vector3>();

        int typeofterraintiles;
        sclevelgenvertright[] listofchunksadjacent = new sclevelgenvertright[6];
        sclevelgenvertright[] listofchunksadjacentfloor = new sclevelgenvertright[6];
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertright someChunk = (sclevelgenvertright)componentparent.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    sclevelgenvertright someChunk = (sclevelgenvertright)componentparent.getChunklod0(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
                    if (someChunk != null)
                    {
                        if (someChunk.map != null)
                        {
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= 1.0f;
                                //var someChunk = (sclevelgenvertright)componentparent.getChunklod0(somechunkpos.X, 0, somechunkpos.Z);
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertright someChunk = (sclevelgenvertright)componentparent.getChunklod0(somechunkpos.X,0, somechunkpos.Z);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        if (levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz) != null)
                        {
                            ...
                            sclevelgenvertright someChunk = (sclevelgenvertright)levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                            if (someChunk != null)
                            {
                                if (xi == 0 && someChunk.map != null)
                                {
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        if (componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz) != null)
                        {
                            ...
                            sclevelgenvertright someChunk = (sclevelgenvertright)componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
