...
{
    public class sclevelgenvertback
    {
        ...
        //public static Dictionary<sclevelgenvertback, Vector3> chunkz = new Dictionary<sclevelgenvertback, Vector3>();

        int typeofterraintiles;
        sclevelgenvertback[] listofchunksadjacent = new sclevelgenvertback[6];
        sclevelgenvertback[] listofchunksadjacentfloor = new sclevelgenvertback[6];
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertback someChunk = (sclevelgenvertback)componentparent.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    sclevelgenvertback someChunk = (sclevelgenvertback)componentparent.getChunklod0(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
                    if (someChunk != null)
                    {
                        if (someChunk.map != null)
                        {
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= 1.0f;
                                //var someChunk = (sclevelgenvertback)componentparent.getChunklod0(somechunkpos.X, 0, somechunkpos.Z);
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenvertback someChunk = (sclevelgenvertback)componentparent.getChunklod0(somechunkpos.X,0, somechunkpos.Z);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        if (levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz) != null)
                        {
                            ...
                            sclevelgenvertback someChunk = (sclevelgenvertback)levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                            if (someChunk != null)
                            {
                                if (xi == 0 && someChunk.map != null)
                                {
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        if (componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz) != null)
                        {
                            ...
                            sclevelgenvertback someChunk = (sclevelgenvertback)componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
