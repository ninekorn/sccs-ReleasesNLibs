...
{
    public class sclevelgenverttop
    {
        ...
        //public static Dictionary<sclevelgenverttop, Vector3> chunkz = new Dictionary<sclevelgenverttop, Vector3>();

        int typeofterraintiles;
        sclevelgenverttop[] listofchunksadjacent = new sclevelgenverttop[6];
        sclevelgenverttop[] listofchunksadjacentfloor = new sclevelgenverttop[6];
                ...
                if (indexints < totalints)
                {
                    ...
                    */
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenverttop someChunk = (sclevelgenverttop)componentparent.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                    ...
                    sclevelgenverttop someChunk = (sclevelgenverttop)componentparent.getChunklod0(somechunkpos.X, somechunkpos.Y, somechunkpos.Z);
                    if (someChunk != null)
                    {
                        if (someChunk.map != null)
                        {
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        else if (xi == 0)
                        {
                            ...
                            else
                            {
                                ...
                                //somechunkpos.X -= 1.0f;
                                //var someChunk = (sclevelgenverttop)componentparent.getChunklod0(somechunkpos.X, 0, somechunkpos.Z);
                    ...
                    /*if (IsTransparent(xi - 1, yi, zi))
                    {
                        ...
                        {
                            sclevelgenverttop someChunk = (sclevelgenverttop)componentparent.getChunklod0(somechunkpos.X,0, somechunkpos.Z);
                    ...
                    if (IsTransparent(xi - 1, yi, zi))
                    {
                        if (levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz) != null)
                        {
                            ...
                            sclevelgenverttop someChunk = (sclevelgenverttop)levelgen.getChunklod0(somevalueforLeftx, somevalueforLefty, somevalueforLeftz);
                            if (someChunk != null)
                            {
                                if (xi == 0 && someChunk.map != null)
                                {
                    ...
                    if (IsTransparent(xi, yi, zi + 1))
                    {
                        ...
                        if (componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz) != null)
                        {
                            ...
                            sclevelgenverttop someChunk = (sclevelgenverttop)componentparent.getChunklod0(somevalueforFrontx, somevalueforFronty, somevalueforFrontz);
