//using DSharpDXRastertek.Tut12.System;
using SharpDX;
...
namespace sccsr15forms// DSharpDXRastertek.Tut12.Graphics.TextFont
{
    public class DFontShader                    // 275 lines
    {
        ...
        private bool InitializeShader(SharpDX.Direct3D11.Device device, IntPtr windowHandler, string vsFileName, string psFileName)
        {
            try
            {
                ...
                string pathofrelease = Directory.GetCurrentDirectory() + @"\DFont\";

                

                #region Input Layout Configuration
                // Setup full paths
                //vsFileName = appconfiguration.FontFilePath + vsFileName;
                //psFileName = appconfiguration.FontFilePath + psFileName;

                // Setup full paths
                vsFileName = pathofrelease + vsFileName;
                psFileName = pathofrelease + psFileName;
