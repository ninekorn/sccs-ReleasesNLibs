...
namespace sccsr15forms
{
    public class SC_cube : ITransform, IComponent
    {
        ...
        public sccsr15forms.SC_cube.DInstanceData[] instancesDataRIGHT { get; set; }
        public sccsr15forms.SC_cube.DInstanceData[] instancesDataUP { get; set; }
        ...
        public SC_cube() { }
        public sccsr15forms.directx.BodyTag _tag;
        public bool Initialize(sccsr15forms.directx D3D, int width, int height, float tileSize, int divX, int divY, float _sizeX, float _sizeY, float _sizeZ, Vector4 color, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int isTerrain, float offsetPosX, float offsetPosY, float offsetPosZ, World the_world, sccsr15forms.directx.BodyTag tag, bool is_static, int addtoworld, float mass, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
        ...
        private bool InitializeBuffer(sccsr15forms.directx D3D, float _sizeX, float _sizeY, float _sizeZ, float tileSize, int instX, int instY, int instZ, IntPtr windowsHandle, Matrix matroxer, int type_of_cube, float offsetPosX, float offsetPosY, float offsetPosZ, float vertoffsetx, float vertoffsety, float vertoffsetz)
        {
            try
            {
                int tessellation = 3;
