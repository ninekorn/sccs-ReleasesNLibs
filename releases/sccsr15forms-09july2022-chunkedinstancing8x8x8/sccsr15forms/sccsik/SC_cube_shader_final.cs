...
namespace sccsr15forms
{
    public class SC_cube_shader_final                 // 228 lines
    {
        ...
        public sccsr15forms.SC_cube.DLightBuffer[] _DLightBuffer;

        public bool Initialize(Device device, IntPtr windowsHandler, SharpDX.Direct3D11.Buffer ConstantLightBuffer, sccsr15forms.SC_cube.DLightBuffer[] DLightBuffer, int shadertype)
        {
        ...
        private bool InitializeShader(Device device, IntPtr windowsHandler, string vsFileName, string psFileName, int shadertype)
        {
            try
            {
                ...
                */
                ...
                {
                    vsFileName = sccsr15forms.Properties.Resources.textureVSassets;// "../../../_sc_instance_shader/" + "texture.vs";
                    psFileName = sccsr15forms.Properties.Resources.texturePSassets;// "../../../_sc_instance_shader/" + "texture.ps";
                    var gsFileName = sccsr15forms.Properties.Resources.HLSL;
